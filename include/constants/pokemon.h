...
#define FLAG_BEAM_MOVE                            (1 << 30)
#define FLAG_BEAM_BOOSTED                         (1 << 31)
...
#define EVO_DARK_SCROLL                   35
#define EVO_WATER_SCROLL                  36
#define EVO_CRITICAL_HITS                 37
#define EVO_SCRIPT_TRIGGER_DMG            38
