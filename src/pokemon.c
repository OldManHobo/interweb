...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_MORPHYDRA_MEGA - 1] = NATIONAL_DEX_MORPHYDRA,
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_MORPHYDRA - 1]       = ANIM_FRONT_FLIP,
    ...
    [SPECIES_CYBIRD - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_PTEROCAST - 1]    = ANIM_H_JUMPS,
