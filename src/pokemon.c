...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(SCRILL),
    SPECIES_TO_HOENN(OVERSCRILL),
    SPECIES_TO_HOENN(SNOUTUSSLE),
    ...
    SPECIES_TO_HOENN(CYBIRD),
    SPECIES_TO_HOENN(PICHU),
    SPECIES_TO_HOENN(ASTROHAUT),
    SPECIES_TO_HOENN(WIRLIXPLOR),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(SCRILL),
    SPECIES_TO_NATIONAL(OVERSCRILL),
    SPECIES_TO_NATIONAL(SNOUTUSSLE),
    SPECIES_TO_NATIONAL(GRAPPOUCH),
    SPECIES_TO_NATIONAL(SWORMO),
    ...
    [SPECIES_COATTAIL_MEGA - 1] = NATIONAL_DEX_COATTAIL,
    [SPECIES_ROADILLO_MEGA - 1] = NATIONAL_DEX_ROADILLO,
    ...
    // Alolan Forms
    [SPECIES_COILARVA_ALOLAN - 1] = NATIONAL_DEX_COILARVA,
    [SPECIES_MORPHYDRA_ALOLAN - 1] = NATIONAL_DEX_MORPHYDRA,
    [SPECIES_WIRLIXPLOR_ALOLAN - 1] = NATIONAL_DEX_WIRLIXPLOR,
    [SPECIES_RUMOSS_ALOLAN - 1] = NATIONAL_DEX_RUMOSS,
    [SPECIES_LIAYARD_ALOLAN - 1] = NATIONAL_DEX_LIAYARD,
...
#endif
    // Cosplay Pikachu
    [SPECIES_ASTROHAUT_COSPLAY - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_ROCK_STAR - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_BELLE - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_POP_STAR - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_PH_D - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_LIBRE - 1] = NATIONAL_DEX_ASTROHAUT,
    // Cap Pikachu
    [SPECIES_ASTROHAUT_ORIGINAL_CAP - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_HOENN_CAP - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_SINNOH_CAP - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_UNOVA_CAP - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_KALOS_CAP - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_ALOLA_CAP - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_PARTNER_CAP - 1] = NATIONAL_DEX_ASTROHAUT,
    [SPECIES_ASTROHAUT_WORLD_CAP - 1] = NATIONAL_DEX_ASTROHAUT,
    // Pichu
...
{
    [SPECIES_GENERA - 1]     = ANIM_V_JUMPS_BIG,
    [SPECIES_GYANNEX - 1]       = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_KAZEIYAGA - 1]      = ANIM_LUNGE_GROW,
    [SPECIES_TEPILLA - 1]    = ANIM_V_SHAKE_BACK_SLOW,
    [SPECIES_ESCORCHES - 1]    = ANIM_H_SLIDE_SLOW,
    [SPECIES_SOLADOR - 1]     = ANIM_SHAKE_GLOW_RED_FAST,
    [SPECIES_RELENTOOTH - 1]      = ANIM_H_JUMPS_V_STRETCH_TWICE,
    [SPECIES_SNARETHAN - 1]     = ANIM_H_STRETCH,
    [SPECIES_LEVIAMAWL - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_DISCUTTLE - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_TENNADISH - 1]       = ANIM_H_SHAKE,
    [SPECIES_WEBILLITE - 1]    = ANIM_CIRCULAR_VIBRATE,
    [SPECIES_GALACTIVY - 1]        = ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_XENOWEED - 1]        = ANIM_GROW_IN_STAGES,
    [SPECIES_COATTAIL - 1]      = ANIM_BOUNCE_ROTATE_TO_SIDES,
    [SPECIES_COATOAC - 1]        = ANIM_DEEP_V_SQUISH_AND_BOUNCE,
    [SPECIES_CYCLIL - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_ROADILLO - 1]       = ANIM_V_SHAKE_BACK,
    [SPECIES_COILARVA - 1]       = ANIM_V_STRETCH_BOTH_ENDS_SLOW,
    [SPECIES_MORPHYDRA - 1]      = ANIM_SWING_CONCAVE_FAST,
    [SPECIES_DRAMAGO - 1]       = ANIM_SPRING_RISING,
    [SPECIES_FELIGHT - 1]        = ANIM_TWIST,
    [SPECIES_SILWING - 1]         = ANIM_FRONT_FLIP,
    [SPECIES_FOMPOUS - 1]         = ANIM_V_SHAKE_TWICE,
    [SPECIES_ASTROHAUT - 1]       = ANIM_H_VIBRATE,
    [SPECIES_WIRLIXPLOR - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_RUMOSS - 1]     = ANIM_H_JUMPS,
    [SPECIES_LIAYARD - 1]     = ANIM_V_SHAKE,
    [SPECIES_TADEA - 1]     = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_BATRACHITE - 1]      = ANIM_H_SLIDE_SLOW,
    [SPECIES_TOAGNITIVE - 1]     = ANIM_V_STRETCH,
    [SPECIES_SILICTAL - 1]     = ANIM_SWING_CONCAVE,
    [SPECIES_CRYSTURDY - 1]      = ANIM_TIP_MOVE_FORWARD,
    [SPECIES_QUARDIAN - 1]      = ANIM_V_SHAKE,
    [SPECIES_BANANEE - 1]      = ANIM_BOUNCE_ROTATE_TO_SIDES,
    [SPECIES_BANAGON - 1]      = ANIM_H_JUMPS_V_STRETCH_TWICE,
    [SPECIES_SALANANA - 1]        = ANIM_BACK_FLIP_BIG,
    [SPECIES_CYBIRD - 1]     = ANIM_RISING_WOBBLE,
    [SPECIES_PTEROCAST - 1]    = ANIM_ZIGZAG_SLOW,
    [SPECIES_AMOBI - 1]    = ANIM_RAPID_H_HOPS,
    [SPECIES_AMOBERIA - 1]         = ANIM_V_SHAKE,
    [SPECIES_TANKELLUR - 1]        = ANIM_ROTATE_UP_SLAM_DOWN,
    [SPECIES_SCRILL - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_OVERSCRILL - 1]         = ANIM_H_VIBRATE,
    [SPECIES_SNOUTUSSLE - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_GRAPPOUCH - 1]         = ANIM_ROTATE_UP_SLAM_DOWN,
    [SPECIES_SWORMO - 1]      = ANIM_V_SHAKE,
    [SPECIES_EKANS - 1]       = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_PIKACHU - 1]      = ANIM_ZIGZAG_SLOW,
...
static const u8 sMonAnimationDelayTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_COATTAIL - 1]   = 35,
    [SPECIES_CYCLIL - 1]  = 25,
    [SPECIES_FELIGHT - 1]     = 2,
    [SPECIES_SILWING - 1]      = 30,
    [SPECIES_TADEA - 1]  = 28,
    [SPECIES_QUARDIAN - 1]   = 25,
    [SPECIES_GRAPPOUCH - 1]      = 10,
    [SPECIES_SWORMO - 1]   = 45,
    [SPECIES_EKANS - 1]    = 20,
