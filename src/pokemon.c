...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(AMOBI),
    SPECIES_TO_HOENN(AMOBERIA),
    ...
    SPECIES_TO_HOENN(TANKELLUR),
    SPECIES_TO_HOENN(CYCLIL),
    SPECIES_TO_HOENN(ROADILLO),
    ...
    SPECIES_TO_HOENN(SAULLACE),
    SPECIES_TO_HOENN(RUMOSS),
    ...
    SPECIES_TO_HOENN(HYPADOG),
    SPECIES_TO_HOENN(HYPADOG2),
    ...
    SPECIES_TO_HOENN(BANAGON),
    SPECIES_TO_HOENN(SALANANA),
    SPECIES_TO_HOENN(PICHU),
    SPECIES_TO_HOENN(GENTOO),
    SPECIES_TO_HOENN(SAWFUL),
    SPECIES_TO_HOENN(PSYDUCK),
    SPECIES_TO_HOENN(AILES),
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(RELENTOOTH),
    SPECIES_TO_NATIONAL(SNARETHAN),
    SPECIES_TO_NATIONAL(LEVIAMAWL),
    SPECIES_TO_NATIONAL(DISCUTTLE),
    SPECIES_TO_NATIONAL(TENNADISH),
    SPECIES_TO_NATIONAL(WEBILLITE),
    SPECIES_TO_NATIONAL(GALACTIVY),
    SPECIES_TO_NATIONAL(XENOWEED),
    SPECIES_TO_NATIONAL(SNAGOON),
    SPECIES_TO_NATIONAL(REPOCOON),
    SPECIES_TO_NATIONAL(COILARVA),
    SPECIES_TO_NATIONAL(COILOCUS),
    SPECIES_TO_NATIONAL(DRAMAGO),
    SPECIES_TO_NATIONAL(FELIGHT),
    SPECIES_TO_NATIONAL(SILWING),
    SPECIES_TO_NATIONAL(FOMPOUS),
    SPECIES_TO_NATIONAL(ASTROHAUT),
    SPECIES_TO_NATIONAL(WIRLIXPLOR),
    SPECIES_TO_NATIONAL(GENTOO),
    SPECIES_TO_NATIONAL(SAWFUL),
    SPECIES_TO_NATIONAL(SAULLACE),
    SPECIES_TO_NATIONAL(RUMOSS),
    SPECIES_TO_NATIONAL(LIAYARD),
    SPECIES_TO_NATIONAL(TADEA),
    SPECIES_TO_NATIONAL(BATRACHITE),
    SPECIES_TO_NATIONAL(TOAGNITIVE),
    SPECIES_TO_NATIONAL(SILICTAL),
    SPECIES_TO_NATIONAL(CRYSTURDY),
    SPECIES_TO_NATIONAL(QUARDIAN),
    SPECIES_TO_NATIONAL(BANANEE),
    SPECIES_TO_NATIONAL(BANAGON),
    SPECIES_TO_NATIONAL(SALANANA),
    SPECIES_TO_NATIONAL(HYPADOG),
    SPECIES_TO_NATIONAL(HYPADOG2),
    SPECIES_TO_NATIONAL(AMOBI),
    SPECIES_TO_NATIONAL(AMOBERIA),
    SPECIES_TO_NATIONAL(TANKELLUR),
    SPECIES_TO_NATIONAL(CYCLIL),
    SPECIES_TO_NATIONAL(ROADILLO),
    SPECIES_TO_NATIONAL(COATTAIL),
    SPECIES_TO_NATIONAL(COATOAC),
    SPECIES_TO_NATIONAL(SNOUTUSSLE),
    SPECIES_TO_NATIONAL(GRAPPOUCH),
    SPECIES_TO_NATIONAL(CYBIRD),
    SPECIES_TO_NATIONAL(PTEROCAST),
    SPECIES_TO_NATIONAL(MEOWTH),
    SPECIES_TO_NATIONAL(PERSIAN),
    SPECIES_TO_NATIONAL(PSYDUCK),
    SPECIES_TO_NATIONAL(AILES),
    SPECIES_TO_NATIONAL(NACLES),
    SPECIES_TO_NATIONAL(LICLES),
    ...
    [SPECIES_SNAGOON_MEGA - 1] = NATIONAL_DEX_SNAGOON,
    [SPECIES_COILOCUS_MEGA - 1] = NATIONAL_DEX_COILOCUS,
    ...
    // Alolan Forms
    [SPECIES_DRAMAGO_ALOLAN - 1] = NATIONAL_DEX_DRAMAGO,
    [SPECIES_FELIGHT_ALOLAN - 1] = NATIONAL_DEX_FELIGHT,
    [SPECIES_SAWFUL_ALOLAN - 1] = NATIONAL_DEX_SAWFUL,
    [SPECIES_SAULLACE_ALOLAN - 1] = NATIONAL_DEX_SAULLACE,
    [SPECIES_RUMOSS_ALOLAN - 1] = NATIONAL_DEX_RUMOSS,
    [SPECIES_BANAGON_ALOLAN - 1] = NATIONAL_DEX_BANAGON,
    [SPECIES_SALANANA_ALOLAN - 1] = NATIONAL_DEX_SALANANA,
    [SPECIES_CYBIRD_ALOLAN - 1] = NATIONAL_DEX_CYBIRD,
    [SPECIES_PTEROCAST_ALOLAN - 1] = NATIONAL_DEX_PTEROCAST,
...
#endif
    // Cosplay Pikachu
    [SPECIES_GENTOO_COSPLAY - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_ROCK_STAR - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_BELLE - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_POP_STAR - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_PH_D - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_LIBRE - 1] = NATIONAL_DEX_GENTOO,
    // Cap Pikachu
    [SPECIES_GENTOO_ORIGINAL_CAP - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_HOENN_CAP - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_SINNOH_CAP - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_UNOVA_CAP - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_KALOS_CAP - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_ALOLA_CAP - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_PARTNER_CAP - 1] = NATIONAL_DEX_GENTOO,
    [SPECIES_GENTOO_WORLD_CAP - 1] = NATIONAL_DEX_GENTOO,
    // Pichu
...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(AMOBI),
    HOENN_TO_NATIONAL(AMOBERIA),
    ...
    HOENN_TO_NATIONAL(HYPADOG),
    HOENN_TO_NATIONAL(HYPADOG2),
    ...
    HOENN_TO_NATIONAL(GENTOO),
    HOENN_TO_NATIONAL(SAWFUL),
    HOENN_TO_NATIONAL(PSYDUCK),
    HOENN_TO_NATIONAL(AILES),
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_RELENTOOTH - 1]      = ANIM_V_JUMPS_SMALL,
    [SPECIES_SNARETHAN - 1]     = ANIM_SHRINK_GROW,
    [SPECIES_LEVIAMAWL - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_DISCUTTLE - 1]      = ANIM_SWING_CONCAVE,
    [SPECIES_TENNADISH - 1]       = ANIM_SWING_CONCAVE,
    [SPECIES_WEBILLITE - 1]    = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_GALACTIVY - 1]        = ANIM_H_SLIDE_SLOW,
    [SPECIES_XENOWEED - 1]        = ANIM_GLOW_ORANGE,
    [SPECIES_SNAGOON - 1]      = ANIM_H_VIBRATE,
    [SPECIES_REPOCOON - 1]        = ANIM_V_STRETCH,
    [SPECIES_COILARVA - 1]     = ANIM_V_STRETCH,
    [SPECIES_COILOCUS - 1]       = ANIM_FRONT_FLIP,
    [SPECIES_DRAMAGO - 1]       = ANIM_RAPID_H_HOPS,
    [SPECIES_FELIGHT - 1]      = ANIM_FIGURE_8,
    [SPECIES_SILWING - 1]       = ANIM_H_JUMPS,
    [SPECIES_FOMPOUS - 1]        = ANIM_FIGURE_8,
    [SPECIES_ASTROHAUT - 1]         = ANIM_V_STRETCH,
    [SPECIES_WIRLIXPLOR - 1]         = ANIM_V_STRETCH,
    [SPECIES_GENTOO - 1]       = ANIM_FLASH_YELLOW,
    [SPECIES_SAWFUL - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_SAULLACE - 1]     = ANIM_SWING_CONCAVE_FAST_SHORT,
    [SPECIES_RUMOSS - 1]     = ANIM_H_SHAKE,
    [SPECIES_LIAYARD - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TADEA - 1]      = ANIM_V_STRETCH,
    [SPECIES_BATRACHITE - 1]     = ANIM_H_SHAKE,
    [SPECIES_TOAGNITIVE - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_SILICTAL - 1]      = ANIM_V_STRETCH,
    [SPECIES_CRYSTURDY - 1]      = ANIM_H_SHAKE,
    [SPECIES_QUARDIAN - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BANANEE - 1]      = ANIM_V_STRETCH,
    [SPECIES_BANAGON - 1]        = ANIM_V_STRETCH,
    [SPECIES_SALANANA - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_HYPADOG - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_HYPADOG2 - 1]    = ANIM_H_JUMPS,
    [SPECIES_AMOBI - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AMOBERIA - 1]        = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_TANKELLUR - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_CYCLIL - 1]         = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_ROADILLO - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_COATTAIL - 1]         = ANIM_H_SLIDE_SLOW,
    [SPECIES_COATOAC - 1]      = ANIM_H_SHAKE,
    [SPECIES_SNOUTUSSLE - 1]       = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_GRAPPOUCH - 1]      = ANIM_ZIGZAG_SLOW,
    [SPECIES_CYBIRD - 1]       = ANIM_V_SHAKE,
    [SPECIES_PTEROCAST - 1]       = ANIM_H_SHAKE_SLOW,
    [SPECIES_MEOWTH - 1]        = ANIM_V_JUMPS_SMALL,
    [SPECIES_PERSIAN - 1]       = ANIM_V_STRETCH,
    [SPECIES_PSYDUCK - 1]       = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_AILES - 1]       = ANIM_H_SHAKE_SLOW,
    [SPECIES_NACLES - 1]        = ANIM_H_JUMPS_V_STRETCH,
    [SPECIES_LICLES - 1]      = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
...
{
    [SPECIES_LEVIAMAWL - 1]  = 50,
    [SPECIES_GALACTIVY - 1]     = 10,
    [SPECIES_XENOWEED - 1]     = 20,
    [SPECIES_SNAGOON - 1]   = 35,
    [SPECIES_COILARVA - 1]  = 25,
    [SPECIES_FOMPOUS - 1]     = 2,
    [SPECIES_ASTROHAUT - 1]      = 30,
    [SPECIES_LIAYARD - 1]  = 28,
    [SPECIES_CRYSTURDY - 1]   = 25,
    [SPECIES_COATTAIL - 1]      = 10,
    [SPECIES_COATOAC - 1]   = 45,
    [SPECIES_SNOUTUSSLE - 1]    = 20,
    [SPECIES_CYBIRD - 1]    = 25,
    [SPECIES_PTEROCAST - 1]    = 35,
    [SPECIES_MEOWTH - 1]     = 40,
