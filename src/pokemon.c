...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_COATTAIL - 1]      = ANIM_H_VIBRATE,
    [SPECIES_COATOAC - 1]        = ANIM_V_STRETCH,
    [SPECIES_CYCLIL - 1]     = ANIM_V_STRETCH,
    [SPECIES_ROADILLO - 1]       = ANIM_FRONT_FLIP,
    [SPECIES_COILARVA - 1]       = ANIM_RAPID_H_HOPS,
    [SPECIES_MORPHYDRA - 1]      = ANIM_FIGURE_8,
    [SPECIES_DRAMAGO - 1]       = ANIM_H_JUMPS,
    [SPECIES_FELIGHT - 1]        = ANIM_FIGURE_8,
    [SPECIES_SILWING - 1]         = ANIM_V_STRETCH,
    [SPECIES_FOMPOUS - 1]         = ANIM_V_STRETCH,
    [SPECIES_ASTROHAUT - 1]       = ANIM_FLASH_YELLOW,
    [SPECIES_WIRLIXPLOR - 1]        = ANIM_GROW_VIBRATE,
    [SPECIES_RUMOSS - 1]     = ANIM_SWING_CONCAVE_FAST_SHORT,
    [SPECIES_LIAYARD - 1]     = ANIM_H_SHAKE,
    [SPECIES_TADEA - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BATRACHITE - 1]      = ANIM_V_STRETCH,
    [SPECIES_TOAGNITIVE - 1]     = ANIM_H_SHAKE,
    [SPECIES_SILICTAL - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_CRYSTURDY - 1]      = ANIM_V_STRETCH,
    [SPECIES_QUARDIAN - 1]      = ANIM_H_SHAKE,
    [SPECIES_BANANEE - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BANAGON - 1]      = ANIM_V_STRETCH,
    [SPECIES_SALANANA - 1]        = ANIM_V_STRETCH,
    [SPECIES_CYBIRD - 1]     = ANIM_GROW_VIBRATE,
    [SPECIES_PTEROCAST - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SMALL,
    [SPECIES_AMOBI - 1]    = ANIM_H_JUMPS,
    [SPECIES_AMOBERIA - 1]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TANKELLUR - 1]        = ANIM_H_SLIDE_WOBBLE,
    [SPECIES_SCRILL - 1]        = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_OVERSCRILL - 1]         = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_SNOUTUSSLE - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_GRAPPOUCH - 1]         = ANIM_H_SLIDE_SLOW,
    [SPECIES_SWORMO - 1]      = ANIM_H_SHAKE,
