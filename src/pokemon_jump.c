...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_GALACTIVY,     .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_XENOWEED,     .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_COILARVA,    .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_COILARVA_ALOLAN, .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_MORPHYDRA,   .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_MORPHYDRA_ALOLAN, .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_ASTROHAUT,    .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_COSPLAY, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_ROCK_STAR, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_BELLE, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_POP_STAR, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_PH_D, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_LIBRE, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_ORIGINAL_CAP, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_HOENN_CAP, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_SINNOH_CAP, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_UNOVA_CAP, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_KALOS_CAP, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_ALOLA_CAP, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_PARTNER_CAP, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_ASTROHAUT_WORLD_CAP, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_RUMOSS,  .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_RUMOSS_ALOLAN, .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_TADEA,  .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_SILICTAL,  .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_BANANEE,   .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_SALANANA,     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_SALANANA_ALOLAN, .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_PTEROCAST, .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_SCRILL,     .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_GRAPPOUCH,      .jumpType = JUMP_TYPE_FAST, },
