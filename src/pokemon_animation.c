...
{
    [SPECIES_GENERA]  = BACK_ANIM_SHRINK_GROW,
    [SPECIES_GYANNEX]    = BACK_ANIM_GROW,
    [SPECIES_KAZEIYAGA]   = BACK_ANIM_GROW,
    [SPECIES_TEPILLA] = BACK_ANIM_V_SHAKE,
    [SPECIES_ESCORCHES] = BACK_ANIM_H_SLIDE,
    [SPECIES_SOLADOR]  = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_RELENTOOTH]   = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_SNARETHAN]  = BACK_ANIM_H_STRETCH,
    [SPECIES_LEVIAMAWL]  = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_DISCUTTLE]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_TENNADISH]    = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_WEBILLITE] = BACK_ANIM_H_VIBRATE,
    [SPECIES_GALACTIVY]     = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_XENOWEED]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_COATTAIL]   = BACK_ANIM_H_SLIDE,
    [SPECIES_COATOAC]     = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CYCLIL]  = BACK_ANIM_V_SHAKE,
    [SPECIES_ROADILLO]    = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_COILARVA]    = BACK_ANIM_V_STRETCH,
    [SPECIES_MORPHYDRA]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_DRAMAGO]    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_FELIGHT]     = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SILWING]      = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_FOMPOUS]      = BACK_ANIM_V_SHAKE,
    [SPECIES_ASTROHAUT]    = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_WIRLIXPLOR]     = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_RUMOSS]  = BACK_ANIM_H_SLIDE,
    [SPECIES_LIAYARD]  = BACK_ANIM_V_SHAKE,
    [SPECIES_TADEA]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_BATRACHITE]   = BACK_ANIM_H_SPRING,
    [SPECIES_TOAGNITIVE]  = BACK_ANIM_V_STRETCH,
    [SPECIES_SILICTAL]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_CRYSTURDY]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_QUARDIAN]   = BACK_ANIM_V_SHAKE,
    [SPECIES_BANANEE]   = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_BANAGON]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_SALANANA]     = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_CYBIRD]  = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_PTEROCAST] = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_AMOBI] = BACK_ANIM_GROW,
    [SPECIES_AMOBERIA]      = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_TANKELLUR]     = BACK_ANIM_V_SHAKE,
    [SPECIES_SCRILL]     = BACK_ANIM_SHRINK_GROW,
    [SPECIES_OVERSCRILL]      = BACK_ANIM_H_VIBRATE,
    [SPECIES_SNOUTUSSLE]  = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_GRAPPOUCH]      = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_SWORMO]   = BACK_ANIM_V_SHAKE,
