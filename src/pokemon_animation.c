...
{
    [SPECIES_GENERA]  = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_GYANNEX]    = BACK_ANIM_H_SLIDE,
    [SPECIES_KAZEIYAGA]   = BACK_ANIM_H_SHAKE,
    ...
    [SPECIES_COATTAIL]   = BACK_ANIM_H_VIBRATE,
    [SPECIES_COATOAC]     = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_CYCLIL]  = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ROADILLO]    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_COILARVA]    = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_MORPHYDRA]   = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_DRAMAGO]    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_FELIGHT]     = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SILWING]      = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_FOMPOUS]      = BACK_ANIM_V_SHAKE,
    [SPECIES_ASTROHAUT]    = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_WIRLIXPLOR]     = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_RUMOSS]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_LIAYARD]  = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_TADEA]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_BATRACHITE]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_TOAGNITIVE]  = BACK_ANIM_V_SHAKE,
    [SPECIES_SILICTAL]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_CRYSTURDY]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_QUARDIAN]   = BACK_ANIM_V_SHAKE,
    [SPECIES_BANANEE]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_BANAGON]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SALANANA]     = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_CYBIRD]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_PTEROCAST] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_AMOBI] = BACK_ANIM_GROW,
    [SPECIES_AMOBERIA]      = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_TANKELLUR]     = BACK_ANIM_V_SHAKE,
    [SPECIES_SCRILL]     = BACK_ANIM_H_SLIDE,
    [SPECIES_OVERSCRILL]      = BACK_ANIM_H_SLIDE,
    [SPECIES_SNOUTUSSLE]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GRAPPOUCH]      = BACK_ANIM_H_SLIDE,
    [SPECIES_SWORMO]   = BACK_ANIM_H_SHAKE,
    [SPECIES_EKANS]    = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_PIKACHU]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
