...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_SCRILL]   = BACK_ANIM_H_VIBRATE,
    [SPECIES_OVERSCRILL]     = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_COILARVA]  = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_MORPHYDRA]    = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_CYBIRD] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_PTEROCAST] = BACK_ANIM_GROW,
