...
{
    [SPECIES_BADGERP]  = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_HUHGER]    = BACK_ANIM_H_SLIDE,
    [SPECIES_MELECIUM]   = BACK_ANIM_H_SHAKE,
    [SPECIES_TEPILLA] = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_ESCORCHES] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SOLADOR]  = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_RELENTOOTH]   = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SNARETHAN]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_LEVIAMAWL]  = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_DISCUTTLE]   = BACK_ANIM_H_SLIDE,
    [SPECIES_TENNADISH]    = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_WEBILLITE] = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_GALACTIVY]     = BACK_ANIM_H_SLIDE,
    [SPECIES_XENOWEED]     = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_SNAGOON]   = BACK_ANIM_H_VIBRATE,
    [SPECIES_REPOCOON]     = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_COILARVA]  = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_COILOCUS]    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_DRAMAGO]    = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_FELIGHT]   = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_SILWING]    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_FOMPOUS]     = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_ASTROHAUT]      = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_WIRLIXPLOR]      = BACK_ANIM_V_SHAKE,
    [SPECIES_GENTOO]    = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_SAWFUL]     = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_SAULLACE]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_RUMOSS]  = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_LIAYARD]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_TADEA]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_BATRACHITE]  = BACK_ANIM_V_SHAKE,
    [SPECIES_TOAGNITIVE]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SILICTAL]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CRYSTURDY]   = BACK_ANIM_V_SHAKE,
    [SPECIES_QUARDIAN]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_BANANEE]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_BANAGON]     = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_SALANANA]  = BACK_ANIM_H_VIBRATE,
    [SPECIES_HYPADOG] = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_HYPADOG2] = BACK_ANIM_GROW,
    [SPECIES_AMOBI]      = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_AMOBERIA]     = BACK_ANIM_V_SHAKE,
    [SPECIES_TANKELLUR]     = BACK_ANIM_H_SLIDE,
    [SPECIES_CYCLIL]      = BACK_ANIM_H_SLIDE,
    [SPECIES_ROADILLO]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_COATTAIL]      = BACK_ANIM_H_SLIDE,
    [SPECIES_COATOAC]   = BACK_ANIM_H_SHAKE,
    [SPECIES_SNOUTUSSLE]    = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_GRAPPOUCH]   = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_CYBIRD]    = BACK_ANIM_V_SHAKE,
    [SPECIES_PTEROCAST]    = BACK_ANIM_V_SHAKE,
    [SPECIES_MEOWTH]     = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_PERSIAN]    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_PSYDUCK]    = BACK_ANIM_H_SLIDE,
    [SPECIES_AILES]    = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_NACLES]     = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_LICLES]   = BACK_ANIM_CONCAVE_ARC_LARGE,
