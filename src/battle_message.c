...
static const u8 sText_DragonAuraActivates[] =_("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is radiating\na draconic aura!");
...
static const u8 sText_PkmnInSnapTrap[] = _("{B_DEF_NAME_WITH_PREFIX} got trapped by a {B_CURRENT_MOVE}!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_DRAGONAURAENTERS - BATTLESTRINGS_TABLE_START] = sText_DragonAuraActivates,
