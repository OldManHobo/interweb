...
{
    [SPECIES_NONE] = gMonIcon_Genera,
    [SPECIES_GENERA] = gMonIcon_Genera,
    [SPECIES_GYANNEX] = gMonIcon_Gyannex,
    [SPECIES_KAZEIYAGA] = gMonIcon_Kazeiyaga,
    [SPECIES_TEPILLA] = gMonIcon_Tepilla,
    [SPECIES_ESCORCHES] = gMonIcon_Escorches,
    [SPECIES_SOLADOR] = gMonIcon_Solador,
    [SPECIES_RELENTOOTH] = gMonIcon_Relentooth,
    [SPECIES_SNARETHAN] = gMonIcon_Snarethan,
    [SPECIES_LEVIAMAWL] = gMonIcon_Leviamawl,
    [SPECIES_DISCUTTLE] = gMonIcon_Discuttle,
    [SPECIES_TENNADISH] = gMonIcon_Tennadish,
    [SPECIES_WEBILLITE] = gMonIcon_Webillite,
    [SPECIES_GALACTIVY] = gMonIcon_Galactivy,
    [SPECIES_XENOWEED] = gMonIcon_Xenoweed,
    [SPECIES_COATTAIL] = gMonIcon_Coattail,
    [SPECIES_COATOAC] = gMonIcon_Coatoac,
    [SPECIES_CYCLIL] = gMonIcon_Cyclil,
    [SPECIES_ROADILLO] = gMonIcon_Roadillo,
    [SPECIES_COILARVA] = gMonIcon_Coilarva,
    [SPECIES_MORPHYDRA] = gMonIcon_Morphydra,
    [SPECIES_DRAMAGO] = gMonIcon_Dramago,
    [SPECIES_FELIGHT] = gMonIcon_Felight,
    [SPECIES_SILWING] = gMonIcon_Silwing,
    [SPECIES_FOMPOUS] = gMonIcon_Fompous,
    [SPECIES_ASTROHAUT] = gMonIcon_Astrohaut,
    [SPECIES_WIRLIXPLOR] = gMonIcon_Wirlixplor,
    [SPECIES_RUMOSS] = gMonIcon_Rumoss,
    [SPECIES_LIAYARD] = gMonIcon_Liayard,
    [SPECIES_TADEA] = gMonIcon_Tadea,
    [SPECIES_BATRACHITE] = gMonIcon_Batrachite,
    [SPECIES_TOAGNITIVE] = gMonIcon_Toagnitive,
    [SPECIES_SILICTAL] = gMonIcon_Silictal,
    [SPECIES_CRYSTURDY] = gMonIcon_Crysturdy,
    [SPECIES_QUARDIAN] = gMonIcon_Quardian,
    [SPECIES_BANANEE] = gMonIcon_Bananee,
    [SPECIES_BANAGON] = gMonIcon_Banagon,
    [SPECIES_SALANANA] = gMonIcon_Salanana,
    [SPECIES_CYBIRD] = gMonIcon_Cybird,
    [SPECIES_PTEROCAST] = gMonIcon_Pterocast,
    [SPECIES_AMOBI] = gMonIcon_Amobi,
    [SPECIES_AMOBERIA] = gMonIcon_Amoberia,
    [SPECIES_TANKELLUR] = gMonIcon_Tankellur,
    [SPECIES_SCRILL] = gMonIcon_Scrill,
    [SPECIES_OVERSCRILL] = gMonIcon_Overscrill,
    [SPECIES_SNOUTUSSLE] = gMonIcon_Snoutussle,
    [SPECIES_GRAPPOUCH] = gMonIcon_Grappouch,
    [SPECIES_SWORMO] = gMonIcon_Swormo,
    [SPECIES_EKANS] = gMonIcon_Venonat,
    [SPECIES_PIKACHU] = gMonIcon_Venomoth,
...
#endif
    [SPECIES_KAZEIYAGA_MEGA] = gMonIcon_KazeiyagaMega,
    [SPECIES_SOLADOR_MEGA_X] = gMonIcon_SoladorMegaX,
    [SPECIES_SOLADOR_MEGA_Y] = gMonIcon_SoladorMegaY,
    [SPECIES_LEVIAMAWL_MEGA] = gMonIcon_LeviamawlMega,
    [SPECIES_COATTAIL_MEGA] = gMonIcon_CoattailMega,
    [SPECIES_ROADILLO_MEGA] = gMonIcon_RoadilloMega,
    ...
    [SPECIES_COILARVA_ALOLAN] = gMonIcon_CoilarvaAlolan,
    [SPECIES_MORPHYDRA_ALOLAN] = gMonIcon_MorphydraAlolan,
    [SPECIES_WIRLIXPLOR_ALOLAN] = gMonIcon_WirlixplorAlolan,
    [SPECIES_RUMOSS_ALOLAN] = gMonIcon_RumossAlolan,
    [SPECIES_LIAYARD_ALOLAN] = gMonIcon_LiayardAlolan,
    [SPECIES_SALANANA_ALOLAN] = gMonIcon_SalananaAlolan,
    [SPECIES_CYBIRD_ALOLAN] = gMonIcon_CybirdAlolan,
...
#endif
    [SPECIES_ASTROHAUT_COSPLAY] = gMonIcon_AstrohautCosplay,
    [SPECIES_ASTROHAUT_ROCK_STAR] = gMonIcon_AstrohautRockStar,
    [SPECIES_ASTROHAUT_BELLE] = gMonIcon_AstrohautBelle,
    [SPECIES_ASTROHAUT_POP_STAR] = gMonIcon_AstrohautPopStar,
    [SPECIES_ASTROHAUT_PH_D] = gMonIcon_AstrohautPhD,
    [SPECIES_ASTROHAUT_LIBRE] = gMonIcon_AstrohautLibre,
    [SPECIES_ASTROHAUT_ORIGINAL_CAP] = gMonIcon_AstrohautOriginalCap,
    [SPECIES_ASTROHAUT_HOENN_CAP] = gMonIcon_AstrohautHoennCap,
    [SPECIES_ASTROHAUT_SINNOH_CAP] = gMonIcon_AstrohautSinnohCap,
    [SPECIES_ASTROHAUT_UNOVA_CAP] = gMonIcon_AstrohautUnovaCap,
    [SPECIES_ASTROHAUT_KALOS_CAP] = gMonIcon_AstrohautKalosCap,
    [SPECIES_ASTROHAUT_ALOLA_CAP] = gMonIcon_AstrohautAlolaCap,
    [SPECIES_ASTROHAUT_PARTNER_CAP] = gMonIcon_AstrohautPartnerCap,
    [SPECIES_ASTROHAUT_WORLD_CAP] = gMonIcon_QuestionMark,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_COILARVA_ALOLAN] = 2,
    [SPECIES_MORPHYDRA_ALOLAN] = 2,
    [SPECIES_WIRLIXPLOR_ALOLAN] = 2,
    [SPECIES_RUMOSS_ALOLAN] = 0,
    [SPECIES_LIAYARD_ALOLAN] = 0,
    ...
    [SPECIES_ASTROHAUT_COSPLAY] = 2,
    [SPECIES_ASTROHAUT_ROCK_STAR] = 1,
    [SPECIES_ASTROHAUT_BELLE] = 0,
    [SPECIES_ASTROHAUT_POP_STAR] = 0,
    [SPECIES_ASTROHAUT_PH_D] = 1,
    [SPECIES_ASTROHAUT_LIBRE] = 0,
    [SPECIES_ASTROHAUT_ORIGINAL_CAP] = 0,
    [SPECIES_ASTROHAUT_HOENN_CAP] = 0,
    [SPECIES_ASTROHAUT_SINNOH_CAP] = 0,
    [SPECIES_ASTROHAUT_UNOVA_CAP] = 0,
    [SPECIES_ASTROHAUT_KALOS_CAP] = 0,
    [SPECIES_ASTROHAUT_ALOLA_CAP] = 0,
    [SPECIES_ASTROHAUT_PARTNER_CAP] = 0,
    [SPECIES_ASTROHAUT_WORLD_CAP] = 0,
