...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_COATTAIL] = gMonIcon_Beedrill,
    [SPECIES_COATOAC] = gMonIcon_Pidgey,
    [SPECIES_CYCLIL] = gMonIcon_Pidgeotto,
    [SPECIES_ROADILLO] = gMonIcon_Pidgeot,
    [SPECIES_COILARVA] = gMonIcon_Rattata,
    [SPECIES_MORPHYDRA] = gMonIcon_Raticate,
    [SPECIES_DRAMAGO] = gMonIcon_Spearow,
    [SPECIES_FELIGHT] = gMonIcon_Fearow,
    [SPECIES_SILWING] = gMonIcon_Ekans,
    [SPECIES_FOMPOUS] = gMonIcon_Arbok,
    [SPECIES_ASTROHAUT] = gMonIcon_Pikachu,
    [SPECIES_WIRLIXPLOR] = gMonIcon_Raichu,
    [SPECIES_RUMOSS] = gMonIcon_Sandshrew,
    [SPECIES_LIAYARD] = gMonIcon_Sandslash,
    [SPECIES_TADEA] = gMonIcon_NidoranF,
    [SPECIES_BATRACHITE] = gMonIcon_Nidorina,
    [SPECIES_TOAGNITIVE] = gMonIcon_Nidoqueen,
    [SPECIES_SILICTAL] = gMonIcon_NidoranM,
    [SPECIES_CRYSTURDY] = gMonIcon_Nidorino,
    [SPECIES_QUARDIAN] = gMonIcon_Nidoking,
    [SPECIES_BANANEE] = gMonIcon_Clefairy,
    [SPECIES_BANAGON] = gMonIcon_Clefable,
    [SPECIES_SALANANA] = gMonIcon_Vulpix,
    [SPECIES_CYBIRD] = gMonIcon_Ninetales,
    [SPECIES_PTEROCAST] = gMonIcon_Jigglypuff,
    [SPECIES_AMOBI] = gMonIcon_Wigglytuff,
    [SPECIES_AMOBERIA] = gMonIcon_Zubat,
    [SPECIES_TANKELLUR] = gMonIcon_Golbat,
    [SPECIES_SCRILL] = gMonIcon_Oddish,
    [SPECIES_OVERSCRILL] = gMonIcon_Gloom,
    [SPECIES_SNOUTUSSLE] = gMonIcon_Vileplume,
    [SPECIES_GRAPPOUCH] = gMonIcon_Paras,
    [SPECIES_SWORMO] = gMonIcon_Parasect,
    ...
    [SPECIES_COATTAIL_MEGA] = gMonIcon_BeedrillMega,
    [SPECIES_ROADILLO_MEGA] = gMonIcon_PidgeotMega,
    ...
    [SPECIES_COILARVA_ALOLAN] = gMonIcon_RattataAlolan,
    [SPECIES_MORPHYDRA_ALOLAN] = gMonIcon_RaticateAlolan,
    [SPECIES_WIRLIXPLOR_ALOLAN] = gMonIcon_RaichuAlolan,
    [SPECIES_RUMOSS_ALOLAN] = gMonIcon_SandshrewAlolan,
    [SPECIES_LIAYARD_ALOLAN] = gMonIcon_SandslashAlolan,
    [SPECIES_SALANANA_ALOLAN] = gMonIcon_VulpixAlolan,
    [SPECIES_CYBIRD_ALOLAN] = gMonIcon_NinetalesAlolan,
...
#endif
    [SPECIES_ASTROHAUT_COSPLAY] = gMonIcon_PikachuCosplay,
    [SPECIES_ASTROHAUT_ROCK_STAR] = gMonIcon_PikachuRockStar,
    [SPECIES_ASTROHAUT_BELLE] = gMonIcon_PikachuBelle,
    [SPECIES_ASTROHAUT_POP_STAR] = gMonIcon_PikachuPopStar,
    [SPECIES_ASTROHAUT_PH_D] = gMonIcon_PikachuPhD,
    [SPECIES_ASTROHAUT_LIBRE] = gMonIcon_PikachuLibre,
    [SPECIES_ASTROHAUT_ORIGINAL_CAP] = gMonIcon_PikachuOriginalCap,
    [SPECIES_ASTROHAUT_HOENN_CAP] = gMonIcon_PikachuHoennCap,
    [SPECIES_ASTROHAUT_SINNOH_CAP] = gMonIcon_PikachuSinnohCap,
    [SPECIES_ASTROHAUT_UNOVA_CAP] = gMonIcon_PikachuUnovaCap,
    [SPECIES_ASTROHAUT_KALOS_CAP] = gMonIcon_PikachuKalosCap,
    [SPECIES_ASTROHAUT_ALOLA_CAP] = gMonIcon_PikachuAlolaCap,
    [SPECIES_ASTROHAUT_PARTNER_CAP] = gMonIcon_PikachuPartnerCap,
