...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_BADGERP] = gMonIcon_Bulbasaur,
    [SPECIES_HUHGER] = gMonIcon_Ivysaur,
    [SPECIES_MELECIUM] = gMonIcon_Venusaur,
    [SPECIES_TEPILLA] = gMonIcon_Charmander,
    [SPECIES_ESCORCHES] = gMonIcon_Charmeleon,
    [SPECIES_SOLADOR] = gMonIcon_Charizard,
    [SPECIES_RELENTOOTH] = gMonIcon_Squirtle,
    [SPECIES_SNARETHAN] = gMonIcon_Wartortle,
    [SPECIES_LEVIAMAWL] = gMonIcon_Blastoise,
    [SPECIES_DISCUTTLE] = gMonIcon_Caterpie,
    [SPECIES_TENNADISH] = gMonIcon_Metapod,
    [SPECIES_WEBILLITE] = gMonIcon_Butterfree,
    [SPECIES_GALACTIVY] = gMonIcon_Weedle,
    [SPECIES_XENOWEED] = gMonIcon_Kakuna,
    [SPECIES_SNAGOON] = gMonIcon_Beedrill,
    [SPECIES_REPOCOON] = gMonIcon_Pidgey,
    [SPECIES_COILARVA] = gMonIcon_Pidgeotto,
    [SPECIES_COILOCUS] = gMonIcon_Pidgeot,
    [SPECIES_DRAMAGO] = gMonIcon_Rattata,
    [SPECIES_FELIGHT] = gMonIcon_Raticate,
    [SPECIES_SILWING] = gMonIcon_Spearow,
    [SPECIES_FOMPOUS] = gMonIcon_Fearow,
    [SPECIES_ASTROHAUT] = gMonIcon_Ekans,
    [SPECIES_WIRLIXPLOR] = gMonIcon_Arbok,
    [SPECIES_GENTOO] = gMonIcon_Pikachu,
    [SPECIES_SAWFUL] = gMonIcon_Raichu,
    [SPECIES_SAULLACE] = gMonIcon_Sandshrew,
    [SPECIES_RUMOSS] = gMonIcon_Sandslash,
    [SPECIES_LIAYARD] = gMonIcon_NidoranF,
    [SPECIES_TADEA] = gMonIcon_Nidorina,
    [SPECIES_BATRACHITE] = gMonIcon_Nidoqueen,
    [SPECIES_TOAGNITIVE] = gMonIcon_NidoranM,
    [SPECIES_SILICTAL] = gMonIcon_Nidorino,
    [SPECIES_CRYSTURDY] = gMonIcon_Nidoking,
    [SPECIES_QUARDIAN] = gMonIcon_Clefairy,
    [SPECIES_BANANEE] = gMonIcon_Clefable,
    [SPECIES_BANAGON] = gMonIcon_Vulpix,
    [SPECIES_SALANANA] = gMonIcon_Ninetales,
    [SPECIES_HYPADOG] = gMonIcon_Jigglypuff,
    [SPECIES_HYPADOG2] = gMonIcon_Wigglytuff,
    [SPECIES_AMOBI] = gMonIcon_Zubat,
    [SPECIES_AMOBERIA] = gMonIcon_Golbat,
    [SPECIES_TANKELLUR] = gMonIcon_Oddish,
    [SPECIES_CYCLIL] = gMonIcon_Gloom,
    [SPECIES_ROADILLO] = gMonIcon_Vileplume,
    [SPECIES_COATTAIL] = gMonIcon_Paras,
    [SPECIES_COATOAC] = gMonIcon_Parasect,
    [SPECIES_SNOUTUSSLE] = gMonIcon_Venonat,
    [SPECIES_GRAPPOUCH] = gMonIcon_Venomoth,
    [SPECIES_CYBIRD] = gMonIcon_Diglett,
    [SPECIES_PTEROCAST] = gMonIcon_Dugtrio,
    [SPECIES_MEOWTH] = gMonIcon_Meowth,
    [SPECIES_PERSIAN] = gMonIcon_Persian,
    [SPECIES_PSYDUCK] = gMonIcon_Psyduck,
    [SPECIES_AILES] = gMonIcon_Golduck,
    [SPECIES_NACLES] = gMonIcon_Mankey,
    [SPECIES_LICLES] = gMonIcon_Primeape,
...
#endif
    [SPECIES_MELECIUM_MEGA] = gMonIcon_VenusaurMega,
    [SPECIES_SOLADOR_MEGA_X] = gMonIcon_CharizardMegaX,
    [SPECIES_SOLADOR_MEGA_Y] = gMonIcon_CharizardMegaY,
    [SPECIES_LEVIAMAWL_MEGA] = gMonIcon_BlastoiseMega,
    [SPECIES_SNAGOON_MEGA] = gMonIcon_BeedrillMega,
    [SPECIES_COILOCUS_MEGA] = gMonIcon_PidgeotMega,
    ...
    [SPECIES_DRAMAGO_ALOLAN] = gMonIcon_RattataAlolan,
    [SPECIES_FELIGHT_ALOLAN] = gMonIcon_RaticateAlolan,
    [SPECIES_SAWFUL_ALOLAN] = gMonIcon_RaichuAlolan,
    [SPECIES_SAULLACE_ALOLAN] = gMonIcon_SandshrewAlolan,
    [SPECIES_RUMOSS_ALOLAN] = gMonIcon_SandslashAlolan,
    [SPECIES_BANAGON_ALOLAN] = gMonIcon_VulpixAlolan,
    [SPECIES_SALANANA_ALOLAN] = gMonIcon_NinetalesAlolan,
    [SPECIES_CYBIRD_ALOLAN] = gMonIcon_DiglettAlolan,
    [SPECIES_PTEROCAST_ALOLAN] = gMonIcon_DugtrioAlolan,
...
#endif
    [SPECIES_GENTOO_COSPLAY] = gMonIcon_PikachuCosplay,
    [SPECIES_GENTOO_ROCK_STAR] = gMonIcon_PikachuRockStar,
    [SPECIES_GENTOO_BELLE] = gMonIcon_PikachuBelle,
    [SPECIES_GENTOO_POP_STAR] = gMonIcon_PikachuPopStar,
    [SPECIES_GENTOO_PH_D] = gMonIcon_PikachuPhD,
    [SPECIES_GENTOO_LIBRE] = gMonIcon_PikachuLibre,
    [SPECIES_GENTOO_ORIGINAL_CAP] = gMonIcon_PikachuOriginalCap,
    [SPECIES_GENTOO_HOENN_CAP] = gMonIcon_PikachuHoennCap,
    [SPECIES_GENTOO_SINNOH_CAP] = gMonIcon_PikachuSinnohCap,
    [SPECIES_GENTOO_UNOVA_CAP] = gMonIcon_PikachuUnovaCap,
    [SPECIES_GENTOO_KALOS_CAP] = gMonIcon_PikachuKalosCap,
    [SPECIES_GENTOO_ALOLA_CAP] = gMonIcon_PikachuAlolaCap,
    [SPECIES_GENTOO_PARTNER_CAP] = gMonIcon_PikachuPartnerCap,
    [SPECIES_GENTOO_WORLD_CAP] = gMonIcon_QuestionMark,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_LIAYARD] = 5,
    [SPECIES_TADEA] = 0,
    [SPECIES_BATRACHITE] = 0,
    [SPECIES_TOAGNITIVE] = 0,
    [SPECIES_SILICTAL] = 0,
    [SPECIES_CRYSTURDY] = 0,
    [SPECIES_QUARDIAN] = 0,
    [SPECIES_BANANEE] = 5,
    ...
    [SPECIES_OVERQWIL] = 2,
    [SPECIES_ENAMORUS] = 1,
    [SPECIES_MELECIUM_MEGA] = 1,
    [SPECIES_SOLADOR_MEGA_X] = 0,
    [SPECIES_SOLADOR_MEGA_Y] = 0,
    [SPECIES_LEVIAMAWL_MEGA] = 2,
    [SPECIES_SNAGOON_MEGA] = 2,
    [SPECIES_COILOCUS_MEGA] = 0,
    ...
    [SPECIES_DRAMAGO_ALOLAN] = 2,
    [SPECIES_FELIGHT_ALOLAN] = 2,
    [SPECIES_SAWFUL_ALOLAN] = 2,
    [SPECIES_SAULLACE_ALOLAN] = 0,
    [SPECIES_RUMOSS_ALOLAN] = 0,
    [SPECIES_BANAGON_ALOLAN] = 2,
    [SPECIES_SALANANA_ALOLAN] = 2,
    [SPECIES_CYBIRD_ALOLAN] = 2,
    [SPECIES_PTEROCAST_ALOLAN] = 2,
    ...
    [SPECIES_GENTOO_COSPLAY] = 2,
    [SPECIES_GENTOO_ROCK_STAR] = 1,
    [SPECIES_GENTOO_BELLE] = 0,
    [SPECIES_GENTOO_POP_STAR] = 0,
    [SPECIES_GENTOO_PH_D] = 1,
    [SPECIES_GENTOO_LIBRE] = 0,
    [SPECIES_GENTOO_ORIGINAL_CAP] = 0,
    [SPECIES_GENTOO_HOENN_CAP] = 0,
    [SPECIES_GENTOO_SINNOH_CAP] = 0,
    [SPECIES_GENTOO_UNOVA_CAP] = 0,
    [SPECIES_GENTOO_KALOS_CAP] = 0,
    [SPECIES_GENTOO_ALOLA_CAP] = 0,
    [SPECIES_GENTOO_PARTNER_CAP] = 0,
    [SPECIES_GENTOO_WORLD_CAP] = 0,
