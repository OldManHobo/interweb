const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // Mega Stones
    [ITEM_MELECIUMITE] = {gItemIcon_Venusaurite, gItemIconPalette_Venusaurite},
    [ITEM_SOLADORITE_X] = {gItemIcon_CharizarditeX, gItemIconPalette_CharizarditeX},
    [ITEM_SOLADORITE_Y] = {gItemIcon_CharizarditeY, gItemIconPalette_CharizarditeY},
    [ITEM_BLASTOISINITE] = {gItemIcon_Blastoisinite, gItemIconPalette_Blastoisinite},
    [ITEM_COATTAILITE] = {gItemIcon_Beedrillite, gItemIconPalette_Beedrillite},
    [ITEM_ROADILLOITE] = {gItemIcon_Pidgeotite, gItemIconPalette_Pidgeotite},
