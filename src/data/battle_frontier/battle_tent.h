...
{
    SLATEPORT_TENT_MON_XENOWEED_3,
    SLATEPORT_TENT_MON_COATOAC,
    SLATEPORT_TENT_MON_ROADILLO_3,
    SLATEPORT_TENT_MON_OVERSCRILL_2,
...
{
    SLATEPORT_TENT_MON_XENOWEED_3,
    SLATEPORT_TENT_MON_WIRLIXPLOR_1,
    SLATEPORT_TENT_MON_WIRLIXPLOR_2,
    SLATEPORT_TENT_MON_OVERSCRILL_2,
...
{
    SLATEPORT_TENT_MON_LEVIAMAWL_1,
    SLATEPORT_TENT_MON_LEVIAMAWL_2,
    SLATEPORT_TENT_MON_WEBILLITE,
    SLATEPORT_TENT_MON_ROADILLO_1,
    SLATEPORT_TENT_MON_GRAPPOUCH_1,
...
const u16 gSlateportBattleTentTrainerMons_Davon[] =
{
    ...
    SLATEPORT_TENT_MON_LEVIAMAWL_2,
    SLATEPORT_TENT_MON_WEBILLITE,
    SLATEPORT_TENT_MON_ROADILLO_2,
    SLATEPORT_TENT_MON_OVERSCRILL_1,
    SLATEPORT_TENT_MON_NUMEL_1,
    SLATEPORT_TENT_MON_BARBOACH,
...
{
    SLATEPORT_TENT_MON_KAZEIYAGA_1,
    SLATEPORT_TENT_MON_KAZEIYAGA_2,
    SLATEPORT_TENT_MON_WIRLIXPLOR_2,
    SLATEPORT_TENT_MON_LIAYARD,
    SLATEPORT_TENT_MON_TOAGNITIVE,
    SLATEPORT_TENT_MON_SALANANA_1,
    SLATEPORT_TENT_MON_SALANANA_2,
...
const u16 gSlateportBattleTentTrainerMons_Rodolfo[] =
{
    ...
    SLATEPORT_TENT_MON_LEVIAMAWL_1,
    SLATEPORT_TENT_MON_LEVIAMAWL_2,
    SLATEPORT_TENT_MON_XENOWEED_1,
    SLATEPORT_TENT_MON_XENOWEED_2,
    SLATEPORT_TENT_MON_LIAYARD,
    SLATEPORT_TENT_MON_QUARDIAN_1,
    SLATEPORT_TENT_MON_QUARDIAN_2,
    SLATEPORT_TENT_MON_BARBOACH,
    SLATEPORT_TENT_MON_TENTACOOL,
    SLATEPORT_TENT_MON_MAGIKARP,
...
const u16 gSlateportBattleTentTrainerMons_Davion[] =
{
    SLATEPORT_TENT_MON_WIRLIXPLOR_2,
    SLATEPORT_TENT_MON_SALANANA_2,
    SLATEPORT_TENT_MON_PTEROCAST_1,
    SLATEPORT_TENT_MON_PTEROCAST_2,
...
{
    SLATEPORT_TENT_MON_KAZEIYAGA_1,
    SLATEPORT_TENT_MON_SOLADOR_1,
    SLATEPORT_TENT_MON_ROADILLO_2,
    SLATEPORT_TENT_MON_SALANANA_1,
    SLATEPORT_TENT_MON_GRAPPOUCH_1,
    SLATEPORT_TENT_MON_SWORMO,
    SLATEPORT_TENT_MON_MAKUHITA,
    SLATEPORT_TENT_MON_TENTACOOL,
    SLATEPORT_TENT_MON_KECLEON_1,
    SLATEPORT_TENT_MON_KECLEON_2,
...
const u16 gSlateportBattleTentTrainerMons_Irvin[] =
{
    ...
    SLATEPORT_TENT_MON_KAZEIYAGA_2,
    SLATEPORT_TENT_MON_SOLADOR_1,
    SLATEPORT_TENT_MON_SOLADOR_2,
    SLATEPORT_TENT_MON_DRAMAGO,
    SLATEPORT_TENT_MON_SILWING,
    SLATEPORT_TENT_MON_PTEROCAST_1,
    SLATEPORT_TENT_MON_PTEROCAST_2,
    SLATEPORT_TENT_MON_SPINDA,
    SLATEPORT_TENT_MON_WHISMUR,
...
const u16 gSlateportBattleTentTrainerMons_Shaun[] =
{
    ...
    SLATEPORT_TENT_MON_TOAGNITIVE,
    SLATEPORT_TENT_MON_SALANANA_1,
    SLATEPORT_TENT_MON_GRAPPOUCH_2,
    SLATEPORT_TENT_MON_NUMEL_1,
    SLATEPORT_TENT_MON_SOLROCK,
    SLATEPORT_TENT_MON_NUMEL_2,
    SLATEPORT_TENT_MON_KADABRA,
...
const u16 gSlateportBattleTentTrainerMons_Kyler[] =
{
    ...
    SLATEPORT_TENT_MON_WHISMUR,
    SLATEPORT_TENT_MON_VIGOROTH,
    SLATEPORT_TENT_MON_TANKELLUR_2,
    SLATEPORT_TENT_MON_PLUSLE_1,
    SLATEPORT_TENT_MON_PLUSLE_2,
...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[NUM_BATTLE_TENT_TRAINERS] =
{
    ...
    [SLATEPORT_TENT_TRAINER_MAGGIE] = {
        ...
        .speechBefore = {EC_POKEMON(SALANANA), EC_POKEMON(XATU), EC_POKEMON_NATIONAL(UMBREON), EC_WORD_ELLIPSIS, EC_WORD_UM, EC_WORD_ELLIPSIS},
