const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(GENERA, gMonBackPic_Genera),
    SPECIES_SPRITE(GYANNEX, gMonBackPic_Gyannex),
    SPECIES_SPRITE(KAZEIYAGA, gMonBackPic_Kazeiyaga),
    SPECIES_SPRITE(TEPILLA, gMonBackPic_Tepilla),
    SPECIES_SPRITE(ESCORCHES, gMonBackPic_Escorches),
    SPECIES_SPRITE(SOLADOR, gMonBackPic_Solador),
    SPECIES_SPRITE(RELENTOOTH, gMonBackPic_Relentooth),
    SPECIES_SPRITE(SNARETHAN, gMonBackPic_Snarethan),
    SPECIES_SPRITE(LEVIAMAWL, gMonBackPic_Leviamawl),
    SPECIES_SPRITE(DISCUTTLE, gMonBackPic_Discuttle),
    SPECIES_SPRITE(TENNADISH, gMonBackPic_Tennadish),
    SPECIES_SPRITE(WEBILLITE, gMonBackPic_Webillite),
    SPECIES_SPRITE(GALACTIVY, gMonBackPic_Galactivy),
    SPECIES_SPRITE(XENOWEED, gMonBackPic_Xenoweed),
    SPECIES_SPRITE(COATTAIL, gMonBackPic_Coattail),
    SPECIES_SPRITE(COATOAC, gMonBackPic_Coatoac),
    SPECIES_SPRITE(CYCLIL, gMonBackPic_Cyclil),
    SPECIES_SPRITE(ROADILLO, gMonBackPic_Roadillo),
    SPECIES_SPRITE(COILARVA, gMonBackPic_Coilarva),
    SPECIES_SPRITE(MORPHYDRA, gMonBackPic_Morphydra),
    SPECIES_SPRITE(DRAMAGO, gMonBackPic_Dramago),
    SPECIES_SPRITE(FELIGHT, gMonBackPic_Felight),
    SPECIES_SPRITE(SILWING, gMonBackPic_Silwing),
    SPECIES_SPRITE(FOMPOUS, gMonBackPic_Fompous),
    SPECIES_SPRITE(ASTROHAUT, gMonBackPic_Astrohaut),
    SPECIES_SPRITE(WIRLIXPLOR, gMonBackPic_Wirlixplor),
    SPECIES_SPRITE(RUMOSS, gMonBackPic_Rumoss),
    SPECIES_SPRITE(LIAYARD, gMonBackPic_Liayard),
    SPECIES_SPRITE(TADEA, gMonBackPic_Tadea),
    SPECIES_SPRITE(BATRACHITE, gMonBackPic_Batrachite),
    SPECIES_SPRITE(TOAGNITIVE, gMonBackPic_Toagnitive),
    SPECIES_SPRITE(SILICTAL, gMonBackPic_Silictal),
    SPECIES_SPRITE(CRYSTURDY, gMonBackPic_Crysturdy),
    SPECIES_SPRITE(QUARDIAN, gMonBackPic_Quardian),
    SPECIES_SPRITE(BANANEE, gMonBackPic_Bananee),
    SPECIES_SPRITE(BANAGON, gMonBackPic_Banagon),
    SPECIES_SPRITE(SALANANA, gMonBackPic_Salanana),
    SPECIES_SPRITE(CYBIRD, gMonBackPic_Cybird),
    SPECIES_SPRITE(PTEROCAST, gMonBackPic_Pterocast),
    SPECIES_SPRITE(AMOBI, gMonBackPic_Amobi),
    SPECIES_SPRITE(AMOBERIA, gMonBackPic_Amoberia),
    SPECIES_SPRITE(TANKELLUR, gMonBackPic_Tankellur),
    SPECIES_SPRITE(SCRILL, gMonBackPic_Scrill),
    SPECIES_SPRITE(OVERSCRILL, gMonBackPic_Overscrill),
    SPECIES_SPRITE(SNOUTUSSLE, gMonBackPic_Snoutussle),
    SPECIES_SPRITE(GRAPPOUCH, gMonBackPic_Grappouch),
    SPECIES_SPRITE(SWORMO, gMonBackPic_Swormo),
    SPECIES_SPRITE(EKANS, gMonBackPic_Venonat),
    SPECIES_SPRITE(PIKACHU, gMonBackPic_Venomoth),
    ...
    SPECIES_SPRITE(KAZEIYAGA_MEGA, gMonBackPic_KazeiyagaMega),
    SPECIES_SPRITE(SOLADOR_MEGA_X, gMonBackPic_SoladorMegaX),
    SPECIES_SPRITE(SOLADOR_MEGA_Y, gMonBackPic_SoladorMegaY),
    SPECIES_SPRITE(LEVIAMAWL_MEGA, gMonBackPic_LeviamawlMega),
    SPECIES_SPRITE(COATTAIL_MEGA, gMonBackPic_CoattailMega),
    SPECIES_SPRITE(ROADILLO_MEGA, gMonBackPic_RoadilloMega),
    ...
    SPECIES_SPRITE(COILARVA_ALOLAN, gMonBackPic_CoilarvaAlolan),
    SPECIES_SPRITE(MORPHYDRA_ALOLAN, gMonBackPic_MorphydraAlolan),
    SPECIES_SPRITE(WIRLIXPLOR_ALOLAN, gMonBackPic_WirlixplorAlolan),
    SPECIES_SPRITE(RUMOSS_ALOLAN, gMonBackPic_RumossAlolan),
    SPECIES_SPRITE(LIAYARD_ALOLAN, gMonBackPic_LiayardAlolan),
    SPECIES_SPRITE(SALANANA_ALOLAN, gMonBackPic_SalananaAlolan),
    SPECIES_SPRITE(CYBIRD_ALOLAN, gMonBackPic_CybirdAlolan),
    ...
    SPECIES_SPRITE(ASTROHAUT_COSPLAY, gMonBackPic_AstrohautCosplay),
    SPECIES_SPRITE(ASTROHAUT_ROCK_STAR, gMonBackPic_AstrohautRockStar),
    SPECIES_SPRITE(ASTROHAUT_BELLE, gMonBackPic_AstrohautBelle),
    SPECIES_SPRITE(ASTROHAUT_POP_STAR, gMonBackPic_AstrohautPopStar),
    SPECIES_SPRITE(ASTROHAUT_PH_D, gMonBackPic_AstrohautPhD),
    SPECIES_SPRITE(ASTROHAUT_LIBRE, gMonBackPic_AstrohautLibre),

    SPECIES_SPRITE(ASTROHAUT_ORIGINAL_CAP, gMonBackPic_AstrohautOriginalCap),
    SPECIES_SPRITE(ASTROHAUT_HOENN_CAP, gMonBackPic_AstrohautHoennCap),
    SPECIES_SPRITE(ASTROHAUT_SINNOH_CAP, gMonBackPic_AstrohautSinnohCap),
    SPECIES_SPRITE(ASTROHAUT_UNOVA_CAP, gMonBackPic_AstrohautUnovaCap),
    SPECIES_SPRITE(ASTROHAUT_KALOS_CAP, gMonBackPic_AstrohautKalosCap),
    SPECIES_SPRITE(ASTROHAUT_ALOLA_CAP, gMonBackPic_AstrohautAlolaCap),
    SPECIES_SPRITE(ASTROHAUT_PARTNER_CAP, gMonBackPic_AstrohautPartnerCap),
    SPECIES_SPRITE(ASTROHAUT_WORLD_CAP, gMonBackPic_AstrohautWorldCap),
