const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(BADGERP, gMonBackPic_Bulbasaur),
    SPECIES_SPRITE(HUHGER, gMonBackPic_Ivysaur),
    SPECIES_SPRITE(MELECIUM, gMonBackPic_Venusaur),
    SPECIES_SPRITE(TEPILLA, gMonBackPic_Charmander),
    SPECIES_SPRITE(ESCORCHES, gMonBackPic_Charmeleon),
    SPECIES_SPRITE(SOLADOR, gMonBackPic_Charizard),
    SPECIES_SPRITE(RELENTOOTH, gMonBackPic_Squirtle),
    SPECIES_SPRITE(SNARETHAN, gMonBackPic_Wartortle),
    SPECIES_SPRITE(LEVIAMAWL, gMonBackPic_Blastoise),
    SPECIES_SPRITE(DISCUTTLE, gMonBackPic_Caterpie),
    SPECIES_SPRITE(TENNADISH, gMonBackPic_Metapod),
    SPECIES_SPRITE(WEBILLITE, gMonBackPic_Butterfree),
    SPECIES_SPRITE(GALACTIVY, gMonBackPic_Weedle),
    SPECIES_SPRITE(XENOWEED, gMonBackPic_Kakuna),
    SPECIES_SPRITE(SNAGOON, gMonBackPic_Beedrill),
    SPECIES_SPRITE(REPOCOON, gMonBackPic_Pidgey),
    SPECIES_SPRITE(COILARVA, gMonBackPic_Pidgeotto),
    SPECIES_SPRITE(COILOCUS, gMonBackPic_Pidgeot),
    SPECIES_SPRITE(DRAMAGO, gMonBackPic_Rattata),
    SPECIES_SPRITE(FELIGHT, gMonBackPic_Raticate),
    SPECIES_SPRITE(SILWING, gMonBackPic_Spearow),
    SPECIES_SPRITE(FOMPOUS, gMonBackPic_Fearow),
    SPECIES_SPRITE(ASTROHAUT, gMonBackPic_Ekans),
    SPECIES_SPRITE(WIRLIXPLOR, gMonBackPic_Arbok),
    SPECIES_SPRITE(GENTOO, gMonBackPic_Pikachu),
    SPECIES_SPRITE(SAWFUL, gMonBackPic_Raichu),
    SPECIES_SPRITE(SAULLACE, gMonBackPic_Sandshrew),
    SPECIES_SPRITE(RUMOSS, gMonBackPic_Sandslash),
    SPECIES_SPRITE(LIAYARD, gMonBackPic_NidoranF),
    SPECIES_SPRITE(TADEA, gMonBackPic_Nidorina),
    SPECIES_SPRITE(BATRACHITE, gMonBackPic_Nidoqueen),
    SPECIES_SPRITE(TOAGNITIVE, gMonBackPic_NidoranM),
    SPECIES_SPRITE(SILICTAL, gMonBackPic_Nidorino),
    SPECIES_SPRITE(CRYSTURDY, gMonBackPic_Nidoking),
    SPECIES_SPRITE(QUARDIAN, gMonBackPic_Clefairy),
    SPECIES_SPRITE(BANANEE, gMonBackPic_Clefable),
    SPECIES_SPRITE(BANAGON, gMonBackPic_Vulpix),
    SPECIES_SPRITE(SALANANA, gMonBackPic_Ninetales),
    SPECIES_SPRITE(HYPADOG, gMonBackPic_Jigglypuff),
    SPECIES_SPRITE(HYPADOG2, gMonBackPic_Wigglytuff),
    SPECIES_SPRITE(AMOBI, gMonBackPic_Zubat),
    SPECIES_SPRITE(AMOBERIA, gMonBackPic_Golbat),
    SPECIES_SPRITE(TANKELLUR, gMonBackPic_Oddish),
    SPECIES_SPRITE(CYCLIL, gMonBackPic_Gloom),
    SPECIES_SPRITE(ROADILLO, gMonBackPic_Vileplume),
    SPECIES_SPRITE(COATTAIL, gMonBackPic_Paras),
    SPECIES_SPRITE(COATOAC, gMonBackPic_Parasect),
    SPECIES_SPRITE(SNOUTUSSLE, gMonBackPic_Venonat),
    SPECIES_SPRITE(GRAPPOUCH, gMonBackPic_Venomoth),
    SPECIES_SPRITE(CYBIRD, gMonBackPic_Diglett),
    SPECIES_SPRITE(PTEROCAST, gMonBackPic_Dugtrio),
    ...
    SPECIES_SPRITE(AILES, gMonBackPic_Golduck),
    SPECIES_SPRITE(NACLES, gMonBackPic_Mankey),
    SPECIES_SPRITE(LICLES, gMonBackPic_Primeape),
    ...
    SPECIES_SPRITE(MELECIUM_MEGA, gMonBackPic_VenusaurMega),
    SPECIES_SPRITE(SOLADOR_MEGA_X, gMonBackPic_CharizardMegaX),
    SPECIES_SPRITE(SOLADOR_MEGA_Y, gMonBackPic_CharizardMegaY),
    SPECIES_SPRITE(LEVIAMAWL_MEGA, gMonBackPic_BlastoiseMega),
    SPECIES_SPRITE(SNAGOON_MEGA, gMonBackPic_BeedrillMega),
    SPECIES_SPRITE(COILOCUS_MEGA, gMonBackPic_PidgeotMega),
    ...
    SPECIES_SPRITE(DRAMAGO_ALOLAN, gMonBackPic_RattataAlolan),
    SPECIES_SPRITE(FELIGHT_ALOLAN, gMonBackPic_RaticateAlolan),
    SPECIES_SPRITE(SAWFUL_ALOLAN, gMonBackPic_RaichuAlolan),
    SPECIES_SPRITE(SAULLACE_ALOLAN, gMonBackPic_SandshrewAlolan),
    SPECIES_SPRITE(RUMOSS_ALOLAN, gMonBackPic_SandslashAlolan),
    SPECIES_SPRITE(BANAGON_ALOLAN, gMonBackPic_VulpixAlolan),
    SPECIES_SPRITE(SALANANA_ALOLAN, gMonBackPic_NinetalesAlolan),
    SPECIES_SPRITE(CYBIRD_ALOLAN, gMonBackPic_DiglettAlolan),
    SPECIES_SPRITE(PTEROCAST_ALOLAN, gMonBackPic_DugtrioAlolan),
    ...
    SPECIES_SPRITE(GENTOO_COSPLAY, gMonBackPic_PikachuCosplay),
    SPECIES_SPRITE(GENTOO_ROCK_STAR, gMonBackPic_PikachuRockStar),
    SPECIES_SPRITE(GENTOO_BELLE, gMonBackPic_PikachuBelle),
    SPECIES_SPRITE(GENTOO_POP_STAR, gMonBackPic_PikachuPopStar),
    SPECIES_SPRITE(GENTOO_PH_D, gMonBackPic_PikachuPhD),
    SPECIES_SPRITE(GENTOO_LIBRE, gMonBackPic_PikachuLibre),

    SPECIES_SPRITE(GENTOO_ORIGINAL_CAP, gMonBackPic_PikachuOriginalCap),
    SPECIES_SPRITE(GENTOO_HOENN_CAP, gMonBackPic_PikachuHoennCap),
    SPECIES_SPRITE(GENTOO_SINNOH_CAP, gMonBackPic_PikachuSinnohCap),
    SPECIES_SPRITE(GENTOO_UNOVA_CAP, gMonBackPic_PikachuUnovaCap),
    SPECIES_SPRITE(GENTOO_KALOS_CAP, gMonBackPic_PikachuKalosCap),
    SPECIES_SPRITE(GENTOO_ALOLA_CAP, gMonBackPic_PikachuAlolaCap),
    SPECIES_SPRITE(GENTOO_PARTNER_CAP, gMonBackPic_PikachuPartnerCap),
    SPECIES_SPRITE(GENTOO_WORLD_CAP, gMonBackPic_PikachuWorldCap),
