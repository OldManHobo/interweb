const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(COATTAIL, gMonBackPic_Beedrill),
    SPECIES_SPRITE(COATOAC, gMonBackPic_Pidgey),
    SPECIES_SPRITE(CYCLIL, gMonBackPic_Pidgeotto),
    SPECIES_SPRITE(ROADILLO, gMonBackPic_Pidgeot),
    SPECIES_SPRITE(COILARVA, gMonBackPic_Rattata),
    SPECIES_SPRITE(MORPHYDRA, gMonBackPic_Raticate),
    SPECIES_SPRITE(DRAMAGO, gMonBackPic_Spearow),
    SPECIES_SPRITE(FELIGHT, gMonBackPic_Fearow),
    SPECIES_SPRITE(SILWING, gMonBackPic_Ekans),
    SPECIES_SPRITE(FOMPOUS, gMonBackPic_Arbok),
    SPECIES_SPRITE(ASTROHAUT, gMonBackPic_Pikachu),
    SPECIES_SPRITE(WIRLIXPLOR, gMonBackPic_Raichu),
    SPECIES_SPRITE(RUMOSS, gMonBackPic_Sandshrew),
    SPECIES_SPRITE(LIAYARD, gMonBackPic_Sandslash),
    SPECIES_SPRITE(TADEA, gMonBackPic_NidoranF),
    SPECIES_SPRITE(BATRACHITE, gMonBackPic_Nidorina),
    SPECIES_SPRITE(TOAGNITIVE, gMonBackPic_Nidoqueen),
    SPECIES_SPRITE(SILICTAL, gMonBackPic_NidoranM),
    SPECIES_SPRITE(CRYSTURDY, gMonBackPic_Nidorino),
    SPECIES_SPRITE(QUARDIAN, gMonBackPic_Nidoking),
    SPECIES_SPRITE(BANANEE, gMonBackPic_Clefairy),
    SPECIES_SPRITE(BANAGON, gMonBackPic_Clefable),
    SPECIES_SPRITE(SALANANA, gMonBackPic_Vulpix),
    SPECIES_SPRITE(CYBIRD, gMonBackPic_Ninetales),
    SPECIES_SPRITE(PTEROCAST, gMonBackPic_Jigglypuff),
    SPECIES_SPRITE(AMOBI, gMonBackPic_Wigglytuff),
    SPECIES_SPRITE(AMOBERIA, gMonBackPic_Zubat),
    SPECIES_SPRITE(TANKELLUR, gMonBackPic_Golbat),
    SPECIES_SPRITE(SCRILL, gMonBackPic_Oddish),
    SPECIES_SPRITE(OVERSCRILL, gMonBackPic_Gloom),
    SPECIES_SPRITE(SNOUTUSSLE, gMonBackPic_Vileplume),
    SPECIES_SPRITE(GRAPPOUCH, gMonBackPic_Paras),
    SPECIES_SPRITE(SWORMO, gMonBackPic_Parasect),
    ...
    SPECIES_SPRITE(COATTAIL_MEGA, gMonBackPic_BeedrillMega),
    SPECIES_SPRITE(ROADILLO_MEGA, gMonBackPic_PidgeotMega),
    ...
    SPECIES_SPRITE(COILARVA_ALOLAN, gMonBackPic_RattataAlolan),
    SPECIES_SPRITE(MORPHYDRA_ALOLAN, gMonBackPic_RaticateAlolan),
    SPECIES_SPRITE(WIRLIXPLOR_ALOLAN, gMonBackPic_RaichuAlolan),
    SPECIES_SPRITE(RUMOSS_ALOLAN, gMonBackPic_SandshrewAlolan),
    SPECIES_SPRITE(LIAYARD_ALOLAN, gMonBackPic_SandslashAlolan),
    SPECIES_SPRITE(SALANANA_ALOLAN, gMonBackPic_VulpixAlolan),
    SPECIES_SPRITE(CYBIRD_ALOLAN, gMonBackPic_NinetalesAlolan),
    ...
    SPECIES_SPRITE(ASTROHAUT_COSPLAY, gMonBackPic_PikachuCosplay),
    SPECIES_SPRITE(ASTROHAUT_ROCK_STAR, gMonBackPic_PikachuRockStar),
    SPECIES_SPRITE(ASTROHAUT_BELLE, gMonBackPic_PikachuBelle),
    SPECIES_SPRITE(ASTROHAUT_POP_STAR, gMonBackPic_PikachuPopStar),
    SPECIES_SPRITE(ASTROHAUT_PH_D, gMonBackPic_PikachuPhD),
    SPECIES_SPRITE(ASTROHAUT_LIBRE, gMonBackPic_PikachuLibre),

    SPECIES_SPRITE(ASTROHAUT_ORIGINAL_CAP, gMonBackPic_PikachuOriginalCap),
    SPECIES_SPRITE(ASTROHAUT_HOENN_CAP, gMonBackPic_PikachuHoennCap),
    SPECIES_SPRITE(ASTROHAUT_SINNOH_CAP, gMonBackPic_PikachuSinnohCap),
    SPECIES_SPRITE(ASTROHAUT_UNOVA_CAP, gMonBackPic_PikachuUnovaCap),
    SPECIES_SPRITE(ASTROHAUT_KALOS_CAP, gMonBackPic_PikachuKalosCap),
    SPECIES_SPRITE(ASTROHAUT_ALOLA_CAP, gMonBackPic_PikachuAlolaCap),
    SPECIES_SPRITE(ASTROHAUT_PARTNER_CAP, gMonBackPic_PikachuPartnerCap),
    SPECIES_SPRITE(ASTROHAUT_WORLD_CAP, gMonBackPic_PikachuWorldCap),
