const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(SCRILL, gMonBackPic_Beedrill),
    SPECIES_SPRITE(OVERSCRILL, gMonBackPic_Pidgey),
    SPECIES_SPRITE(COILARVA, gMonBackPic_Pidgeotto),
    SPECIES_SPRITE(MORPHYDRA, gMonBackPic_Pidgeot),
    ...
    SPECIES_SPRITE(CYBIRD, gMonBackPic_Jigglypuff),
    SPECIES_SPRITE(PTEROCAST, gMonBackPic_Wigglytuff),
    ...
    SPECIES_SPRITE(SCRILL_MEGA, gMonBackPic_BeedrillMega),
    SPECIES_SPRITE(MORPHYDRA_MEGA, gMonBackPic_PidgeotMega),
