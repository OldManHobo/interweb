...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_BULBASAUR]                    = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 10 },
    [SPECIES_IVYSAUR]                      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  5 },
    [SPECIES_VENUSAUR]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 0 },
    [SPECIES_CHARMANDER]                   = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  1 },
    [SPECIES_CHARMELEON]                   = { .size = MON_COORDS_SIZE(56, 48), .y_offset =  7 },
    ...
    [SPECIES_CATERPIE]                     = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 0 },
    [SPECIES_METAPOD]                      = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  0 },
    [SPECIES_BUTTERFREE]                   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  0 },
    [SPECIES_WEEDLE]                       = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  19 },
    [SPECIES_KAKUNA]                       = { .size = MON_COORDS_SIZE(32, 40), .y_offset = 8 },
    [SPECIES_BEEDRILL]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_PIDGEY]                       = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 4 },
    ...
    [SPECIES_SPEAROW]                      = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  8 },
    [SPECIES_FEAROW]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  0 },
    [SPECIES_EKANS]                        = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 9 },
    [SPECIES_ARBOK]                        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_PIKACHU]                      = PIKACHU_BACK_PIC_COORDS,
    [SPECIES_RAICHU]                       = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  3 },
    [SPECIES_SANDSHREW]                    = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 4 },
    [SPECIES_SANDSLASH]                    = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 3 },
    [SPECIES_NIDORAN_F]                    = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 11 },
    [SPECIES_NIDORINA]                     = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  6 },
    [SPECIES_NIDOQUEEN]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  8 },
    [SPECIES_NIDORAN_M]                    = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  0 },
    [SPECIES_NIDORINO]                     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  2 },
    [SPECIES_NIDOKING]                     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  4 },
    [SPECIES_CLEFAIRY]                     = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 0 },
    [SPECIES_CLEFABLE]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 9 },
    [SPECIES_VULPIX]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  10 },
    [SPECIES_NINETALES]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    [SPECIES_JIGGLYPUFF]                   = { .size = MON_COORDS_SIZE(56, 48), .y_offset = 10 },
    ...
    [SPECIES_GLOOM]                        = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 5 },
    [SPECIES_VILEPLUME]                    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_PARAS]                        = { .size = MON_COORDS_SIZE(64, 32), .y_offset = 4 },
    [SPECIES_PARASECT]                     = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 4 },
    ...
    [SPECIES_GOLDUCK]                      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_MANKEY]                       = { .size = MON_COORDS_SIZE(64, 48), .y_offset =  0 },
    [SPECIES_PRIMEAPE]                     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 0 },
