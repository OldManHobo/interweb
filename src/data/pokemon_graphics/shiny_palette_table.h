const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(MORPHYDRA, gMonShinyPalette_Pidgeot),
    ...
    SPECIES_SHINY_PAL(CYBIRD, gMonShinyPalette_Jigglypuff),
    SPECIES_SHINY_PAL(PTEROCAST, gMonShinyPalette_Wigglytuff),
    ...
    SPECIES_SHINY_PAL(MORPHYDRA_MEGA, gMonShinyPalette_PidgeotMega),
