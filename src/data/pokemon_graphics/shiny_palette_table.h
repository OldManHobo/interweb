const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(SCRILL, gMonShinyPalette_Beedrill),
    SPECIES_SHINY_PAL(OVERSCRILL, gMonShinyPalette_Pidgey),
    ...
    SPECIES_SHINY_PAL(SCRILL_MEGA, gMonShinyPalette_BeedrillMega),
