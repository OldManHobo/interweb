const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(COATTAIL, gMonShinyPalette_Beedrill),
    SPECIES_SHINY_PAL(COATOAC, gMonShinyPalette_Pidgey),
    SPECIES_SHINY_PAL(CYCLIL, gMonShinyPalette_Pidgeotto),
    SPECIES_SHINY_PAL(ROADILLO, gMonShinyPalette_Pidgeot),
    SPECIES_SHINY_PAL(COILARVA, gMonShinyPalette_Rattata),
    SPECIES_SHINY_PAL(MORPHYDRA, gMonShinyPalette_Raticate),
    SPECIES_SHINY_PAL(DRAMAGO, gMonShinyPalette_Spearow),
    SPECIES_SHINY_PAL(FELIGHT, gMonShinyPalette_Fearow),
    SPECIES_SHINY_PAL(SILWING, gMonShinyPalette_Ekans),
    SPECIES_SHINY_PAL(FOMPOUS, gMonShinyPalette_Arbok),
    SPECIES_SHINY_PAL(ASTROHAUT, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(WIRLIXPLOR, gMonShinyPalette_Raichu),
    SPECIES_SHINY_PAL(RUMOSS, gMonShinyPalette_Sandshrew),
    SPECIES_SHINY_PAL(LIAYARD, gMonShinyPalette_Sandslash),
    SPECIES_SHINY_PAL(TADEA, gMonShinyPalette_NidoranF),
    SPECIES_SHINY_PAL(BATRACHITE, gMonShinyPalette_Nidorina),
    SPECIES_SHINY_PAL(TOAGNITIVE, gMonShinyPalette_Nidoqueen),
    SPECIES_SHINY_PAL(SILICTAL, gMonShinyPalette_NidoranM),
    SPECIES_SHINY_PAL(CRYSTURDY, gMonShinyPalette_Nidorino),
    SPECIES_SHINY_PAL(QUARDIAN, gMonShinyPalette_Nidoking),
    SPECIES_SHINY_PAL(BANANEE, gMonShinyPalette_Clefairy),
    SPECIES_SHINY_PAL(BANAGON, gMonShinyPalette_Clefable),
    SPECIES_SHINY_PAL(SALANANA, gMonShinyPalette_Vulpix),
    SPECIES_SHINY_PAL(CYBIRD, gMonShinyPalette_Ninetales),
    SPECIES_SHINY_PAL(PTEROCAST, gMonShinyPalette_Jigglypuff),
    SPECIES_SHINY_PAL(AMOBI, gMonShinyPalette_Wigglytuff),
    SPECIES_SHINY_PAL(AMOBERIA, gMonShinyPalette_Zubat),
    SPECIES_SHINY_PAL(TANKELLUR, gMonShinyPalette_Golbat),
    SPECIES_SHINY_PAL(SCRILL, gMonShinyPalette_Oddish),
    SPECIES_SHINY_PAL(OVERSCRILL, gMonShinyPalette_Gloom),
    SPECIES_SHINY_PAL(SNOUTUSSLE, gMonShinyPalette_Vileplume),
    SPECIES_SHINY_PAL(GRAPPOUCH, gMonShinyPalette_Paras),
    SPECIES_SHINY_PAL(SWORMO, gMonShinyPalette_Parasect),
    ...
    SPECIES_SHINY_PAL(COATTAIL_MEGA, gMonShinyPalette_BeedrillMega),
    SPECIES_SHINY_PAL(ROADILLO_MEGA, gMonShinyPalette_PidgeotMega),
    ...
    SPECIES_SHINY_PAL(COILARVA_ALOLAN, gMonShinyPalette_RattataAlolan),
    SPECIES_SHINY_PAL(MORPHYDRA_ALOLAN, gMonShinyPalette_RaticateAlolan),
    SPECIES_SHINY_PAL(WIRLIXPLOR_ALOLAN, gMonShinyPalette_RaichuAlolan),
    SPECIES_SHINY_PAL(RUMOSS_ALOLAN, gMonShinyPalette_SandshrewAlolan),
    SPECIES_SHINY_PAL(LIAYARD_ALOLAN, gMonShinyPalette_SandslashAlolan),
    SPECIES_SHINY_PAL(SALANANA_ALOLAN, gMonShinyPalette_VulpixAlolan),
    SPECIES_SHINY_PAL(CYBIRD_ALOLAN, gMonShinyPalette_NinetalesAlolan),
    ...
    SPECIES_SHINY_PAL(ASTROHAUT_COSPLAY, gMonShinyPalette_PikachuCosplay),
    SPECIES_SHINY_PAL(ASTROHAUT_ROCK_STAR, gMonShinyPalette_PikachuRockStar),
    SPECIES_SHINY_PAL(ASTROHAUT_BELLE, gMonShinyPalette_PikachuBelle),
    SPECIES_SHINY_PAL(ASTROHAUT_POP_STAR, gMonShinyPalette_PikachuPopStar),
    SPECIES_SHINY_PAL(ASTROHAUT_PH_D, gMonShinyPalette_PikachuPhD),
    SPECIES_SHINY_PAL(ASTROHAUT_LIBRE, gMonShinyPalette_PikachuLibre),

    SPECIES_SHINY_PAL(ASTROHAUT_ORIGINAL_CAP, gMonShinyPalette_PikachuOriginalCap),
    SPECIES_SHINY_PAL(ASTROHAUT_HOENN_CAP, gMonShinyPalette_PikachuHoennCap),
    SPECIES_SHINY_PAL(ASTROHAUT_SINNOH_CAP, gMonShinyPalette_PikachuSinnohCap),
    SPECIES_SHINY_PAL(ASTROHAUT_UNOVA_CAP, gMonShinyPalette_PikachuUnovaCap),
    SPECIES_SHINY_PAL(ASTROHAUT_KALOS_CAP, gMonShinyPalette_PikachuKalosCap),
    SPECIES_SHINY_PAL(ASTROHAUT_ALOLA_CAP, gMonShinyPalette_PikachuAlolaCap),
    SPECIES_SHINY_PAL(ASTROHAUT_PARTNER_CAP, gMonShinyPalette_PikachuPartnerCap),
    SPECIES_SHINY_PAL(ASTROHAUT_WORLD_CAP, gMonShinyPalette_PikachuWorldCap),
