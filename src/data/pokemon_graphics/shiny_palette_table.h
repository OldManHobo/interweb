const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(BADGERP, gMonShinyPalette_Bulbasaur),
    SPECIES_SHINY_PAL(HUHGER, gMonShinyPalette_Ivysaur),
    SPECIES_SHINY_PAL(MELECIUM, gMonShinyPalette_Venusaur),
    SPECIES_SHINY_PAL(TEPILLA, gMonShinyPalette_Charmander),
    SPECIES_SHINY_PAL(ESCORCHES, gMonShinyPalette_Charmeleon),
    SPECIES_SHINY_PAL(SOLADOR, gMonShinyPalette_Charizard),
    SPECIES_SHINY_PAL(RELENTOOTH, gMonShinyPalette_Squirtle),
    SPECIES_SHINY_PAL(SNARETHAN, gMonShinyPalette_Wartortle),
    SPECIES_SHINY_PAL(LEVIAMAWL, gMonShinyPalette_Blastoise),
    SPECIES_SHINY_PAL(DISCUTTLE, gMonShinyPalette_Caterpie),
    SPECIES_SHINY_PAL(TENNADISH, gMonShinyPalette_Metapod),
    SPECIES_SHINY_PAL(WEBILLITE, gMonShinyPalette_Butterfree),
    SPECIES_SHINY_PAL(GALACTIVY, gMonShinyPalette_Weedle),
    SPECIES_SHINY_PAL(XENOWEED, gMonShinyPalette_Kakuna),
    SPECIES_SHINY_PAL(SNAGOON, gMonShinyPalette_Beedrill),
    SPECIES_SHINY_PAL(REPOCOON, gMonShinyPalette_Pidgey),
    SPECIES_SHINY_PAL(COILARVA, gMonShinyPalette_Pidgeotto),
    SPECIES_SHINY_PAL(COILOCUS, gMonShinyPalette_Pidgeot),
    SPECIES_SHINY_PAL(DRAMAGO, gMonShinyPalette_Rattata),
    SPECIES_SHINY_PAL(FELIGHT, gMonShinyPalette_Raticate),
    SPECIES_SHINY_PAL(SILWING, gMonShinyPalette_Spearow),
    SPECIES_SHINY_PAL(FOMPOUS, gMonShinyPalette_Fearow),
    SPECIES_SHINY_PAL(ASTROHAUT, gMonShinyPalette_Ekans),
    SPECIES_SHINY_PAL(WIRLIXPLOR, gMonShinyPalette_Arbok),
    SPECIES_SHINY_PAL(GENTOO, gMonShinyPalette_Pikachu),
    SPECIES_SHINY_PAL(SAWFUL, gMonShinyPalette_Raichu),
    SPECIES_SHINY_PAL(SAULLACE, gMonShinyPalette_Sandshrew),
    SPECIES_SHINY_PAL(RUMOSS, gMonShinyPalette_Sandslash),
    SPECIES_SHINY_PAL(LIAYARD, gMonShinyPalette_NidoranF),
    SPECIES_SHINY_PAL(TADEA, gMonShinyPalette_Nidorina),
    SPECIES_SHINY_PAL(BATRACHITE, gMonShinyPalette_Nidoqueen),
    SPECIES_SHINY_PAL(TOAGNITIVE, gMonShinyPalette_NidoranM),
    SPECIES_SHINY_PAL(SILICTAL, gMonShinyPalette_Nidorino),
    SPECIES_SHINY_PAL(CRYSTURDY, gMonShinyPalette_Nidoking),
    SPECIES_SHINY_PAL(QUARDIAN, gMonShinyPalette_Clefairy),
    SPECIES_SHINY_PAL(BANANEE, gMonShinyPalette_Clefable),
    SPECIES_SHINY_PAL(BANAGON, gMonShinyPalette_Vulpix),
    SPECIES_SHINY_PAL(SALANANA, gMonShinyPalette_Ninetales),
    SPECIES_SHINY_PAL(HYPADOG, gMonShinyPalette_Jigglypuff),
    SPECIES_SHINY_PAL(HYPADOG2, gMonShinyPalette_Wigglytuff),
    SPECIES_SHINY_PAL(AMOBI, gMonShinyPalette_Zubat),
    SPECIES_SHINY_PAL(AMOBERIA, gMonShinyPalette_Golbat),
    SPECIES_SHINY_PAL(TANKELLUR, gMonShinyPalette_Oddish),
    SPECIES_SHINY_PAL(CYCLIL, gMonShinyPalette_Gloom),
    SPECIES_SHINY_PAL(ROADILLO, gMonShinyPalette_Vileplume),
    SPECIES_SHINY_PAL(COATTAIL, gMonShinyPalette_Paras),
    SPECIES_SHINY_PAL(COATOAC, gMonShinyPalette_Parasect),
    SPECIES_SHINY_PAL(SNOUTUSSLE, gMonShinyPalette_Venonat),
    SPECIES_SHINY_PAL(GRAPPOUCH, gMonShinyPalette_Venomoth),
    SPECIES_SHINY_PAL(CYBIRD, gMonShinyPalette_Diglett),
    SPECIES_SHINY_PAL(PTEROCAST, gMonShinyPalette_Dugtrio),
    ...
    SPECIES_SHINY_PAL(AILES, gMonShinyPalette_Golduck),
    SPECIES_SHINY_PAL(NACLES, gMonShinyPalette_Mankey),
    SPECIES_SHINY_PAL(LICLES, gMonShinyPalette_Primeape),
    ...
    SPECIES_SHINY_PAL(MELECIUM_MEGA, gMonShinyPalette_VenusaurMega),
    SPECIES_SHINY_PAL(SOLADOR_MEGA_X, gMonShinyPalette_CharizardMegaX),
    SPECIES_SHINY_PAL(SOLADOR_MEGA_Y, gMonShinyPalette_CharizardMegaY),
    SPECIES_SHINY_PAL(LEVIAMAWL_MEGA, gMonShinyPalette_BlastoiseMega),
    SPECIES_SHINY_PAL(SNAGOON_MEGA, gMonShinyPalette_BeedrillMega),
    SPECIES_SHINY_PAL(COILOCUS_MEGA, gMonShinyPalette_PidgeotMega),
    ...
    SPECIES_SHINY_PAL(DRAMAGO_ALOLAN, gMonShinyPalette_RattataAlolan),
    SPECIES_SHINY_PAL(FELIGHT_ALOLAN, gMonShinyPalette_RaticateAlolan),
    SPECIES_SHINY_PAL(SAWFUL_ALOLAN, gMonShinyPalette_RaichuAlolan),
    SPECIES_SHINY_PAL(SAULLACE_ALOLAN, gMonShinyPalette_SandshrewAlolan),
    SPECIES_SHINY_PAL(RUMOSS_ALOLAN, gMonShinyPalette_SandslashAlolan),
    SPECIES_SHINY_PAL(BANAGON_ALOLAN, gMonShinyPalette_VulpixAlolan),
    SPECIES_SHINY_PAL(SALANANA_ALOLAN, gMonShinyPalette_NinetalesAlolan),
    SPECIES_SHINY_PAL(CYBIRD_ALOLAN, gMonShinyPalette_DiglettAlolan),
    SPECIES_SHINY_PAL(PTEROCAST_ALOLAN, gMonShinyPalette_DugtrioAlolan),
    ...
    SPECIES_SHINY_PAL(GENTOO_COSPLAY, gMonShinyPalette_PikachuCosplay),
    SPECIES_SHINY_PAL(GENTOO_ROCK_STAR, gMonShinyPalette_PikachuRockStar),
    SPECIES_SHINY_PAL(GENTOO_BELLE, gMonShinyPalette_PikachuBelle),
    SPECIES_SHINY_PAL(GENTOO_POP_STAR, gMonShinyPalette_PikachuPopStar),
    SPECIES_SHINY_PAL(GENTOO_PH_D, gMonShinyPalette_PikachuPhD),
    SPECIES_SHINY_PAL(GENTOO_LIBRE, gMonShinyPalette_PikachuLibre),

    SPECIES_SHINY_PAL(GENTOO_ORIGINAL_CAP, gMonShinyPalette_PikachuOriginalCap),
    SPECIES_SHINY_PAL(GENTOO_HOENN_CAP, gMonShinyPalette_PikachuHoennCap),
    SPECIES_SHINY_PAL(GENTOO_SINNOH_CAP, gMonShinyPalette_PikachuSinnohCap),
    SPECIES_SHINY_PAL(GENTOO_UNOVA_CAP, gMonShinyPalette_PikachuUnovaCap),
    SPECIES_SHINY_PAL(GENTOO_KALOS_CAP, gMonShinyPalette_PikachuKalosCap),
    SPECIES_SHINY_PAL(GENTOO_ALOLA_CAP, gMonShinyPalette_PikachuAlolaCap),
    SPECIES_SHINY_PAL(GENTOO_PARTNER_CAP, gMonShinyPalette_PikachuPartnerCap),
    SPECIES_SHINY_PAL(GENTOO_WORLD_CAP, gMonShinyPalette_PikachuWorldCap),
