const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(GENERA, gMonShinyPalette_Genera),
    SPECIES_SHINY_PAL(GYANNEX, gMonShinyPalette_Gyannex),
    SPECIES_SHINY_PAL(KAZEIYAGA, gMonShinyPalette_Kazeiyaga),
    SPECIES_SHINY_PAL(TEPILLA, gMonShinyPalette_Tepilla),
    SPECIES_SHINY_PAL(ESCORCHES, gMonShinyPalette_Escorches),
    SPECIES_SHINY_PAL(SOLADOR, gMonShinyPalette_Solador),
    SPECIES_SHINY_PAL(RELENTOOTH, gMonShinyPalette_Relentooth),
    SPECIES_SHINY_PAL(SNARETHAN, gMonShinyPalette_Snarethan),
    SPECIES_SHINY_PAL(LEVIAMAWL, gMonShinyPalette_Leviamawl),
    SPECIES_SHINY_PAL(DISCUTTLE, gMonShinyPalette_Discuttle),
    SPECIES_SHINY_PAL(TENNADISH, gMonShinyPalette_Tennadish),
    SPECIES_SHINY_PAL(WEBILLITE, gMonShinyPalette_Webillite),
    SPECIES_SHINY_PAL(GALACTIVY, gMonShinyPalette_Galactivy),
    SPECIES_SHINY_PAL(XENOWEED, gMonShinyPalette_Xenoweed),
    SPECIES_SHINY_PAL(COATTAIL, gMonShinyPalette_Coattail),
    SPECIES_SHINY_PAL(COATOAC, gMonShinyPalette_Coatoac),
    SPECIES_SHINY_PAL(CYCLIL, gMonShinyPalette_Cyclil),
    SPECIES_SHINY_PAL(ROADILLO, gMonShinyPalette_Roadillo),
    SPECIES_SHINY_PAL(COILARVA, gMonShinyPalette_Coilarva),
    SPECIES_SHINY_PAL(MORPHYDRA, gMonShinyPalette_Morphydra),
    SPECIES_SHINY_PAL(DRAMAGO, gMonShinyPalette_Dramago),
    SPECIES_SHINY_PAL(FELIGHT, gMonShinyPalette_Felight),
    SPECIES_SHINY_PAL(SILWING, gMonShinyPalette_Silwing),
    SPECIES_SHINY_PAL(FOMPOUS, gMonShinyPalette_Fompous),
    SPECIES_SHINY_PAL(ASTROHAUT, gMonShinyPalette_Astrohaut),
    SPECIES_SHINY_PAL(WIRLIXPLOR, gMonShinyPalette_Wirlixplor),
    SPECIES_SHINY_PAL(RUMOSS, gMonShinyPalette_Rumoss),
    SPECIES_SHINY_PAL(LIAYARD, gMonShinyPalette_Liayard),
    SPECIES_SHINY_PAL(TADEA, gMonShinyPalette_Tadea),
    SPECIES_SHINY_PAL(BATRACHITE, gMonShinyPalette_Batrachite),
    SPECIES_SHINY_PAL(TOAGNITIVE, gMonShinyPalette_Toagnitive),
    SPECIES_SHINY_PAL(SILICTAL, gMonShinyPalette_Silictal),
    SPECIES_SHINY_PAL(CRYSTURDY, gMonShinyPalette_Crysturdy),
    SPECIES_SHINY_PAL(QUARDIAN, gMonShinyPalette_Quardian),
    SPECIES_SHINY_PAL(BANANEE, gMonShinyPalette_Bananee),
    SPECIES_SHINY_PAL(BANAGON, gMonShinyPalette_Banagon),
    SPECIES_SHINY_PAL(SALANANA, gMonShinyPalette_Salanana),
    SPECIES_SHINY_PAL(CYBIRD, gMonShinyPalette_Cybird),
    SPECIES_SHINY_PAL(PTEROCAST, gMonShinyPalette_Pterocast),
    SPECIES_SHINY_PAL(AMOBI, gMonShinyPalette_Amobi),
    SPECIES_SHINY_PAL(AMOBERIA, gMonShinyPalette_Amoberia),
    SPECIES_SHINY_PAL(TANKELLUR, gMonShinyPalette_Tankellur),
    SPECIES_SHINY_PAL(SCRILL, gMonShinyPalette_Scrill),
    SPECIES_SHINY_PAL(OVERSCRILL, gMonShinyPalette_Overscrill),
    SPECIES_SHINY_PAL(SNOUTUSSLE, gMonShinyPalette_Snoutussle),
    SPECIES_SHINY_PAL(GRAPPOUCH, gMonShinyPalette_Grappouch),
    SPECIES_SHINY_PAL(SWORMO, gMonShinyPalette_Swormo),
    SPECIES_SHINY_PAL(EKANS, gMonShinyPalette_Venonat),
    SPECIES_SHINY_PAL(PIKACHU, gMonShinyPalette_Venomoth),
    ...
    SPECIES_SHINY_PAL(KAZEIYAGA_MEGA, gMonShinyPalette_KazeiyagaMega),
    SPECIES_SHINY_PAL(SOLADOR_MEGA_X, gMonShinyPalette_SoladorMegaX),
    SPECIES_SHINY_PAL(SOLADOR_MEGA_Y, gMonShinyPalette_SoladorMegaY),
    SPECIES_SHINY_PAL(LEVIAMAWL_MEGA, gMonShinyPalette_LeviamawlMega),
    SPECIES_SHINY_PAL(COATTAIL_MEGA, gMonShinyPalette_CoattailMega),
    SPECIES_SHINY_PAL(ROADILLO_MEGA, gMonShinyPalette_RoadilloMega),
    ...
    SPECIES_SHINY_PAL(COILARVA_ALOLAN, gMonShinyPalette_CoilarvaAlolan),
    SPECIES_SHINY_PAL(MORPHYDRA_ALOLAN, gMonShinyPalette_MorphydraAlolan),
    SPECIES_SHINY_PAL(WIRLIXPLOR_ALOLAN, gMonShinyPalette_WirlixplorAlolan),
    SPECIES_SHINY_PAL(RUMOSS_ALOLAN, gMonShinyPalette_RumossAlolan),
    SPECIES_SHINY_PAL(LIAYARD_ALOLAN, gMonShinyPalette_LiayardAlolan),
    SPECIES_SHINY_PAL(SALANANA_ALOLAN, gMonShinyPalette_SalananaAlolan),
    SPECIES_SHINY_PAL(CYBIRD_ALOLAN, gMonShinyPalette_CybirdAlolan),
    ...
    SPECIES_SHINY_PAL(ASTROHAUT_COSPLAY, gMonShinyPalette_AstrohautCosplay),
    SPECIES_SHINY_PAL(ASTROHAUT_ROCK_STAR, gMonShinyPalette_AstrohautRockStar),
    SPECIES_SHINY_PAL(ASTROHAUT_BELLE, gMonShinyPalette_AstrohautBelle),
    SPECIES_SHINY_PAL(ASTROHAUT_POP_STAR, gMonShinyPalette_AstrohautPopStar),
    SPECIES_SHINY_PAL(ASTROHAUT_PH_D, gMonShinyPalette_AstrohautPhD),
    SPECIES_SHINY_PAL(ASTROHAUT_LIBRE, gMonShinyPalette_AstrohautLibre),

    SPECIES_SHINY_PAL(ASTROHAUT_ORIGINAL_CAP, gMonShinyPalette_AstrohautOriginalCap),
    SPECIES_SHINY_PAL(ASTROHAUT_HOENN_CAP, gMonShinyPalette_AstrohautHoennCap),
    SPECIES_SHINY_PAL(ASTROHAUT_SINNOH_CAP, gMonShinyPalette_AstrohautSinnohCap),
    SPECIES_SHINY_PAL(ASTROHAUT_UNOVA_CAP, gMonShinyPalette_AstrohautUnovaCap),
    SPECIES_SHINY_PAL(ASTROHAUT_KALOS_CAP, gMonShinyPalette_AstrohautKalosCap),
    SPECIES_SHINY_PAL(ASTROHAUT_ALOLA_CAP, gMonShinyPalette_AstrohautAlolaCap),
    SPECIES_SHINY_PAL(ASTROHAUT_PARTNER_CAP, gMonShinyPalette_AstrohautPartnerCap),
    SPECIES_SHINY_PAL(ASTROHAUT_WORLD_CAP, gMonShinyPalette_AstrohautWorldCap),
