const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(BADGERP, gMonFrontPic_Bulbasaur),
    SPECIES_SPRITE(HUHGER, gMonFrontPic_Ivysaur),
    SPECIES_SPRITE(MELECIUM, gMonFrontPic_Venusaur),
    SPECIES_SPRITE(TEPILLA, gMonFrontPic_Charmander),
    SPECIES_SPRITE(ESCORCHES, gMonFrontPic_Charmeleon),
    SPECIES_SPRITE(SOLADOR, gMonFrontPic_Charizard),
    SPECIES_SPRITE(RELENTOOTH, gMonFrontPic_Squirtle),
    SPECIES_SPRITE(SNARETHAN, gMonFrontPic_Wartortle),
    SPECIES_SPRITE(LEVIAMAWL, gMonFrontPic_Blastoise),
    SPECIES_SPRITE(DISCUTTLE, gMonFrontPic_Caterpie),
    SPECIES_SPRITE(TENNADISH, gMonFrontPic_Metapod),
    SPECIES_SPRITE(WEBILLITE, gMonFrontPic_Butterfree),
    SPECIES_SPRITE(GALACTIVY, gMonFrontPic_Weedle),
    SPECIES_SPRITE(XENOWEED, gMonFrontPic_Kakuna),
    SPECIES_SPRITE(SNAGOON, gMonFrontPic_Beedrill),
    SPECIES_SPRITE(REPOCOON, gMonFrontPic_Pidgey),
    SPECIES_SPRITE(COILARVA, gMonFrontPic_Pidgeotto),
    SPECIES_SPRITE(COILOCUS, gMonFrontPic_Pidgeot),
    SPECIES_SPRITE(DRAMAGO, gMonFrontPic_Rattata),
    SPECIES_SPRITE(FELIGHT, gMonFrontPic_Raticate),
    SPECIES_SPRITE(SILWING, gMonFrontPic_Spearow),
    SPECIES_SPRITE(FOMPOUS, gMonFrontPic_Fearow),
    SPECIES_SPRITE(ASTROHAUT, gMonFrontPic_Ekans),
    SPECIES_SPRITE(WIRLIXPLOR, gMonFrontPic_Arbok),
    SPECIES_SPRITE(GENTOO, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(SAWFUL, gMonFrontPic_Raichu),
    SPECIES_SPRITE(SAULLACE, gMonFrontPic_Sandshrew),
    SPECIES_SPRITE(RUMOSS, gMonFrontPic_Sandslash),
    SPECIES_SPRITE(LIAYARD, gMonFrontPic_NidoranF),
    SPECIES_SPRITE(TADEA, gMonFrontPic_Nidorina),
    SPECIES_SPRITE(BATRACHITE, gMonFrontPic_Nidoqueen),
    SPECIES_SPRITE(TOAGNITIVE, gMonFrontPic_NidoranM),
    SPECIES_SPRITE(SILICTAL, gMonFrontPic_Nidorino),
    SPECIES_SPRITE(CRYSTURDY, gMonFrontPic_Nidoking),
    SPECIES_SPRITE(QUARDIAN, gMonFrontPic_Clefairy),
    SPECIES_SPRITE(BANANEE, gMonFrontPic_Clefable),
    SPECIES_SPRITE(BANAGON, gMonFrontPic_Vulpix),
    SPECIES_SPRITE(SALANANA, gMonFrontPic_Ninetales),
    SPECIES_SPRITE(HYPADOG, gMonFrontPic_Jigglypuff),
    SPECIES_SPRITE(HYPADOG2, gMonFrontPic_Wigglytuff),
    SPECIES_SPRITE(AMOBI, gMonFrontPic_Zubat),
    SPECIES_SPRITE(AMOBERIA, gMonFrontPic_Golbat),
    SPECIES_SPRITE(TANKELLUR, gMonFrontPic_Oddish),
    SPECIES_SPRITE(CYCLIL, gMonFrontPic_Gloom),
    SPECIES_SPRITE(ROADILLO, gMonFrontPic_Vileplume),
    SPECIES_SPRITE(COATTAIL, gMonFrontPic_Paras),
    SPECIES_SPRITE(COATOAC, gMonFrontPic_Parasect),
    SPECIES_SPRITE(SNOUTUSSLE, gMonFrontPic_Venonat),
    SPECIES_SPRITE(GRAPPOUCH, gMonFrontPic_Venomoth),
    SPECIES_SPRITE(CYBIRD, gMonFrontPic_Diglett),
    SPECIES_SPRITE(PTEROCAST, gMonFrontPic_Dugtrio),
    ...
    SPECIES_SPRITE(AILES, gMonFrontPic_Golduck),
    SPECIES_SPRITE(NACLES, gMonFrontPic_Mankey),
    SPECIES_SPRITE(LICLES, gMonFrontPic_Primeape),
...
#endif
    SPECIES_SPRITE(MELECIUM_MEGA, gMonFrontPic_VenusaurMega),
    SPECIES_SPRITE(SOLADOR_MEGA_X, gMonFrontPic_CharizardMegaX),
    SPECIES_SPRITE(SOLADOR_MEGA_Y, gMonFrontPic_CharizardMegaY),
    SPECIES_SPRITE(LEVIAMAWL_MEGA, gMonFrontPic_BlastoiseMega),
    SPECIES_SPRITE(SNAGOON_MEGA, gMonFrontPic_BeedrillMega),
    SPECIES_SPRITE(COILOCUS_MEGA, gMonFrontPic_PidgeotMega),
    ...
    SPECIES_SPRITE(DRAMAGO_ALOLAN, gMonFrontPic_RattataAlolan),
    SPECIES_SPRITE(FELIGHT_ALOLAN, gMonFrontPic_RaticateAlolan),
    SPECIES_SPRITE(SAWFUL_ALOLAN, gMonFrontPic_RaichuAlolan),
    SPECIES_SPRITE(SAULLACE_ALOLAN, gMonFrontPic_SandshrewAlolan),
    SPECIES_SPRITE(RUMOSS_ALOLAN, gMonFrontPic_SandslashAlolan),
    SPECIES_SPRITE(BANAGON_ALOLAN, gMonFrontPic_VulpixAlolan),
    SPECIES_SPRITE(SALANANA_ALOLAN, gMonFrontPic_NinetalesAlolan),
    SPECIES_SPRITE(CYBIRD_ALOLAN, gMonFrontPic_DiglettAlolan),
    SPECIES_SPRITE(PTEROCAST_ALOLAN, gMonFrontPic_DugtrioAlolan),
    ...
    SPECIES_SPRITE(GENTOO_COSPLAY, gMonFrontPic_PikachuCosplay),
    SPECIES_SPRITE(GENTOO_ROCK_STAR, gMonFrontPic_PikachuRockStar),
    SPECIES_SPRITE(GENTOO_BELLE, gMonFrontPic_PikachuBelle),
    SPECIES_SPRITE(GENTOO_POP_STAR, gMonFrontPic_PikachuPopStar),
    SPECIES_SPRITE(GENTOO_PH_D, gMonFrontPic_PikachuPhD),
    SPECIES_SPRITE(GENTOO_LIBRE, gMonFrontPic_PikachuLibre),

    SPECIES_SPRITE(GENTOO_ORIGINAL_CAP, gMonFrontPic_PikachuOriginalCap),
    SPECIES_SPRITE(GENTOO_HOENN_CAP, gMonFrontPic_PikachuHoennCap),
    SPECIES_SPRITE(GENTOO_SINNOH_CAP, gMonFrontPic_PikachuSinnohCap),
    SPECIES_SPRITE(GENTOO_UNOVA_CAP, gMonFrontPic_PikachuUnovaCap),
    SPECIES_SPRITE(GENTOO_KALOS_CAP, gMonFrontPic_PikachuKalosCap),
    SPECIES_SPRITE(GENTOO_ALOLA_CAP, gMonFrontPic_PikachuAlolaCap),
    SPECIES_SPRITE(GENTOO_PARTNER_CAP, gMonFrontPic_PikachuPartnerCap),
    SPECIES_SPRITE(GENTOO_WORLD_CAP, gMonFrontPic_PikachuWorldCap),
