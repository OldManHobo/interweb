const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(GENERA, gMonFrontPic_Genera),
    SPECIES_SPRITE(GYANNEX, gMonFrontPic_Gyannex),
    SPECIES_SPRITE(KAZEIYAGA, gMonFrontPic_Kazeiyaga),
    SPECIES_SPRITE(TEPILLA, gMonFrontPic_Tepilla),
    SPECIES_SPRITE(ESCORCHES, gMonFrontPic_Escorches),
    SPECIES_SPRITE(SOLADOR, gMonFrontPic_Solador),
    SPECIES_SPRITE(RELENTOOTH, gMonFrontPic_Relentooth),
    SPECIES_SPRITE(SNARETHAN, gMonFrontPic_Snarethan),
    SPECIES_SPRITE(LEVIAMAWL, gMonFrontPic_Leviamawl),
    SPECIES_SPRITE(DISCUTTLE, gMonFrontPic_Discuttle),
    SPECIES_SPRITE(TENNADISH, gMonFrontPic_Tennadish),
    SPECIES_SPRITE(WEBILLITE, gMonFrontPic_Webillite),
    SPECIES_SPRITE(GALACTIVY, gMonFrontPic_Galactivy),
    SPECIES_SPRITE(XENOWEED, gMonFrontPic_Xenoweed),
    SPECIES_SPRITE(COATTAIL, gMonFrontPic_Coattail),
    SPECIES_SPRITE(COATOAC, gMonFrontPic_Coatoac),
    SPECIES_SPRITE(CYCLIL, gMonFrontPic_Cyclil),
    SPECIES_SPRITE(ROADILLO, gMonFrontPic_Roadillo),
    SPECIES_SPRITE(COILARVA, gMonFrontPic_Coilarva),
    SPECIES_SPRITE(MORPHYDRA, gMonFrontPic_Morphydra),
    SPECIES_SPRITE(DRAMAGO, gMonFrontPic_Dramago),
    SPECIES_SPRITE(FELIGHT, gMonFrontPic_Felight),
    SPECIES_SPRITE(SILWING, gMonFrontPic_Silwing),
    SPECIES_SPRITE(FOMPOUS, gMonFrontPic_Fompous),
    SPECIES_SPRITE(ASTROHAUT, gMonFrontPic_Astrohaut),
    SPECIES_SPRITE(WIRLIXPLOR, gMonFrontPic_Wirlixplor),
    SPECIES_SPRITE(RUMOSS, gMonFrontPic_Rumoss),
    SPECIES_SPRITE(LIAYARD, gMonFrontPic_Liayard),
    SPECIES_SPRITE(TADEA, gMonFrontPic_Tadea),
    SPECIES_SPRITE(BATRACHITE, gMonFrontPic_Batrachite),
    SPECIES_SPRITE(TOAGNITIVE, gMonFrontPic_Toagnitive),
    SPECIES_SPRITE(SILICTAL, gMonFrontPic_Silictal),
    SPECIES_SPRITE(CRYSTURDY, gMonFrontPic_Crysturdy),
    SPECIES_SPRITE(QUARDIAN, gMonFrontPic_Quardian),
    SPECIES_SPRITE(BANANEE, gMonFrontPic_Bananee),
    SPECIES_SPRITE(BANAGON, gMonFrontPic_Banagon),
    SPECIES_SPRITE(SALANANA, gMonFrontPic_Salanana),
    SPECIES_SPRITE(CYBIRD, gMonFrontPic_Cybird),
    SPECIES_SPRITE(PTEROCAST, gMonFrontPic_Pterocast),
    SPECIES_SPRITE(AMOBI, gMonFrontPic_Amobi),
    SPECIES_SPRITE(AMOBERIA, gMonFrontPic_Amoberia),
    SPECIES_SPRITE(TANKELLUR, gMonFrontPic_Tankellur),
    SPECIES_SPRITE(SCRILL, gMonFrontPic_Scrill),
    SPECIES_SPRITE(OVERSCRILL, gMonFrontPic_Overscrill),
    SPECIES_SPRITE(SNOUTUSSLE, gMonFrontPic_Snoutussle),
    SPECIES_SPRITE(GRAPPOUCH, gMonFrontPic_Grappouch),
    SPECIES_SPRITE(SWORMO, gMonFrontPic_Swormo),
    SPECIES_SPRITE(EKANS, gMonFrontPic_Venonat),
    SPECIES_SPRITE(PIKACHU, gMonFrontPic_Venomoth),
...
#endif
    SPECIES_SPRITE(KAZEIYAGA_MEGA, gMonFrontPic_KazeiyagaMega),
    SPECIES_SPRITE(SOLADOR_MEGA_X, gMonFrontPic_SoladorMegaX),
    SPECIES_SPRITE(SOLADOR_MEGA_Y, gMonFrontPic_SoladorMegaY),
    SPECIES_SPRITE(LEVIAMAWL_MEGA, gMonFrontPic_LeviamawlMega),
    SPECIES_SPRITE(COATTAIL_MEGA, gMonFrontPic_CoattailMega),
    SPECIES_SPRITE(ROADILLO_MEGA, gMonFrontPic_RoadilloMega),
    ...
    SPECIES_SPRITE(COILARVA_ALOLAN, gMonFrontPic_CoilarvaAlolan),
    SPECIES_SPRITE(MORPHYDRA_ALOLAN, gMonFrontPic_MorphydraAlolan),
    SPECIES_SPRITE(WIRLIXPLOR_ALOLAN, gMonFrontPic_WirlixplorAlolan),
    SPECIES_SPRITE(RUMOSS_ALOLAN, gMonFrontPic_RumossAlolan),
    SPECIES_SPRITE(LIAYARD_ALOLAN, gMonFrontPic_LiayardAlolan),
    SPECIES_SPRITE(SALANANA_ALOLAN, gMonFrontPic_SalananaAlolan),
    SPECIES_SPRITE(CYBIRD_ALOLAN, gMonFrontPic_CybirdAlolan),
    ...
    SPECIES_SPRITE(ASTROHAUT_COSPLAY, gMonFrontPic_AstrohautCosplay),
    SPECIES_SPRITE(ASTROHAUT_ROCK_STAR, gMonFrontPic_AstrohautRockStar),
    SPECIES_SPRITE(ASTROHAUT_BELLE, gMonFrontPic_AstrohautBelle),
    SPECIES_SPRITE(ASTROHAUT_POP_STAR, gMonFrontPic_AstrohautPopStar),
    SPECIES_SPRITE(ASTROHAUT_PH_D, gMonFrontPic_AstrohautPhD),
    SPECIES_SPRITE(ASTROHAUT_LIBRE, gMonFrontPic_AstrohautLibre),

    SPECIES_SPRITE(ASTROHAUT_ORIGINAL_CAP, gMonFrontPic_AstrohautOriginalCap),
    SPECIES_SPRITE(ASTROHAUT_HOENN_CAP, gMonFrontPic_AstrohautHoennCap),
    SPECIES_SPRITE(ASTROHAUT_SINNOH_CAP, gMonFrontPic_AstrohautSinnohCap),
    SPECIES_SPRITE(ASTROHAUT_UNOVA_CAP, gMonFrontPic_AstrohautUnovaCap),
    SPECIES_SPRITE(ASTROHAUT_KALOS_CAP, gMonFrontPic_AstrohautKalosCap),
    SPECIES_SPRITE(ASTROHAUT_ALOLA_CAP, gMonFrontPic_AstrohautAlolaCap),
    SPECIES_SPRITE(ASTROHAUT_PARTNER_CAP, gMonFrontPic_AstrohautPartnerCap),
    SPECIES_SPRITE(ASTROHAUT_WORLD_CAP, gMonFrontPic_AstrohautWorldCap),
