const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(MORPHYDRA, gMonFrontPic_Pidgeot),
    ...
    SPECIES_SPRITE(CYBIRD, gMonFrontPic_Jigglypuff),
    SPECIES_SPRITE(PTEROCAST, gMonFrontPic_Wigglytuff),
    ...
    SPECIES_SPRITE(MORPHYDRA_MEGA, gMonFrontPic_PidgeotMega),
