const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(COATTAIL, gMonFrontPic_Beedrill),
    SPECIES_SPRITE(COATOAC, gMonFrontPic_Pidgey),
    SPECIES_SPRITE(CYCLIL, gMonFrontPic_Pidgeotto),
    SPECIES_SPRITE(ROADILLO, gMonFrontPic_Pidgeot),
    SPECIES_SPRITE(COILARVA, gMonFrontPic_Rattata),
    SPECIES_SPRITE(MORPHYDRA, gMonFrontPic_Raticate),
    SPECIES_SPRITE(DRAMAGO, gMonFrontPic_Spearow),
    SPECIES_SPRITE(FELIGHT, gMonFrontPic_Fearow),
    SPECIES_SPRITE(SILWING, gMonFrontPic_Ekans),
    SPECIES_SPRITE(FOMPOUS, gMonFrontPic_Arbok),
    SPECIES_SPRITE(ASTROHAUT, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(WIRLIXPLOR, gMonFrontPic_Raichu),
    SPECIES_SPRITE(RUMOSS, gMonFrontPic_Sandshrew),
    SPECIES_SPRITE(LIAYARD, gMonFrontPic_Sandslash),
    SPECIES_SPRITE(TADEA, gMonFrontPic_NidoranF),
    SPECIES_SPRITE(BATRACHITE, gMonFrontPic_Nidorina),
    SPECIES_SPRITE(TOAGNITIVE, gMonFrontPic_Nidoqueen),
    SPECIES_SPRITE(SILICTAL, gMonFrontPic_NidoranM),
    SPECIES_SPRITE(CRYSTURDY, gMonFrontPic_Nidorino),
    SPECIES_SPRITE(QUARDIAN, gMonFrontPic_Nidoking),
    SPECIES_SPRITE(BANANEE, gMonFrontPic_Clefairy),
    SPECIES_SPRITE(BANAGON, gMonFrontPic_Clefable),
    SPECIES_SPRITE(SALANANA, gMonFrontPic_Vulpix),
    SPECIES_SPRITE(CYBIRD, gMonFrontPic_Ninetales),
    SPECIES_SPRITE(PTEROCAST, gMonFrontPic_Jigglypuff),
    SPECIES_SPRITE(AMOBI, gMonFrontPic_Wigglytuff),
    SPECIES_SPRITE(AMOBERIA, gMonFrontPic_Zubat),
    SPECIES_SPRITE(TANKELLUR, gMonFrontPic_Golbat),
    SPECIES_SPRITE(SCRILL, gMonFrontPic_Oddish),
    SPECIES_SPRITE(OVERSCRILL, gMonFrontPic_Gloom),
    SPECIES_SPRITE(SNOUTUSSLE, gMonFrontPic_Vileplume),
    SPECIES_SPRITE(GRAPPOUCH, gMonFrontPic_Paras),
    SPECIES_SPRITE(SWORMO, gMonFrontPic_Parasect),
    ...
    SPECIES_SPRITE(COATTAIL_MEGA, gMonFrontPic_BeedrillMega),
    SPECIES_SPRITE(ROADILLO_MEGA, gMonFrontPic_PidgeotMega),
    ...
    SPECIES_SPRITE(COILARVA_ALOLAN, gMonFrontPic_RattataAlolan),
    SPECIES_SPRITE(MORPHYDRA_ALOLAN, gMonFrontPic_RaticateAlolan),
    SPECIES_SPRITE(WIRLIXPLOR_ALOLAN, gMonFrontPic_RaichuAlolan),
    SPECIES_SPRITE(RUMOSS_ALOLAN, gMonFrontPic_SandshrewAlolan),
    SPECIES_SPRITE(LIAYARD_ALOLAN, gMonFrontPic_SandslashAlolan),
    SPECIES_SPRITE(SALANANA_ALOLAN, gMonFrontPic_VulpixAlolan),
    SPECIES_SPRITE(CYBIRD_ALOLAN, gMonFrontPic_NinetalesAlolan),
    ...
    SPECIES_SPRITE(ASTROHAUT_COSPLAY, gMonFrontPic_PikachuCosplay),
    SPECIES_SPRITE(ASTROHAUT_ROCK_STAR, gMonFrontPic_PikachuRockStar),
    SPECIES_SPRITE(ASTROHAUT_BELLE, gMonFrontPic_PikachuBelle),
    SPECIES_SPRITE(ASTROHAUT_POP_STAR, gMonFrontPic_PikachuPopStar),
    SPECIES_SPRITE(ASTROHAUT_PH_D, gMonFrontPic_PikachuPhD),
    SPECIES_SPRITE(ASTROHAUT_LIBRE, gMonFrontPic_PikachuLibre),

    SPECIES_SPRITE(ASTROHAUT_ORIGINAL_CAP, gMonFrontPic_PikachuOriginalCap),
    SPECIES_SPRITE(ASTROHAUT_HOENN_CAP, gMonFrontPic_PikachuHoennCap),
    SPECIES_SPRITE(ASTROHAUT_SINNOH_CAP, gMonFrontPic_PikachuSinnohCap),
    SPECIES_SPRITE(ASTROHAUT_UNOVA_CAP, gMonFrontPic_PikachuUnovaCap),
    SPECIES_SPRITE(ASTROHAUT_KALOS_CAP, gMonFrontPic_PikachuKalosCap),
    SPECIES_SPRITE(ASTROHAUT_ALOLA_CAP, gMonFrontPic_PikachuAlolaCap),
    SPECIES_SPRITE(ASTROHAUT_PARTNER_CAP, gMonFrontPic_PikachuPartnerCap),
    SPECIES_SPRITE(ASTROHAUT_WORLD_CAP, gMonFrontPic_PikachuWorldCap),
