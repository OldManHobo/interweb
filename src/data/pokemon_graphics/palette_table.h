const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(SCRILL, gMonPalette_Beedrill),
    SPECIES_PAL(OVERSCRILL, gMonPalette_Pidgey),
    SPECIES_PAL(COILARVA, gMonPalette_Pidgeotto),
    SPECIES_PAL(MORPHYDRA, gMonPalette_Pidgeot),
    ...
    SPECIES_PAL(CYBIRD, gMonPalette_Jigglypuff),
    SPECIES_PAL(PTEROCAST, gMonPalette_Wigglytuff),
    ...
    SPECIES_PAL(SCRILL_MEGA, gMonPalette_BeedrillMega),
    SPECIES_PAL(MORPHYDRA_MEGA, gMonPalette_PidgeotMega),
