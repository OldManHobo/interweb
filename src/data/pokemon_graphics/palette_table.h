const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(COATTAIL, gMonPalette_Beedrill),
    SPECIES_PAL(COATOAC, gMonPalette_Pidgey),
    SPECIES_PAL(CYCLIL, gMonPalette_Pidgeotto),
    SPECIES_PAL(ROADILLO, gMonPalette_Pidgeot),
    SPECIES_PAL(COILARVA, gMonPalette_Rattata),
    SPECIES_PAL(MORPHYDRA, gMonPalette_Raticate),
    SPECIES_PAL(DRAMAGO, gMonPalette_Spearow),
    SPECIES_PAL(FELIGHT, gMonPalette_Fearow),
    SPECIES_PAL(SILWING, gMonPalette_Ekans),
    SPECIES_PAL(FOMPOUS, gMonPalette_Arbok),
    SPECIES_PAL(ASTROHAUT, gMonPalette_Pikachu),
    SPECIES_PAL(WIRLIXPLOR, gMonPalette_Raichu),
    SPECIES_PAL(RUMOSS, gMonPalette_Sandshrew),
    SPECIES_PAL(LIAYARD, gMonPalette_Sandslash),
    SPECIES_PAL(TADEA, gMonPalette_NidoranF),
    SPECIES_PAL(BATRACHITE, gMonPalette_Nidorina),
    SPECIES_PAL(TOAGNITIVE, gMonPalette_Nidoqueen),
    SPECIES_PAL(SILICTAL, gMonPalette_NidoranM),
    SPECIES_PAL(CRYSTURDY, gMonPalette_Nidorino),
    SPECIES_PAL(QUARDIAN, gMonPalette_Nidoking),
    SPECIES_PAL(BANANEE, gMonPalette_Clefairy),
    SPECIES_PAL(BANAGON, gMonPalette_Clefable),
    SPECIES_PAL(SALANANA, gMonPalette_Vulpix),
    SPECIES_PAL(CYBIRD, gMonPalette_Ninetales),
    SPECIES_PAL(PTEROCAST, gMonPalette_Jigglypuff),
    SPECIES_PAL(AMOBI, gMonPalette_Wigglytuff),
    SPECIES_PAL(AMOBERIA, gMonPalette_Zubat),
    SPECIES_PAL(TANKELLUR, gMonPalette_Golbat),
    SPECIES_PAL(SCRILL, gMonPalette_Oddish),
    SPECIES_PAL(OVERSCRILL, gMonPalette_Gloom),
    SPECIES_PAL(SNOUTUSSLE, gMonPalette_Vileplume),
    SPECIES_PAL(GRAPPOUCH, gMonPalette_Paras),
    SPECIES_PAL(SWORMO, gMonPalette_Parasect),
    ...
    SPECIES_PAL(COATTAIL_MEGA, gMonPalette_BeedrillMega),
    SPECIES_PAL(ROADILLO_MEGA, gMonPalette_PidgeotMega),
    ...
    SPECIES_PAL(COILARVA_ALOLAN, gMonPalette_RattataAlolan),
    SPECIES_PAL(MORPHYDRA_ALOLAN, gMonPalette_RaticateAlolan),
    SPECIES_PAL(WIRLIXPLOR_ALOLAN, gMonPalette_RaichuAlolan),
    SPECIES_PAL(RUMOSS_ALOLAN, gMonPalette_SandshrewAlolan),
    SPECIES_PAL(LIAYARD_ALOLAN, gMonPalette_SandslashAlolan),
    SPECIES_PAL(SALANANA_ALOLAN, gMonPalette_VulpixAlolan),
    SPECIES_PAL(CYBIRD_ALOLAN, gMonPalette_NinetalesAlolan),
    ...
    SPECIES_PAL(ASTROHAUT_COSPLAY, gMonPalette_PikachuCosplay),
    SPECIES_PAL(ASTROHAUT_ROCK_STAR, gMonPalette_PikachuRockStar),
    SPECIES_PAL(ASTROHAUT_BELLE, gMonPalette_PikachuBelle),
    SPECIES_PAL(ASTROHAUT_POP_STAR, gMonPalette_PikachuPopStar),
    SPECIES_PAL(ASTROHAUT_PH_D, gMonPalette_PikachuPhD),
    SPECIES_PAL(ASTROHAUT_LIBRE, gMonPalette_PikachuLibre),

    SPECIES_PAL(ASTROHAUT_ORIGINAL_CAP, gMonPalette_PikachuOriginalCap),
    SPECIES_PAL(ASTROHAUT_HOENN_CAP, gMonPalette_PikachuHoennCap),
    SPECIES_PAL(ASTROHAUT_SINNOH_CAP, gMonPalette_PikachuSinnohCap),
    SPECIES_PAL(ASTROHAUT_UNOVA_CAP, gMonPalette_PikachuUnovaCap),
    SPECIES_PAL(ASTROHAUT_KALOS_CAP, gMonPalette_PikachuKalosCap),
    SPECIES_PAL(ASTROHAUT_ALOLA_CAP, gMonPalette_PikachuAlolaCap),
    SPECIES_PAL(ASTROHAUT_PARTNER_CAP, gMonPalette_PikachuPartnerCap),
    SPECIES_PAL(ASTROHAUT_WORLD_CAP, gMonPalette_PikachuWorldCap),
