const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(GENERA, gMonPalette_Genera),
    SPECIES_PAL(GYANNEX, gMonPalette_Gyannex),
    SPECIES_PAL(KAZEIYAGA, gMonPalette_Kazeiyaga),
    SPECIES_PAL(TEPILLA, gMonPalette_Tepilla),
    SPECIES_PAL(ESCORCHES, gMonPalette_Escorches),
    SPECIES_PAL(SOLADOR, gMonPalette_Solador),
    SPECIES_PAL(RELENTOOTH, gMonPalette_Relentooth),
    SPECIES_PAL(SNARETHAN, gMonPalette_Snarethan),
    SPECIES_PAL(LEVIAMAWL, gMonPalette_Leviamawl),
    SPECIES_PAL(DISCUTTLE, gMonPalette_Discuttle),
    SPECIES_PAL(TENNADISH, gMonPalette_Tennadish),
    SPECIES_PAL(WEBILLITE, gMonPalette_Webillite),
    SPECIES_PAL(GALACTIVY, gMonPalette_Galactivy),
    SPECIES_PAL(XENOWEED, gMonPalette_Xenoweed),
    SPECIES_PAL(COATTAIL, gMonPalette_Coattail),
    SPECIES_PAL(COATOAC, gMonPalette_Coatoac),
    SPECIES_PAL(CYCLIL, gMonPalette_Cyclil),
    SPECIES_PAL(ROADILLO, gMonPalette_Roadillo),
    SPECIES_PAL(COILARVA, gMonPalette_Coilarva),
    SPECIES_PAL(MORPHYDRA, gMonPalette_Morphydra),
    SPECIES_PAL(DRAMAGO, gMonPalette_Dramago),
    SPECIES_PAL(FELIGHT, gMonPalette_Felight),
    SPECIES_PAL(SILWING, gMonPalette_Silwing),
    SPECIES_PAL(FOMPOUS, gMonPalette_Fompous),
    SPECIES_PAL(ASTROHAUT, gMonPalette_Astrohaut),
    SPECIES_PAL(WIRLIXPLOR, gMonPalette_Wirlixplor),
    SPECIES_PAL(RUMOSS, gMonPalette_Rumoss),
    SPECIES_PAL(LIAYARD, gMonPalette_Liayard),
    SPECIES_PAL(TADEA, gMonPalette_Tadea),
    SPECIES_PAL(BATRACHITE, gMonPalette_Batrachite),
    SPECIES_PAL(TOAGNITIVE, gMonPalette_Toagnitive),
    SPECIES_PAL(SILICTAL, gMonPalette_Silictal),
    SPECIES_PAL(CRYSTURDY, gMonPalette_Crysturdy),
    SPECIES_PAL(QUARDIAN, gMonPalette_Quardian),
    SPECIES_PAL(BANANEE, gMonPalette_Bananee),
    SPECIES_PAL(BANAGON, gMonPalette_Banagon),
    SPECIES_PAL(SALANANA, gMonPalette_Salanana),
    SPECIES_PAL(CYBIRD, gMonPalette_Cybird),
    SPECIES_PAL(PTEROCAST, gMonPalette_Pterocast),
    SPECIES_PAL(AMOBI, gMonPalette_Amobi),
    SPECIES_PAL(AMOBERIA, gMonPalette_Amoberia),
    SPECIES_PAL(TANKELLUR, gMonPalette_Tankellur),
    SPECIES_PAL(SCRILL, gMonPalette_Scrill),
    SPECIES_PAL(OVERSCRILL, gMonPalette_Overscrill),
    SPECIES_PAL(SNOUTUSSLE, gMonPalette_Snoutussle),
    SPECIES_PAL(GRAPPOUCH, gMonPalette_Grappouch),
    SPECIES_PAL(SWORMO, gMonPalette_Swormo),
    SPECIES_PAL(EKANS, gMonPalette_Venonat),
    SPECIES_PAL(PIKACHU, gMonPalette_Venomoth),
...
#endif
    SPECIES_PAL(KAZEIYAGA_MEGA, gMonPalette_KazeiyagaMega),
    SPECIES_PAL(SOLADOR_MEGA_X, gMonPalette_SoladorMegaX),
    SPECIES_PAL(SOLADOR_MEGA_Y, gMonPalette_SoladorMegaY),
    SPECIES_PAL(LEVIAMAWL_MEGA, gMonPalette_LeviamawlMega),
    SPECIES_PAL(COATTAIL_MEGA, gMonPalette_CoattailMega),
    SPECIES_PAL(ROADILLO_MEGA, gMonPalette_RoadilloMega),
    ...
    SPECIES_PAL(COILARVA_ALOLAN, gMonPalette_CoilarvaAlolan),
    SPECIES_PAL(MORPHYDRA_ALOLAN, gMonPalette_MorphydraAlolan),
    SPECIES_PAL(WIRLIXPLOR_ALOLAN, gMonPalette_WirlixplorAlolan),
    SPECIES_PAL(RUMOSS_ALOLAN, gMonPalette_RumossAlolan),
    SPECIES_PAL(LIAYARD_ALOLAN, gMonPalette_LiayardAlolan),
    SPECIES_PAL(SALANANA_ALOLAN, gMonPalette_SalananaAlolan),
    SPECIES_PAL(CYBIRD_ALOLAN, gMonPalette_CybirdAlolan),
    ...
    SPECIES_PAL(ASTROHAUT_COSPLAY, gMonPalette_AstrohautCosplay),
    SPECIES_PAL(ASTROHAUT_ROCK_STAR, gMonPalette_AstrohautRockStar),
    SPECIES_PAL(ASTROHAUT_BELLE, gMonPalette_AstrohautBelle),
    SPECIES_PAL(ASTROHAUT_POP_STAR, gMonPalette_AstrohautPopStar),
    SPECIES_PAL(ASTROHAUT_PH_D, gMonPalette_AstrohautPhD),
    SPECIES_PAL(ASTROHAUT_LIBRE, gMonPalette_AstrohautLibre),

    SPECIES_PAL(ASTROHAUT_ORIGINAL_CAP, gMonPalette_AstrohautOriginalCap),
    SPECIES_PAL(ASTROHAUT_HOENN_CAP, gMonPalette_AstrohautHoennCap),
    SPECIES_PAL(ASTROHAUT_SINNOH_CAP, gMonPalette_AstrohautSinnohCap),
    SPECIES_PAL(ASTROHAUT_UNOVA_CAP, gMonPalette_AstrohautUnovaCap),
    SPECIES_PAL(ASTROHAUT_KALOS_CAP, gMonPalette_AstrohautKalosCap),
    SPECIES_PAL(ASTROHAUT_ALOLA_CAP, gMonPalette_AstrohautAlolaCap),
    SPECIES_PAL(ASTROHAUT_PARTNER_CAP, gMonPalette_AstrohautPartnerCap),
    SPECIES_PAL(ASTROHAUT_WORLD_CAP, gMonPalette_AstrohautWorldCap),
