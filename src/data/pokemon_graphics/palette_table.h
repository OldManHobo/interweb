const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(BADGERP, gMonPalette_Bulbasaur),
    SPECIES_PAL(HUHGER, gMonPalette_Ivysaur),
    SPECIES_PAL(MELECIUM, gMonPalette_Venusaur),
    SPECIES_PAL(TEPILLA, gMonPalette_Charmander),
    SPECIES_PAL(ESCORCHES, gMonPalette_Charmeleon),
    SPECIES_PAL(SOLADOR, gMonPalette_Charizard),
    SPECIES_PAL(RELENTOOTH, gMonPalette_Squirtle),
    SPECIES_PAL(SNARETHAN, gMonPalette_Wartortle),
    SPECIES_PAL(LEVIAMAWL, gMonPalette_Blastoise),
    SPECIES_PAL(DISCUTTLE, gMonPalette_Caterpie),
    SPECIES_PAL(TENNADISH, gMonPalette_Metapod),
    SPECIES_PAL(WEBILLITE, gMonPalette_Butterfree),
    SPECIES_PAL(GALACTIVY, gMonPalette_Weedle),
    SPECIES_PAL(XENOWEED, gMonPalette_Kakuna),
    SPECIES_PAL(SNAGOON, gMonPalette_Beedrill),
    SPECIES_PAL(REPOCOON, gMonPalette_Pidgey),
    SPECIES_PAL(COILARVA, gMonPalette_Pidgeotto),
    SPECIES_PAL(COILOCUS, gMonPalette_Pidgeot),
    SPECIES_PAL(DRAMAGO, gMonPalette_Rattata),
    SPECIES_PAL(FELIGHT, gMonPalette_Raticate),
    SPECIES_PAL(SILWING, gMonPalette_Spearow),
    SPECIES_PAL(FOMPOUS, gMonPalette_Fearow),
    SPECIES_PAL(ASTROHAUT, gMonPalette_Ekans),
    SPECIES_PAL(WIRLIXPLOR, gMonPalette_Arbok),
    SPECIES_PAL(GENTOO, gMonPalette_Pikachu),
    SPECIES_PAL(SAWFUL, gMonPalette_Raichu),
    SPECIES_PAL(SAULLACE, gMonPalette_Sandshrew),
    SPECIES_PAL(RUMOSS, gMonPalette_Sandslash),
    SPECIES_PAL(LIAYARD, gMonPalette_NidoranF),
    SPECIES_PAL(TADEA, gMonPalette_Nidorina),
    SPECIES_PAL(BATRACHITE, gMonPalette_Nidoqueen),
    SPECIES_PAL(TOAGNITIVE, gMonPalette_NidoranM),
    SPECIES_PAL(SILICTAL, gMonPalette_Nidorino),
    SPECIES_PAL(CRYSTURDY, gMonPalette_Nidoking),
    SPECIES_PAL(QUARDIAN, gMonPalette_Clefairy),
    SPECIES_PAL(BANANEE, gMonPalette_Clefable),
    SPECIES_PAL(BANAGON, gMonPalette_Vulpix),
    SPECIES_PAL(SALANANA, gMonPalette_Ninetales),
    SPECIES_PAL(HYPADOG, gMonPalette_Jigglypuff),
    SPECIES_PAL(HYPADOG2, gMonPalette_Wigglytuff),
    SPECIES_PAL(AMOBI, gMonPalette_Zubat),
    SPECIES_PAL(AMOBERIA, gMonPalette_Golbat),
    SPECIES_PAL(TANKELLUR, gMonPalette_Oddish),
    SPECIES_PAL(CYCLIL, gMonPalette_Gloom),
    SPECIES_PAL(ROADILLO, gMonPalette_Vileplume),
    SPECIES_PAL(COATTAIL, gMonPalette_Paras),
    SPECIES_PAL(COATOAC, gMonPalette_Parasect),
    SPECIES_PAL(SNOUTUSSLE, gMonPalette_Venonat),
    SPECIES_PAL(GRAPPOUCH, gMonPalette_Venomoth),
    SPECIES_PAL(CYBIRD, gMonPalette_Diglett),
    SPECIES_PAL(PTEROCAST, gMonPalette_Dugtrio),
    SPECIES_PAL(MEOWTH, gMonPalette_Meowth),
    SPECIES_PAL(PERSIAN, gMonPalette_Persian),
    SPECIES_PAL(PSYDUCK, gMonPalette_Psyduck),
    SPECIES_PAL(AILES, gMonPalette_Golduck),
    SPECIES_PAL(NACLES, gMonPalette_Mankey),
    SPECIES_PAL(LICLES, gMonPalette_Primeape),
...
#endif
    SPECIES_PAL(MELECIUM_MEGA, gMonPalette_VenusaurMega),
    SPECIES_PAL(SOLADOR_MEGA_X, gMonPalette_CharizardMegaX),
    SPECIES_PAL(SOLADOR_MEGA_Y, gMonPalette_CharizardMegaY),
    SPECIES_PAL(LEVIAMAWL_MEGA, gMonPalette_BlastoiseMega),
    SPECIES_PAL(SNAGOON_MEGA, gMonPalette_BeedrillMega),
    SPECIES_PAL(COILOCUS_MEGA, gMonPalette_PidgeotMega),
    ...
    SPECIES_PAL(DRAMAGO_ALOLAN, gMonPalette_RattataAlolan),
    SPECIES_PAL(FELIGHT_ALOLAN, gMonPalette_RaticateAlolan),
    SPECIES_PAL(SAWFUL_ALOLAN, gMonPalette_RaichuAlolan),
    SPECIES_PAL(SAULLACE_ALOLAN, gMonPalette_SandshrewAlolan),
    SPECIES_PAL(RUMOSS_ALOLAN, gMonPalette_SandslashAlolan),
    SPECIES_PAL(BANAGON_ALOLAN, gMonPalette_VulpixAlolan),
    SPECIES_PAL(SALANANA_ALOLAN, gMonPalette_NinetalesAlolan),
    SPECIES_PAL(CYBIRD_ALOLAN, gMonPalette_DiglettAlolan),
    SPECIES_PAL(PTEROCAST_ALOLAN, gMonPalette_DugtrioAlolan),
    ...
    SPECIES_PAL(GENTOO_COSPLAY, gMonPalette_PikachuCosplay),
    SPECIES_PAL(GENTOO_ROCK_STAR, gMonPalette_PikachuRockStar),
    SPECIES_PAL(GENTOO_BELLE, gMonPalette_PikachuBelle),
    SPECIES_PAL(GENTOO_POP_STAR, gMonPalette_PikachuPopStar),
    SPECIES_PAL(GENTOO_PH_D, gMonPalette_PikachuPhD),
    SPECIES_PAL(GENTOO_LIBRE, gMonPalette_PikachuLibre),

    SPECIES_PAL(GENTOO_ORIGINAL_CAP, gMonPalette_PikachuOriginalCap),
    SPECIES_PAL(GENTOO_HOENN_CAP, gMonPalette_PikachuHoennCap),
    SPECIES_PAL(GENTOO_SINNOH_CAP, gMonPalette_PikachuSinnohCap),
    SPECIES_PAL(GENTOO_UNOVA_CAP, gMonPalette_PikachuUnovaCap),
    SPECIES_PAL(GENTOO_KALOS_CAP, gMonPalette_PikachuKalosCap),
    SPECIES_PAL(GENTOO_ALOLA_CAP, gMonPalette_PikachuAlolaCap),
    SPECIES_PAL(GENTOO_PARTNER_CAP, gMonPalette_PikachuPartnerCap),
    SPECIES_PAL(GENTOO_WORLD_CAP, gMonPalette_PikachuWorldCap),
