const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_COATTAIL] = gMonFootprint_Beedrill,
    [SPECIES_COATOAC] = gMonFootprint_Pidgey,
    [SPECIES_CYCLIL] = gMonFootprint_Pidgeotto,
    [SPECIES_ROADILLO] = gMonFootprint_Pidgeot,
    [SPECIES_COILARVA] = gMonFootprint_Rattata,
    [SPECIES_MORPHYDRA] = gMonFootprint_Raticate,
    [SPECIES_DRAMAGO] = gMonFootprint_Spearow,
    [SPECIES_FELIGHT] = gMonFootprint_Fearow,
    [SPECIES_SILWING] = gMonFootprint_Ekans,
    [SPECIES_FOMPOUS] = gMonFootprint_Arbok,
    [SPECIES_ASTROHAUT] = gMonFootprint_Pikachu,
    [SPECIES_WIRLIXPLOR] = gMonFootprint_Raichu,
    [SPECIES_RUMOSS] = gMonFootprint_Sandshrew,
    [SPECIES_LIAYARD] = gMonFootprint_Sandslash,
    [SPECIES_TADEA] = gMonFootprint_NidoranF,
    [SPECIES_BATRACHITE] = gMonFootprint_Nidorina,
    [SPECIES_TOAGNITIVE] = gMonFootprint_Nidoqueen,
    [SPECIES_SILICTAL] = gMonFootprint_NidoranM,
    [SPECIES_CRYSTURDY] = gMonFootprint_Nidorino,
    [SPECIES_QUARDIAN] = gMonFootprint_Nidoking,
    [SPECIES_BANANEE] = gMonFootprint_Clefairy,
    [SPECIES_BANAGON] = gMonFootprint_Clefable,
    [SPECIES_SALANANA] = gMonFootprint_Vulpix,
    [SPECIES_CYBIRD] = gMonFootprint_Ninetales,
    [SPECIES_PTEROCAST] = gMonFootprint_Jigglypuff,
    [SPECIES_AMOBI] = gMonFootprint_Wigglytuff,
    [SPECIES_AMOBERIA] = gMonFootprint_Zubat,
    [SPECIES_TANKELLUR] = gMonFootprint_Golbat,
    [SPECIES_SCRILL] = gMonFootprint_Oddish,
    [SPECIES_OVERSCRILL] = gMonFootprint_Gloom,
    [SPECIES_SNOUTUSSLE] = gMonFootprint_Vileplume,
    [SPECIES_GRAPPOUCH] = gMonFootprint_Paras,
    [SPECIES_SWORMO] = gMonFootprint_Parasect,
