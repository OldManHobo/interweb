const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_SCRILL] = gMonFootprint_Beedrill,
    [SPECIES_OVERSCRILL] = gMonFootprint_Pidgey,
    [SPECIES_COILARVA] = gMonFootprint_Pidgeotto,
    [SPECIES_MORPHYDRA] = gMonFootprint_Pidgeot,
    ...
    [SPECIES_CYBIRD] = gMonFootprint_Jigglypuff,
    [SPECIES_PTEROCAST] = gMonFootprint_Wigglytuff,
