...
{
    [SPECIES_NONE] = gMonFootprint_Genera,
    [SPECIES_GENERA] = gMonFootprint_Genera,
    [SPECIES_GYANNEX] = gMonFootprint_Gyannex,
    [SPECIES_KAZEIYAGA] = gMonFootprint_Kazeiyaga,
    [SPECIES_TEPILLA] = gMonFootprint_Tepilla,
    [SPECIES_ESCORCHES] = gMonFootprint_Escorches,
    [SPECIES_SOLADOR] = gMonFootprint_Solador,
    [SPECIES_RELENTOOTH] = gMonFootprint_Relentooth,
    [SPECIES_SNARETHAN] = gMonFootprint_Snarethan,
    [SPECIES_LEVIAMAWL] = gMonFootprint_Leviamawl,
    [SPECIES_DISCUTTLE] = gMonFootprint_Discuttle,
    [SPECIES_TENNADISH] = gMonFootprint_Tennadish,
    [SPECIES_WEBILLITE] = gMonFootprint_Webillite,
    [SPECIES_GALACTIVY] = gMonFootprint_Galactivy,
    [SPECIES_XENOWEED] = gMonFootprint_Xenoweed,
    [SPECIES_COATTAIL] = gMonFootprint_Coattail,
    [SPECIES_COATOAC] = gMonFootprint_Coatoac,
    [SPECIES_CYCLIL] = gMonFootprint_Cyclil,
    [SPECIES_ROADILLO] = gMonFootprint_Roadillo,
    [SPECIES_COILARVA] = gMonFootprint_Coilarva,
    [SPECIES_MORPHYDRA] = gMonFootprint_Morphydra,
    [SPECIES_DRAMAGO] = gMonFootprint_Dramago,
    [SPECIES_FELIGHT] = gMonFootprint_Felight,
    [SPECIES_SILWING] = gMonFootprint_Silwing,
    [SPECIES_FOMPOUS] = gMonFootprint_Fompous,
    [SPECIES_ASTROHAUT] = gMonFootprint_Astrohaut,
    [SPECIES_WIRLIXPLOR] = gMonFootprint_Wirlixplor,
    [SPECIES_RUMOSS] = gMonFootprint_Rumoss,
    [SPECIES_LIAYARD] = gMonFootprint_Liayard,
    [SPECIES_TADEA] = gMonFootprint_Tadea,
    [SPECIES_BATRACHITE] = gMonFootprint_Batrachite,
    [SPECIES_TOAGNITIVE] = gMonFootprint_Toagnitive,
    [SPECIES_SILICTAL] = gMonFootprint_Silictal,
    [SPECIES_CRYSTURDY] = gMonFootprint_Crysturdy,
    [SPECIES_QUARDIAN] = gMonFootprint_Quardian,
    [SPECIES_BANANEE] = gMonFootprint_Bananee,
    [SPECIES_BANAGON] = gMonFootprint_Banagon,
    [SPECIES_SALANANA] = gMonFootprint_Salanana,
    [SPECIES_CYBIRD] = gMonFootprint_Cybird,
    [SPECIES_PTEROCAST] = gMonFootprint_Pterocast,
    [SPECIES_AMOBI] = gMonFootprint_Amobi,
    [SPECIES_AMOBERIA] = gMonFootprint_Amoberia,
    [SPECIES_TANKELLUR] = gMonFootprint_Tankellur,
    [SPECIES_SCRILL] = gMonFootprint_Scrill,
    [SPECIES_OVERSCRILL] = gMonFootprint_Overscrill,
    [SPECIES_SNOUTUSSLE] = gMonFootprint_Snoutussle,
    [SPECIES_GRAPPOUCH] = gMonFootprint_Grappouch,
    [SPECIES_SWORMO] = gMonFootprint_Swormo,
    [SPECIES_EKANS] = gMonFootprint_Venonat,
    [SPECIES_PIKACHU] = gMonFootprint_Venomoth,
    ...
    [SPECIES_AILES] = gMonFootprint_Golduck,
    [SPECIES_NACLES] = gMonFootprint_Mankey,
    [SPECIES_LICLES] = gMonFootprint_Primeape,
...
#endif
    [SPECIES_EGG] = gMonFootprint_Genera,
};
