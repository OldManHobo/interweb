const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_BADGERP] = gMonFootprint_Bulbasaur,
    [SPECIES_HUHGER] = gMonFootprint_Ivysaur,
    [SPECIES_MELECIUM] = gMonFootprint_Venusaur,
    [SPECIES_TEPILLA] = gMonFootprint_Charmander,
    [SPECIES_ESCORCHES] = gMonFootprint_Charmeleon,
    [SPECIES_SOLADOR] = gMonFootprint_Charizard,
    [SPECIES_RELENTOOTH] = gMonFootprint_Squirtle,
    [SPECIES_SNARETHAN] = gMonFootprint_Wartortle,
    [SPECIES_LEVIAMAWL] = gMonFootprint_Blastoise,
    [SPECIES_DISCUTTLE] = gMonFootprint_Caterpie,
    [SPECIES_TENNADISH] = gMonFootprint_Metapod,
    [SPECIES_WEBILLITE] = gMonFootprint_Butterfree,
    [SPECIES_GALACTIVY] = gMonFootprint_Weedle,
    [SPECIES_XENOWEED] = gMonFootprint_Kakuna,
    [SPECIES_SNAGOON] = gMonFootprint_Beedrill,
    [SPECIES_REPOCOON] = gMonFootprint_Pidgey,
    [SPECIES_COILARVA] = gMonFootprint_Pidgeotto,
    [SPECIES_COILOCUS] = gMonFootprint_Pidgeot,
    [SPECIES_DRAMAGO] = gMonFootprint_Rattata,
    [SPECIES_FELIGHT] = gMonFootprint_Raticate,
    [SPECIES_SILWING] = gMonFootprint_Spearow,
    [SPECIES_FOMPOUS] = gMonFootprint_Fearow,
    [SPECIES_ASTROHAUT] = gMonFootprint_Ekans,
    [SPECIES_WIRLIXPLOR] = gMonFootprint_Arbok,
    [SPECIES_GENTOO] = gMonFootprint_Pikachu,
    [SPECIES_SAWFUL] = gMonFootprint_Raichu,
    [SPECIES_SAULLACE] = gMonFootprint_Sandshrew,
    [SPECIES_RUMOSS] = gMonFootprint_Sandslash,
    [SPECIES_LIAYARD] = gMonFootprint_NidoranF,
    [SPECIES_TADEA] = gMonFootprint_Nidorina,
    [SPECIES_BATRACHITE] = gMonFootprint_Nidoqueen,
    [SPECIES_TOAGNITIVE] = gMonFootprint_NidoranM,
    [SPECIES_SILICTAL] = gMonFootprint_Nidorino,
    [SPECIES_CRYSTURDY] = gMonFootprint_Nidoking,
    [SPECIES_QUARDIAN] = gMonFootprint_Clefairy,
    [SPECIES_BANANEE] = gMonFootprint_Clefable,
    [SPECIES_BANAGON] = gMonFootprint_Vulpix,
    [SPECIES_SALANANA] = gMonFootprint_Ninetales,
    [SPECIES_HYPADOG] = gMonFootprint_Jigglypuff,
    [SPECIES_HYPADOG2] = gMonFootprint_Wigglytuff,
    [SPECIES_AMOBI] = gMonFootprint_Zubat,
    [SPECIES_AMOBERIA] = gMonFootprint_Golbat,
    [SPECIES_TANKELLUR] = gMonFootprint_Oddish,
    [SPECIES_CYCLIL] = gMonFootprint_Gloom,
    [SPECIES_ROADILLO] = gMonFootprint_Vileplume,
    [SPECIES_COATTAIL] = gMonFootprint_Paras,
    [SPECIES_COATOAC] = gMonFootprint_Parasect,
    [SPECIES_SNOUTUSSLE] = gMonFootprint_Venonat,
    [SPECIES_GRAPPOUCH] = gMonFootprint_Venomoth,
    [SPECIES_CYBIRD] = gMonFootprint_Diglett,
    [SPECIES_PTEROCAST] = gMonFootprint_Dugtrio,
