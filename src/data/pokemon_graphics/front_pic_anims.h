...
static const union AnimCmd sAnim_GENTOO_PH_D_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_BADGERP]   = sAnims_Bulbasaur,
    [SPECIES_HUHGER]     = sAnims_Ivysaur,
    [SPECIES_MELECIUM]    = sAnims_Venusaur,
    [SPECIES_TEPILLA]  = sAnims_Charmander,
    [SPECIES_ESCORCHES]  = sAnims_Charmeleon,
    [SPECIES_SOLADOR]   = sAnims_Charizard,
    [SPECIES_RELENTOOTH]    = sAnims_Squirtle,
    [SPECIES_SNARETHAN]   = sAnims_Wartortle,
    [SPECIES_LEVIAMAWL]   = sAnims_Blastoise,
    [SPECIES_DISCUTTLE]    = sAnims_Caterpie,
    [SPECIES_TENNADISH]     = sAnims_Metapod,
    [SPECIES_WEBILLITE]  = sAnims_Butterfree,
    [SPECIES_GALACTIVY]      = sAnims_Weedle,
    [SPECIES_XENOWEED]      = sAnims_Kakuna,
    [SPECIES_SNAGOON]    = sAnims_Beedrill,
    [SPECIES_REPOCOON]      = sAnims_Pidgey,
    [SPECIES_COILARVA]   = sAnims_Pidgeotto,
    [SPECIES_COILOCUS]     = sAnims_Pidgeot,
    [SPECIES_DRAMAGO]     = sAnims_Rattata,
    [SPECIES_FELIGHT]    = sAnims_Raticate,
    [SPECIES_SILWING]     = sAnims_Spearow,
    [SPECIES_FOMPOUS]      = sAnims_Fearow,
    [SPECIES_ASTROHAUT]       = sAnims_Ekans,
    [SPECIES_WIRLIXPLOR]       = sAnims_Arbok,
    [SPECIES_GENTOO]     = sAnims_Pikachu,
    [SPECIES_SAWFUL]      = sAnims_Raichu,
    [SPECIES_SAULLACE]   = sAnims_Sandshrew,
    [SPECIES_RUMOSS]   = sAnims_Sandslash,
    [SPECIES_LIAYARD]   = sAnims_NidoranF,
    [SPECIES_TADEA]    = sAnims_Nidorina,
    [SPECIES_BATRACHITE]   = sAnims_Nidoqueen,
    [SPECIES_TOAGNITIVE]   = sAnims_NidoranM,
    [SPECIES_SILICTAL]    = sAnims_Nidorino,
    [SPECIES_CRYSTURDY]    = sAnims_Nidoking,
    [SPECIES_QUARDIAN]    = sAnims_Clefairy,
    [SPECIES_BANANEE]    = sAnims_Clefable,
    [SPECIES_BANAGON]      = sAnims_Vulpix,
    [SPECIES_SALANANA]   = sAnims_Ninetales,
    [SPECIES_HYPADOG]  = sAnims_Jigglypuff,
    [SPECIES_HYPADOG2]  = sAnims_Wigglytuff,
    [SPECIES_AMOBI]       = sAnims_Zubat,
    [SPECIES_AMOBERIA]      = sAnims_Golbat,
    [SPECIES_TANKELLUR]      = sAnims_Oddish,
    [SPECIES_CYCLIL]       = sAnims_Gloom,
    [SPECIES_ROADILLO]   = sAnims_Vileplume,
    [SPECIES_COATTAIL]       = sAnims_Paras,
    [SPECIES_COATOAC]    = sAnims_Parasect,
    [SPECIES_SNOUTUSSLE]     = sAnims_Venonat,
    [SPECIES_GRAPPOUCH]    = sAnims_Venomoth,
    [SPECIES_CYBIRD]     = sAnims_Diglett,
    [SPECIES_PTEROCAST]     = sAnims_Dugtrio,
...
#endif
    [SPECIES_MELECIUM_MEGA] = sAnims_VenusaurMega,
    [SPECIES_SOLADOR_MEGA_X] = sAnims_SOLADOR_MEGA_X,
    [SPECIES_SOLADOR_MEGA_Y] = sAnims_SOLADOR_MEGA_Y,
    [SPECIES_LEVIAMAWL_MEGA] = sAnims_BlastoiseMega,
    [SPECIES_SNAGOON_MEGA] = sAnims_BeedrillMega,
    [SPECIES_COILOCUS_MEGA] = sAnims_PidgeotMega,
    ...
    [SPECIES_DRAMAGO_ALOLAN] = sAnims_RattataAlolan,
    [SPECIES_FELIGHT_ALOLAN] = sAnims_RaticateAlolan,
    [SPECIES_SAWFUL_ALOLAN] = sAnims_RaichuAlolan,
    [SPECIES_SAULLACE_ALOLAN] = sAnims_SandshrewAlolan,
    [SPECIES_RUMOSS_ALOLAN] = sAnims_SandslashAlolan,
    [SPECIES_BANAGON_ALOLAN] = sAnims_VulpixAlolan,
    [SPECIES_SALANANA_ALOLAN] = sAnims_NinetalesAlolan,
    [SPECIES_CYBIRD_ALOLAN] = sAnims_DiglettAlolan,
    [SPECIES_PTEROCAST_ALOLAN] = sAnims_DugtrioAlolan,
...
#endif
    [SPECIES_GENTOO_COSPLAY] = sAnims_PikachuCosplay,
    [SPECIES_GENTOO_ROCK_STAR] = sAnims_PikachuRockStar,
    [SPECIES_GENTOO_BELLE] = sAnims_PikachuBelle,
    [SPECIES_GENTOO_POP_STAR] = sAnims_PikachuPopStar,
    [SPECIES_GENTOO_PH_D] = sAnims_GENTOO_PH_D,
    [SPECIES_GENTOO_LIBRE] = sAnims_PikachuLibre,
    [SPECIES_GENTOO_ORIGINAL_CAP] = sAnims_PikachuOriginalCap,
    [SPECIES_GENTOO_HOENN_CAP] = sAnims_PikachuHoennCap,
    [SPECIES_GENTOO_SINNOH_CAP] = sAnims_PikachuSinnohCap,
    [SPECIES_GENTOO_UNOVA_CAP] = sAnims_PikachuUnovaCap,
    [SPECIES_GENTOO_KALOS_CAP] = sAnims_PikachuKalosCap,
    [SPECIES_GENTOO_ALOLA_CAP] = sAnims_PikachuAlolaCap,
    [SPECIES_GENTOO_PARTNER_CAP] = sAnims_PikachuPartnerCap,
    [SPECIES_GENTOO_WORLD_CAP] = sAnims_PikachuWorldCap,
