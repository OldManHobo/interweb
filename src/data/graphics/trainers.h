...
const u32 gTrainerFrontPic_Professor[] = INCBIN_U32("graphics/trainers/front_pics/professor.4bpp.lz");
const u32 gTrainerPalette_Professor[] = INCBIN_U32("graphics/trainers/front_pics/professor.gbapal.lz");
