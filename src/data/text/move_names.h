...
const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_BYTE] = _("Byte"),
    [MOVE_TURBO_CUTTER] = _("Turbo Cutter"),
    [MOVE_GIGABYTE] = _("Gigabyte"),
    [MOVE_WILD_SPAM] = _("Wild Spam"),
    [MOVE_SHED_CACHE] = _("Shed Cache"),
    [MOVE_INSTALL] = _("Install"),
    [MOVE_TECHNO_BUSTER] = _("TechnoBustr"),
    ...
    [MOVE_HOCUS_POCUS] = _("Hocus Pocus"),
    [MOVE_RUFFLE_UP] = _("Ruffle Up"),
    [MOVE_SOUL_DRAIN] = _("Soul Drain"),
    [MOVE_QUICK_SAND] = _("Quick Sand"),
    [MOVE_SOMNO_PUNCH] = _("Somno Punch"),
    [MOVE_DOOMSTONER] = _("Doomstoner"),
...
const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_DATA_TRANSFER] = _("DataTransfr"),
    [MOVE_VENOM_DRAIN] = _("Venom Drain"),
    [MOVE_EXHAUST_FUME] = _("ExhaustFume"),
    [MOVE_DEEP_SUNDER] = _("Deep Sunder"),
    [MOVE_SNUGGLE_BUG] = _("Snuggle Bug"),
    [MOVE_DREARY_HUG] = _("Dreary Hug"),
    [MOVE_ICY_WATER] = _("Icy Water"),
