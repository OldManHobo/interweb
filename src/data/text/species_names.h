const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_BADGERP] = _("Badgerp"),
    [SPECIES_HUHGER] = _("Huhger"),
    [SPECIES_MELECIUM] = _("Melecium"),
    [SPECIES_TEPILLA] = _("Tepilla"),
    [SPECIES_ESCORCHES] = _("Escorches"),
    [SPECIES_SOLADOR] = _("Solador"),
    [SPECIES_RELENTOOTH] = _("Relentooth"),
    [SPECIES_SNARETHAN] = _("Snarethan"),
    [SPECIES_LEVIAMAWL] = _("Leviamawl"),
    [SPECIES_DISCUTTLE] = _("Discuttle"),
    [SPECIES_TENNADISH] = _("Tennadish"),
    [SPECIES_WEBILLITE] = _("Webillite"),
    [SPECIES_GALACTIVY] = _("Galactivy"),
    [SPECIES_XENOWEED] = _("Xenoweed"),
    [SPECIES_SNAGOON] = _("Snagoon"),
    [SPECIES_REPOCOON] = _("Repocoon"),
    [SPECIES_COILARVA] = _("Coilarva"),
    [SPECIES_COILOCUS] = _("Coilocus"),
    [SPECIES_DRAMAGO] = _("Dramago"),
    [SPECIES_FELIGHT] = _("Felight"),
    [SPECIES_SILWING] = _("Silwing"),
    [SPECIES_FOMPOUS] = _("Fompous"),
    [SPECIES_ASTROHAUT] = _("Astrohaut"),
    [SPECIES_WIRLIXPLOR] = _("Wirlixplor"),
    [SPECIES_GENTOO] = _("Gentoo"),
    [SPECIES_SAWFUL] = _("Sawful"),
    [SPECIES_SAULLACE] = _("Saullace"),
    [SPECIES_RUMOSS] = _("Rumoss"),
    [SPECIES_LIAYARD] = _("Liayard"),
    [SPECIES_TADEA] = _("Tadea"),
    [SPECIES_BATRACHITE] = _("Batrachite"),
    [SPECIES_TOAGNITIVE] = _("Toagnitive"),
    [SPECIES_SILICTAL] = _("Silictal"),
    [SPECIES_CRYSTURDY] = _("Crysturdy"),
    [SPECIES_QUARDIAN] = _("Quardian"),
    [SPECIES_BANANEE] = _("Bananee"),
    [SPECIES_BANAGON] = _("Banagon"),
    [SPECIES_SALANANA] = _("Salanana"),
    [SPECIES_HYPADOG] = _("Hypadog"),
    [SPECIES_HYPADOG2] = _("Hypadog2"),
    [SPECIES_AMOBI] = _("Amobi"),
    [SPECIES_AMOBERIA] = _("Amoberia"),
    [SPECIES_TANKELLUR] = _("Tankellur"),
    [SPECIES_CYCLIL] = _("Cyclil"),
    [SPECIES_ROADILLO] = _("Roadillo"),
    [SPECIES_COATTAIL] = _("Coattail"),
    [SPECIES_COATOAC] = _("Coatoac"),
    [SPECIES_SNOUTUSSLE] = _("Snoutussle"),
    [SPECIES_GRAPPOUCH] = _("Grappouch"),
    [SPECIES_CYBIRD] = _("Cybird"),
    [SPECIES_PTEROCAST] = _("Pterocast"),
    [SPECIES_MEOWTH] = _("Meowth"),
    [SPECIES_PERSIAN] = _("Persian"),
    [SPECIES_PSYDUCK] = _("Psyduck"),
    [SPECIES_AILES] = _("Ailes"),
    [SPECIES_NACLES] = _("Nacles"),
    [SPECIES_LICLES] = _("Licles"),
    ...
    // Megas
    [SPECIES_MELECIUM_MEGA] = _("Venusaur"),
    [SPECIES_SOLADOR_MEGA_X] = _("Charizard"),
    [SPECIES_SOLADOR_MEGA_Y] = _("Charizard"),
    [SPECIES_LEVIAMAWL_MEGA] = _("Blastoise"),
    [SPECIES_SNAGOON_MEGA] = _("Beedrill"),
    [SPECIES_COILOCUS_MEGA] = _("Pidgeot"),
    ...
    // Alolan Forms
    [SPECIES_DRAMAGO_ALOLAN] = _("Rattata"),
    [SPECIES_FELIGHT_ALOLAN] = _("Raticate"),
    [SPECIES_SAWFUL_ALOLAN] = _("Raichu"),
    [SPECIES_SAULLACE_ALOLAN] = _("Sandshrew"),
    [SPECIES_RUMOSS_ALOLAN] = _("Sandslash"),
    [SPECIES_BANAGON_ALOLAN] = _("Vulpix"),
    [SPECIES_SALANANA_ALOLAN] = _("Ninetales"),
    [SPECIES_CYBIRD_ALOLAN] = _("Diglett"),
    [SPECIES_PTEROCAST_ALOLAN] = _("Dugtrio"),
...
//Hisuian Forms
    ...
    // Cosplay Pikachu
    [SPECIES_GENTOO_COSPLAY] = _("Pikachu"),
    [SPECIES_GENTOO_ROCK_STAR] = _("Pikachu"),
    [SPECIES_GENTOO_BELLE] = _("Pikachu"),
    [SPECIES_GENTOO_POP_STAR] = _("Pikachu"),
    [SPECIES_GENTOO_PH_D] = _("Pikachu"),
    [SPECIES_GENTOO_LIBRE] = _("Pikachu"),
    // Cap Pikachu
    [SPECIES_GENTOO_ORIGINAL_CAP] = _("Pikachu"),
    [SPECIES_GENTOO_HOENN_CAP] = _("Pikachu"),
    [SPECIES_GENTOO_SINNOH_CAP] = _("Pikachu"),
    [SPECIES_GENTOO_UNOVA_CAP] = _("Pikachu"),
    [SPECIES_GENTOO_KALOS_CAP] = _("Pikachu"),
    [SPECIES_GENTOO_ALOLA_CAP] = _("Pikachu"),
    [SPECIES_GENTOO_PARTNER_CAP] = _("Pikachu"),
    [SPECIES_GENTOO_WORLD_CAP] = _("Pikachu"),
    // Pichu
