const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_BULBASAUR] = _("Badgerp"),
    [SPECIES_IVYSAUR] = _("Huhger"),
    [SPECIES_VENUSAUR] = _("Melecium"),
    [SPECIES_CHARMANDER] = _("Tepilla"),
    [SPECIES_CHARMELEON] = _("Escorches"),
    [SPECIES_CHARIZARD] = _("Solador"),
    [SPECIES_SQUIRTLE] = _("Pupble"),
    [SPECIES_WARTORTLE] = _("Wulphish"),
    [SPECIES_BLASTOISE] = _("Leviahound"),
    [SPECIES_CATERPIE] = _("Discuttle"),
    [SPECIES_METAPOD] = _("Tennadish"),
    [SPECIES_BUTTERFREE] = _("Webillite"),
    [SPECIES_WEEDLE] = _("Kichief"),
    [SPECIES_KAKUNA] = _("Volki"),
    [SPECIES_BEEDRILL] = _("Snagoon"),
    [SPECIES_PIDGEY] = _("Repocoon"),
    [SPECIES_PIDGEOTTO] = _("Coilarva"),
    [SPECIES_PIDGEOT] = _("Coilocus"),
    [SPECIES_RATTATA] = _("Dramago"),
    [SPECIES_RATICATE] = _("Felight"),
    [SPECIES_SPEAROW] = _("Silwing"),
    [SPECIES_FEAROW] = _("Fompous"),
    [SPECIES_EKANS] = _("Astrohaut"),
    [SPECIES_ARBOK] = _("Wirlixplor"),
    [SPECIES_PIKACHU] = _("Gentoo"),
    [SPECIES_RAICHU] = _("Sawful"),
    [SPECIES_SANDSHREW] = _("Saullace"),
    [SPECIES_SANDSLASH] = _("Rumoss"),
    [SPECIES_NIDORAN_F] = _("Liayard"),
    [SPECIES_NIDORINA] = _("Tadea"),
    [SPECIES_NIDOQUEEN] = _("Batrachite"),
    [SPECIES_NIDORAN_M] = _("Toagnitive"),
    [SPECIES_NIDORINO] = _("Silictal"),
    [SPECIES_NIDOKING] = _("Crysturdy"),
    [SPECIES_CLEFAIRY] = _("Quardian"),
    [SPECIES_CLEFABLE] = _("Bananee"),
    [SPECIES_VULPIX] = _("Banagon"),
    [SPECIES_NINETALES] = _("Salanana"),
    [SPECIES_JIGGLYPUFF] = _("Hypadog"),
    [SPECIES_WIGGLYTUFF] = _("Hypadog2"),
    [SPECIES_ZUBAT] = _("Amobi"),
    [SPECIES_GOLBAT] = _("Amoberia"),
    [SPECIES_ODDISH] = _("Tankellur"),
    [SPECIES_GLOOM] = _("Cyclil"),
    [SPECIES_VILEPLUME] = _("Roadillo"),
    [SPECIES_PARAS] = _("Coattail"),
    [SPECIES_PARASECT] = _("Coatoac"),
    [SPECIES_VENONAT] = _("Snoutussle"),
    [SPECIES_VENOMOTH] = _("Grappouch"),
    ...
    [SPECIES_GOLDUCK] = _("Ailes"),
    [SPECIES_MANKEY] = _("Nacles"),
    [SPECIES_PRIMEAPE] = _("Licles"),
