const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    // Megas
    [SPECIES_KAZEIYAGA_MEGA] = _("Kazeiyaga"),
    [SPECIES_SOLADOR_MEGA_X] = _("Solador"),
    [SPECIES_SOLADOR_MEGA_Y] = _("Solador"),
    [SPECIES_LEVIAMAWL_MEGA] = _("Leviamawl"),
    [SPECIES_COATTAIL_MEGA] = _("Coattail"),
    [SPECIES_ROADILLO_MEGA] = _("Roadillo"),
    ...
    // Alolan Forms
    [SPECIES_COILARVA_ALOLAN] = _("Coilarva"),
    [SPECIES_MORPHYDRA_ALOLAN] = _("Morphydra"),
    [SPECIES_WIRLIXPLOR_ALOLAN] = _("Wirlixplor"),
    [SPECIES_RUMOSS_ALOLAN] = _("Rumoss"),
    [SPECIES_LIAYARD_ALOLAN] = _("Liayard"),
    [SPECIES_SALANANA_ALOLAN] = _("Salanana"),
    [SPECIES_CYBIRD_ALOLAN] = _("Cybird"),
