const u32 *const gDecorIconTable[][2] =
{
    ...
    [DECOR_ASTROHAUT_DOLL]    = {NULL, NULL},
    ...
    [DECOR_PTEROCAST_DOLL] = {NULL, NULL},
    [DECOR_MEOWTH_DOLL]     = {NULL, NULL},
    [DECOR_BANANEE_DOLL]   = {NULL, NULL},
    ...
    [DECOR_MELECIUM_DOLL]   = {gDecorIcon_VenusaurDoll, gDecorIconPalette_VenusaurDoll},
    [DECOR_SOLADOR_DOLL]  = {gDecorIcon_CharizardDoll, gDecorIconPalette_CharizardDoll},
    [DECOR_LEVIAMAWL_DOLL]  = {gDecorIcon_BlastoiseDoll, gDecorIconPalette_BlastoiseDoll},
