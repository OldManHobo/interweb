...
const u16 gEasyChatWordsByLetter_I[] = {
    ...
    EC_WORD_IT_S,
    EC_WORD_ITEM,
    EC_POKEMON_NATIONAL(HUHGER),
};

const u16 gEasyChatWordsByLetter_J[] = {
    DOUBLE_SPECIES_NAME
    EC_POKEMON(HYPADOG),
    EC_POKEMON_NATIONAL(HYPADOG),
    EC_POKEMON(JIRACHI),
    EC_WORD_JOKING,
...
const u16 gEasyChatWordsByLetter_O[] = {
    ...
    DOUBLE_SPECIES_NAME
    EC_POKEMON(TANKELLUR),
    EC_POKEMON_NATIONAL(TANKELLUR),
    EC_MOVE(ODOR_SLEUTH),
    EC_WORD_OF,
    EC_WORD_OFF,
    EC_WORD_OFFENSIVE,
...
const u16 gEasyChatWordsByLetter_P[] = {
    ...
    EC_WORD_PICKUP,
    EC_POKEMON_NATIONAL(COILOCUS),
    EC_POKEMON_NATIONAL(COILARVA),
    EC_POKEMON_NATIONAL(REPOCOON),
    DOUBLE_SPECIES_NAME
    EC_POKEMON(GENTOO),
    EC_POKEMON_NATIONAL(GENTOO),
