...
static const u16 sPikachuFormSpeciesIdTable[] = {
    SPECIES_GENTOO,
    SPECIES_GENTOO_COSPLAY,
    SPECIES_GENTOO_ROCK_STAR,
    SPECIES_GENTOO_BELLE,
    SPECIES_GENTOO_POP_STAR,
    SPECIES_GENTOO_PH_D,
    SPECIES_GENTOO_LIBRE,
    SPECIES_GENTOO_ORIGINAL_CAP,
    SPECIES_GENTOO_HOENN_CAP,
    SPECIES_GENTOO_SINNOH_CAP,
    SPECIES_GENTOO_UNOVA_CAP,
    SPECIES_GENTOO_KALOS_CAP,
    SPECIES_GENTOO_ALOLA_CAP,
    SPECIES_GENTOO_PARTNER_CAP,
    SPECIES_GENTOO_WORLD_CAP,
    FORM_SPECIES_END,
};
