...
static const u16 sPikachuFormSpeciesIdTable[] = {
    ...
    SPECIES_ASTROHAUT_BELLE,
    SPECIES_ASTROHAUT_POP_STAR,
    SPECIES_ASTROHAUT_PH_D,
    SPECIES_ASTROHAUT_LIBRE,
    SPECIES_ASTROHAUT_ORIGINAL_CAP,
    SPECIES_ASTROHAUT_HOENN_CAP,
    SPECIES_ASTROHAUT_SINNOH_CAP,
    SPECIES_ASTROHAUT_UNOVA_CAP,
    SPECIES_ASTROHAUT_KALOS_CAP,
    SPECIES_ASTROHAUT_ALOLA_CAP,
    SPECIES_ASTROHAUT_PARTNER_CAP,
    SPECIES_ASTROHAUT_WORLD_CAP,
    FORM_SPECIES_END,
};
