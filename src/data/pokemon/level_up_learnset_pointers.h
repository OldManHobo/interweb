const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_BADGERP] = sBulbasaurLevelUpLearnset,
    [SPECIES_HUHGER] = sIvysaurLevelUpLearnset,
    [SPECIES_MELECIUM] = sVenusaurLevelUpLearnset,
    [SPECIES_TEPILLA] = sCharmanderLevelUpLearnset,
    [SPECIES_ESCORCHES] = sCharmeleonLevelUpLearnset,
    [SPECIES_SOLADOR] = sCharizardLevelUpLearnset,
    [SPECIES_RELENTOOTH] = sSquirtleLevelUpLearnset,
    [SPECIES_SNARETHAN] = sWartortleLevelUpLearnset,
    [SPECIES_LEVIAMAWL] = sBlastoiseLevelUpLearnset,
    [SPECIES_DISCUTTLE] = sCaterpieLevelUpLearnset,
    [SPECIES_TENNADISH] = sMetapodLevelUpLearnset,
    [SPECIES_WEBILLITE] = sButterfreeLevelUpLearnset,
    [SPECIES_GALACTIVY] = sWeedleLevelUpLearnset,
    [SPECIES_XENOWEED] = sKakunaLevelUpLearnset,
    [SPECIES_SNAGOON] = sBeedrillLevelUpLearnset,
    [SPECIES_REPOCOON] = sPidgeyLevelUpLearnset,
    [SPECIES_COILARVA] = sPidgeottoLevelUpLearnset,
    [SPECIES_COILOCUS] = sPidgeotLevelUpLearnset,
    [SPECIES_DRAMAGO] = sRattataLevelUpLearnset,
    [SPECIES_FELIGHT] = sRaticateLevelUpLearnset,
    [SPECIES_SILWING] = sSpearowLevelUpLearnset,
    [SPECIES_FOMPOUS] = sFearowLevelUpLearnset,
    [SPECIES_ASTROHAUT] = sEkansLevelUpLearnset,
    [SPECIES_WIRLIXPLOR] = sArbokLevelUpLearnset,
    [SPECIES_GENTOO] = sPikachuLevelUpLearnset,
    [SPECIES_SAWFUL] = sRaichuLevelUpLearnset,
    [SPECIES_SAULLACE] = sSandshrewLevelUpLearnset,
    [SPECIES_RUMOSS] = sSandslashLevelUpLearnset,
    [SPECIES_LIAYARD] = sNidoranFLevelUpLearnset,
    [SPECIES_TADEA] = sNidorinaLevelUpLearnset,
    [SPECIES_BATRACHITE] = sNidoqueenLevelUpLearnset,
    [SPECIES_TOAGNITIVE] = sNidoranMLevelUpLearnset,
    [SPECIES_SILICTAL] = sNidorinoLevelUpLearnset,
    [SPECIES_CRYSTURDY] = sNidokingLevelUpLearnset,
    [SPECIES_QUARDIAN] = sClefairyLevelUpLearnset,
    [SPECIES_BANANEE] = sClefableLevelUpLearnset,
    [SPECIES_BANAGON] = sVulpixLevelUpLearnset,
    [SPECIES_SALANANA] = sNinetalesLevelUpLearnset,
    [SPECIES_HYPADOG] = sJigglypuffLevelUpLearnset,
    [SPECIES_HYPADOG2] = sWigglytuffLevelUpLearnset,
    [SPECIES_AMOBI] = sZubatLevelUpLearnset,
    [SPECIES_AMOBERIA] = sGolbatLevelUpLearnset,
    [SPECIES_TANKELLUR] = sOddishLevelUpLearnset,
    [SPECIES_CYCLIL] = sGloomLevelUpLearnset,
    [SPECIES_ROADILLO] = sVileplumeLevelUpLearnset,
    [SPECIES_COATTAIL] = sParasLevelUpLearnset,
    [SPECIES_COATOAC] = sParasectLevelUpLearnset,
    [SPECIES_SNOUTUSSLE] = sVenonatLevelUpLearnset,
    [SPECIES_GRAPPOUCH] = sVenomothLevelUpLearnset,
    [SPECIES_CYBIRD] = sDiglettLevelUpLearnset,
    [SPECIES_PTEROCAST] = sDugtrioLevelUpLearnset,
    [SPECIES_MEOWTH] = sMeowthLevelUpLearnset,
    [SPECIES_PERSIAN] = sPersianLevelUpLearnset,
    [SPECIES_PSYDUCK] = sPsyduckLevelUpLearnset,
    [SPECIES_AILES] = sGolduckLevelUpLearnset,
    [SPECIES_NACLES] = sMankeyLevelUpLearnset,
    [SPECIES_LICLES] = sPrimeapeLevelUpLearnset,
...
#endif
    // Megas
    [SPECIES_MELECIUM_MEGA] = sVenusaurLevelUpLearnset,
    [SPECIES_SOLADOR_MEGA_X] = sCharizardLevelUpLearnset,
    [SPECIES_SOLADOR_MEGA_Y] = sCharizardLevelUpLearnset,
    [SPECIES_LEVIAMAWL_MEGA] = sBlastoiseLevelUpLearnset,
    [SPECIES_SNAGOON_MEGA] = sBeedrillLevelUpLearnset,
    [SPECIES_COILOCUS_MEGA] = sPidgeotLevelUpLearnset,
    ...
    // Alolan Forms
    [SPECIES_DRAMAGO_ALOLAN] = sRattataAlolanLevelUpLearnset,
    [SPECIES_FELIGHT_ALOLAN] = sRaticateAlolanLevelUpLearnset,
    [SPECIES_SAWFUL_ALOLAN] = sRaichuAlolanLevelUpLearnset,
    [SPECIES_SAULLACE_ALOLAN] = sSandshrewAlolanLevelUpLearnset,
    [SPECIES_RUMOSS_ALOLAN] = sSandslashAlolanLevelUpLearnset,
    [SPECIES_BANAGON_ALOLAN] = sVulpixAlolanLevelUpLearnset,
    [SPECIES_SALANANA_ALOLAN] = sNinetalesAlolanLevelUpLearnset,
    [SPECIES_CYBIRD_ALOLAN] = sDiglettAlolanLevelUpLearnset,
    [SPECIES_PTEROCAST_ALOLAN] = sDugtrioAlolanLevelUpLearnset,
    ...
    // Misc Forms
    // Cosplay Pikachu
    [SPECIES_GENTOO_COSPLAY] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_ROCK_STAR] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_BELLE] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_POP_STAR] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_PH_D] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_LIBRE] = sPikachuLevelUpLearnset,
    // Cap Pikachu
    [SPECIES_GENTOO_ORIGINAL_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_HOENN_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_SINNOH_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_UNOVA_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_KALOS_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_ALOLA_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_PARTNER_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_GENTOO_WORLD_CAP] = sPikachuLevelUpLearnset,
    // Pichu
