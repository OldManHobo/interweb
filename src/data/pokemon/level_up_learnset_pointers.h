...
{
    [SPECIES_NONE] = sGeneraLevelUpLearnset,
    [SPECIES_GENERA] = sGeneraLevelUpLearnset,
    [SPECIES_GYANNEX] = sGyannexLevelUpLearnset,
    [SPECIES_KAZEIYAGA] = sKazeiyagaLevelUpLearnset,
    [SPECIES_TEPILLA] = sTepillaLevelUpLearnset,
    [SPECIES_ESCORCHES] = sEscorchesLevelUpLearnset,
    [SPECIES_SOLADOR] = sSoladorLevelUpLearnset,
    [SPECIES_RELENTOOTH] = sRelentoothLevelUpLearnset,
    [SPECIES_SNARETHAN] = sSnarethanLevelUpLearnset,
    [SPECIES_LEVIAMAWL] = sLeviamawlLevelUpLearnset,
    [SPECIES_DISCUTTLE] = sDiscuttleLevelUpLearnset,
    [SPECIES_TENNADISH] = sTennadishLevelUpLearnset,
    [SPECIES_WEBILLITE] = sWebilliteLevelUpLearnset,
    [SPECIES_GALACTIVY] = sGalactivyLevelUpLearnset,
    [SPECIES_XENOWEED] = sXenoweedLevelUpLearnset,
    [SPECIES_COATTAIL] = sCoattailLevelUpLearnset,
    [SPECIES_COATOAC] = sCoatoacLevelUpLearnset,
    [SPECIES_CYCLIL] = sCyclilLevelUpLearnset,
    [SPECIES_ROADILLO] = sRoadilloLevelUpLearnset,
    [SPECIES_COILARVA] = sCoilarvaLevelUpLearnset,
    [SPECIES_MORPHYDRA] = sMorphydraLevelUpLearnset,
    [SPECIES_DRAMAGO] = sDramagoLevelUpLearnset,
    [SPECIES_FELIGHT] = sFelightLevelUpLearnset,
    [SPECIES_SILWING] = sSilwingLevelUpLearnset,
    ...
    [SPECIES_RUMOSS] = sRumossLevelUpLearnset,
    [SPECIES_LIAYARD] = sLiayardLevelUpLearnset,
    [SPECIES_TADEA] = sTadeaLevelUpLearnset,
    [SPECIES_BATRACHITE] = sBatrachiteLevelUpLearnset,
    [SPECIES_TOAGNITIVE] = sToagnitiveLevelUpLearnset,
    [SPECIES_SILICTAL] = sSilictalLevelUpLearnset,
    [SPECIES_CRYSTURDY] = sCrysturdyLevelUpLearnset,
    [SPECIES_QUARDIAN] = sQuardianLevelUpLearnset,
    [SPECIES_BANANEE] = sBananeeLevelUpLearnset,
    [SPECIES_BANAGON] = sBanagonLevelUpLearnset,
    [SPECIES_SALANANA] = sSalananaLevelUpLearnset,
    [SPECIES_CYBIRD] = sCybirdLevelUpLearnset,
    [SPECIES_PTEROCAST] = sPterocastLevelUpLearnset,
    [SPECIES_AMOBI] = sAmobiLevelUpLearnset,
    [SPECIES_AMOBERIA] = sAmoberiaLevelUpLearnset,
    [SPECIES_TANKELLUR] = sTankellurLevelUpLearnset,
    [SPECIES_SCRILL] = sScrillLevelUpLearnset,
    [SPECIES_OVERSCRILL] = sOverscrillLevelUpLearnset,
    [SPECIES_SNOUTUSSLE] = sSnoutussleLevelUpLearnset,
    [SPECIES_GRAPPOUCH] = sGrappouchLevelUpLearnset,
    [SPECIES_SWORMO] = sSwormoLevelUpLearnset,
...
#endif
    // Megas
    [SPECIES_KAZEIYAGA_MEGA] = sKazeiyagaLevelUpLearnset,
    [SPECIES_SOLADOR_MEGA_X] = sSoladorLevelUpLearnset,
    [SPECIES_SOLADOR_MEGA_Y] = sSoladorLevelUpLearnset,
    [SPECIES_LEVIAMAWL_MEGA] = sLeviamawlLevelUpLearnset,
    [SPECIES_COATTAIL_MEGA] = sCoattailLevelUpLearnset,
    [SPECIES_ROADILLO_MEGA] = sRoadilloLevelUpLearnset,
    ...
    // Alolan Forms
    [SPECIES_COILARVA_ALOLAN] = sCoilarvaAlolanLevelUpLearnset,
    [SPECIES_MORPHYDRA_ALOLAN] = sMorphydraAlolanLevelUpLearnset,
    [SPECIES_WIRLIXPLOR_ALOLAN] = sWirlixplorAlolanLevelUpLearnset,
    [SPECIES_RUMOSS_ALOLAN] = sRumossAlolanLevelUpLearnset,
    [SPECIES_LIAYARD_ALOLAN] = sLiayardAlolanLevelUpLearnset,
    [SPECIES_SALANANA_ALOLAN] = sSalananaAlolanLevelUpLearnset,
    [SPECIES_CYBIRD_ALOLAN] = sCybirdAlolanLevelUpLearnset,
    ...
    // Misc Forms
    // Cosplay Astrohaut
    [SPECIES_ASTROHAUT_COSPLAY] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_ROCK_STAR] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_BELLE] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_POP_STAR] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_PH_D] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_LIBRE] = sAstrohautLevelUpLearnset,
    // Cap Astrohaut
    [SPECIES_ASTROHAUT_ORIGINAL_CAP] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_HOENN_CAP] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_SINNOH_CAP] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_UNOVA_CAP] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_KALOS_CAP] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_ALOLA_CAP] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_PARTNER_CAP] = sAstrohautLevelUpLearnset,
    [SPECIES_ASTROHAUT_WORLD_CAP] = sAstrohautLevelUpLearnset,
    // Pichu
