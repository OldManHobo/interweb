const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_COATTAIL] = sBeedrillLevelUpLearnset,
    [SPECIES_COATOAC] = sPidgeyLevelUpLearnset,
    [SPECIES_CYCLIL] = sPidgeottoLevelUpLearnset,
    [SPECIES_ROADILLO] = sPidgeotLevelUpLearnset,
    [SPECIES_COILARVA] = sRattataLevelUpLearnset,
    [SPECIES_MORPHYDRA] = sRaticateLevelUpLearnset,
    [SPECIES_DRAMAGO] = sSpearowLevelUpLearnset,
    [SPECIES_FELIGHT] = sFearowLevelUpLearnset,
    [SPECIES_SILWING] = sEkansLevelUpLearnset,
    [SPECIES_FOMPOUS] = sArbokLevelUpLearnset,
    [SPECIES_ASTROHAUT] = sPikachuLevelUpLearnset,
    [SPECIES_WIRLIXPLOR] = sRaichuLevelUpLearnset,
    [SPECIES_RUMOSS] = sSandshrewLevelUpLearnset,
    [SPECIES_LIAYARD] = sSandslashLevelUpLearnset,
    [SPECIES_TADEA] = sNidoranFLevelUpLearnset,
    [SPECIES_BATRACHITE] = sNidorinaLevelUpLearnset,
    [SPECIES_TOAGNITIVE] = sNidoqueenLevelUpLearnset,
    [SPECIES_SILICTAL] = sNidoranMLevelUpLearnset,
    [SPECIES_CRYSTURDY] = sNidorinoLevelUpLearnset,
    [SPECIES_QUARDIAN] = sNidokingLevelUpLearnset,
    [SPECIES_BANANEE] = sClefairyLevelUpLearnset,
    [SPECIES_BANAGON] = sClefableLevelUpLearnset,
    [SPECIES_SALANANA] = sVulpixLevelUpLearnset,
    [SPECIES_CYBIRD] = sNinetalesLevelUpLearnset,
    [SPECIES_PTEROCAST] = sJigglypuffLevelUpLearnset,
    [SPECIES_AMOBI] = sWigglytuffLevelUpLearnset,
    [SPECIES_AMOBERIA] = sZubatLevelUpLearnset,
    [SPECIES_TANKELLUR] = sGolbatLevelUpLearnset,
    [SPECIES_SCRILL] = sOddishLevelUpLearnset,
    [SPECIES_OVERSCRILL] = sGloomLevelUpLearnset,
    [SPECIES_SNOUTUSSLE] = sVileplumeLevelUpLearnset,
    [SPECIES_GRAPPOUCH] = sParasLevelUpLearnset,
    [SPECIES_SWORMO] = sParasectLevelUpLearnset,
    [SPECIES_EKANS] = sVenonatLevelUpLearnset,
    [SPECIES_PIKACHU] = sVenomothLevelUpLearnset,
    ...
    [SPECIES_COATTAIL_MEGA] = sBeedrillLevelUpLearnset,
    [SPECIES_ROADILLO_MEGA] = sPidgeotLevelUpLearnset,
    ...
    // Alolan Forms
    [SPECIES_COILARVA_ALOLAN] = sRattataAlolanLevelUpLearnset,
    [SPECIES_MORPHYDRA_ALOLAN] = sRaticateAlolanLevelUpLearnset,
    [SPECIES_WIRLIXPLOR_ALOLAN] = sRaichuAlolanLevelUpLearnset,
    [SPECIES_RUMOSS_ALOLAN] = sSandshrewAlolanLevelUpLearnset,
    [SPECIES_LIAYARD_ALOLAN] = sSandslashAlolanLevelUpLearnset,
    [SPECIES_SALANANA_ALOLAN] = sVulpixAlolanLevelUpLearnset,
    [SPECIES_CYBIRD_ALOLAN] = sNinetalesAlolanLevelUpLearnset,
    ...
    // Misc Forms
    // Cosplay Pikachu
    [SPECIES_ASTROHAUT_COSPLAY] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_ROCK_STAR] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_BELLE] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_POP_STAR] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_PH_D] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_LIBRE] = sPikachuLevelUpLearnset,
    // Cap Pikachu
    [SPECIES_ASTROHAUT_ORIGINAL_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_HOENN_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_SINNOH_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_UNOVA_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_KALOS_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_ALOLA_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_PARTNER_CAP] = sPikachuLevelUpLearnset,
    [SPECIES_ASTROHAUT_WORLD_CAP] = sPikachuLevelUpLearnset,
    // Pichu
