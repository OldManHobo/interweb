const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MELECIUM]              = {{EVO_MEGA_EVOLUTION, ITEM_MELECIUMITE, SPECIES_MELECIUM_MEGA}},
    [SPECIES_TEPILLA]            = {{EVO_LEVEL, 16, SPECIES_ESCORCHES}},
    [SPECIES_ESCORCHES]            = {{EVO_LEVEL, 36, SPECIES_SOLADOR}},
    [SPECIES_SOLADOR]             = {{EVO_MEGA_EVOLUTION, ITEM_SOLADORITE_X, SPECIES_SOLADOR_MEGA_X},
                                       {EVO_MEGA_EVOLUTION, ITEM_SOLADORITE_Y, SPECIES_SOLADOR_MEGA_Y}},
    [SPECIES_RELENTOOTH]              = {{EVO_LEVEL, 16, SPECIES_SNARETHAN}},
    [SPECIES_SNARETHAN]             = {{EVO_LEVEL, 36, SPECIES_LEVIAMAWL}},
    [SPECIES_LEVIAMAWL]             = {{EVO_MEGA_EVOLUTION, ITEM_BLASTOISINITE, SPECIES_LEVIAMAWL_MEGA}},
    [SPECIES_DISCUTTLE]              = {{EVO_LEVEL, 10, SPECIES_TENNADISH}},
    [SPECIES_TENNADISH]               = {{EVO_LEVEL, 24, SPECIES_WEBILLITE}},
    [SPECIES_GALACTIVY]                = {{EVO_LEVEL, 22, SPECIES_XENOWEED}},
    [SPECIES_SNAGOON]              = {{EVO_LEVEL, 18, SPECIES_REPOCOON}},
    [SPECIES_COILARVA]             = {{EVO_LEVEL, 18, SPECIES_COILOCUS}},
    [SPECIES_COILOCUS]               = {{EVO_LEVEL, 32, SPECIES_DRAMAGO}},
    [SPECIES_FELIGHT]              = {{EVO_LEVEL, 21, SPECIES_SILWING}},
    [SPECIES_FOMPOUS]                = {{EVO_LEVEL, 14, SPECIES_ASTROHAUT}},
    [SPECIES_ASTROHAUT]                 = {{EVO_LEVEL, 28, SPECIES_WIRLIXPLOR}},
    [SPECIES_GENTOO]               = {{EVO_LEVEL, 25, SPECIES_SAWFUL}},
    [SPECIES_SAWFUL]                = {{EVO_MOVE, MOVE_PLAY_ROUGH, SPECIES_SAULLACE}},
    [SPECIES_RUMOSS]             = {{EVO_LEVEL, 24, SPECIES_RUMOSS}},
    [SPECIES_TADEA]              = {{EVO_LEVEL, 22, SPECIES_BATRACHITE}},
    [SPECIES_BATRACHITE]             = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_TOAGNITIVE}},
    [SPECIES_SILICTAL]              = {{EVO_LEVEL, 23, SPECIES_CRYSTURDY}},
    [SPECIES_CRYSTURDY]              = {{EVO_LEVEL, 37, SPECIES_QUARDIAN}},
    [SPECIES_BANANEE]              = {{EVO_LEVEL, 25, SPECIES_BANAGON}},
    [SPECIES_BANAGON]                = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_SALANANA}},
    [SPECIES_HYPADOG]            = {{EVO_LEVEL, 23, SPECIES_HYPADOG2}},
    [SPECIES_AMOBI]                 = {{EVO_LEVEL, 24, SPECIES_AMOBERIA}},
    [SPECIES_AMOBERIA]                = {{EVO_LEVEL, 34, SPECIES_TANKELLUR}},
    [SPECIES_CYCLIL]                 = {{EVO_MOVE, 21, SPECIES_ROADILLO}},
    [SPECIES_COATTAIL]                 = {{EVO_LEVEL, 18, SPECIES_COATOAC}},
    [SPECIES_SNOUTUSSLE]               = {{EVO_FRIENDSHIP, 0, SPECIES_GRAPPOUCH}},
    [SPECIES_CYBIRD]               = {{EVO_LEVEL, 26, SPECIES_PTEROCAST}},
    [SPECIES_MEOWTH]                = {{EVO_LEVEL, 28, SPECIES_PERSIAN}},
    [SPECIES_PSYDUCK]               = {{EVO_LEVEL, 33, SPECIES_AILES}},
    [SPECIES_NACLES]                = {{EVO_LEVEL, 28, SPECIES_LICLES}},
    ...
    [SPECIES_PICHU]                 = {{EVO_FRIENDSHIP, 0, SPECIES_GENTOO}},
    [SPECIES_CLEFFA]                = {{EVO_FRIENDSHIP, 0, SPECIES_QUARDIAN}},
    [SPECIES_IGGLYBUFF]             = {{EVO_FRIENDSHIP, 0, SPECIES_HYPADOG}},
...
#endif
    [SPECIES_DRAMAGO_ALOLAN]        = {{EVO_LEVEL_NIGHT, 20, SPECIES_FELIGHT_ALOLAN}},
    [SPECIES_SAULLACE_ALOLAN]      = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_RUMOSS_ALOLAN}},
    [SPECIES_BANAGON_ALOLAN]         = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_SALANANA_ALOLAN}},
    [SPECIES_CYBIRD_ALOLAN]        = {{EVO_LEVEL, 26, SPECIES_PTEROCAST_ALOLAN}},
