const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_METAPOD]               = {{EVO_LEVEL, 24, SPECIES_BUTTERFREE}},
    [SPECIES_WEEDLE]                = {{EVO_LEVEL, 22, SPECIES_KAKUNA}},
    [SPECIES_BEEDRILL]              = {{EVO_LEVEL, 18, SPECIES_PIDGEY}},
    [SPECIES_PIDGEOTTO]             = {{EVO_LEVEL, 18, SPECIES_PIDGEOT}},
    [SPECIES_PIDGEOT]               = {{EVO_LEVEL, 32, SPECIES_RATTATA}},
    [SPECIES_RATICATE]              = {{EVO_LEVEL, 21, SPECIES_SPEAROW}},
    [SPECIES_FEAROW]                = {{EVO_LEVEL, 14, SPECIES_EKANS}},
    [SPECIES_EKANS]                 = {{EVO_LEVEL, 28, SPECIES_ARBOK}},
    [SPECIES_PIKACHU]               = {{EVO_LEVEL, 25, SPECIES_RAICHU}},
    [SPECIES_RAICHU]                = {{EVO_MOVE, MOVE_PLAY_ROUGH, SPECIES_SANDSHREW}},
    [SPECIES_SANDSLASH]             = {{EVO_LEVEL, 24, SPECIES_SANDSLASH}},
    [SPECIES_NIDORINA]              = {{EVO_LEVEL, 22, SPECIES_NIDOQUEEN}},
    [SPECIES_NIDOQUEEN]             = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_NIDORAN_M}},
    [SPECIES_NIDORINO]              = {{EVO_LEVEL, 23, SPECIES_NIDOKING}},
    [SPECIES_NIDOKING]              = {{EVO_LEVEL, 37, SPECIES_CLEFAIRY}},
    [SPECIES_CLEFABLE]              = {{EVO_LEVEL, 25, SPECIES_VULPIX}},
    [SPECIES_VULPIX]                = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_NINETALES}},
    [SPECIES_JIGGLYPUFF]            = {{EVO_LEVEL, 23, SPECIES_WIGGLYTUFF}},
    [SPECIES_ZUBAT]                 = {{EVO_LEVEL, 24, SPECIES_GOLBAT}},
    [SPECIES_GOLBAT]                = {{EVO_LEVEL, 34, SPECIES_ODDISH}},
    [SPECIES_GLOOM]                 = {{EVO_MOVE, 21, SPECIES_VILEPLUME}},
    [SPECIES_PARAS]                 = {{EVO_LEVEL, 18, SPECIES_PARASECT}},
    [SPECIES_VENONAT]               = {{EVO_FRIENDSHIP, 0, SPECIES_VENOMOTH}},
