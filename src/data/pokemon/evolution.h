const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CYCLIL]             = {{EVO_LEVEL, 18, SPECIES_ROADILLO}},
    [SPECIES_ROADILLO]               = {{EVO_LEVEL, 32, SPECIES_COILARVA}},
    [SPECIES_MORPHYDRA]              = {{EVO_LEVEL, 21, SPECIES_DRAMAGO}},
    [SPECIES_FELIGHT]                = {{EVO_LEVEL, 14, SPECIES_SILWING}},
    [SPECIES_SILWING]                 = {{EVO_LEVEL, 28, SPECIES_FOMPOUS}},
    [SPECIES_ASTROHAUT]               = {{EVO_LEVEL, 25, SPECIES_WIRLIXPLOR}},
    [SPECIES_WIRLIXPLOR]                = {{EVO_MOVE, MOVE_PLAY_ROUGH, SPECIES_RUMOSS}},
    [SPECIES_LIAYARD]             = {{EVO_LEVEL, 24, SPECIES_LIAYARD}},
    [SPECIES_BATRACHITE]              = {{EVO_LEVEL, 22, SPECIES_TOAGNITIVE}},
    [SPECIES_TOAGNITIVE]             = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_SILICTAL}},
    [SPECIES_CRYSTURDY]              = {{EVO_LEVEL, 23, SPECIES_QUARDIAN}},
    [SPECIES_QUARDIAN]              = {{EVO_LEVEL, 37, SPECIES_BANANEE}},
    [SPECIES_BANAGON]              = {{EVO_LEVEL, 25, SPECIES_SALANANA}},
    [SPECIES_SALANANA]                = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_CYBIRD}},
    [SPECIES_PTEROCAST]            = {{EVO_LEVEL, 23, SPECIES_AMOBI}},
    [SPECIES_AMOBERIA]                 = {{EVO_LEVEL, 24, SPECIES_TANKELLUR}},
    [SPECIES_TANKELLUR]                = {{EVO_LEVEL, 34, SPECIES_SCRILL}},
    [SPECIES_OVERSCRILL]                 = {{EVO_MOVE, 21, SPECIES_SNOUTUSSLE}},
    [SPECIES_GRAPPOUCH]                 = {{EVO_LEVEL, 18, SPECIES_SWORMO}},
    [SPECIES_EKANS]               = {{EVO_FRIENDSHIP, 0, SPECIES_PIKACHU}},
    ...
    [SPECIES_PICHU]                 = {{EVO_FRIENDSHIP, 0, SPECIES_ASTROHAUT}},
    [SPECIES_CLEFFA]                = {{EVO_FRIENDSHIP, 0, SPECIES_BANANEE}},
    [SPECIES_IGGLYBUFF]             = {{EVO_FRIENDSHIP, 0, SPECIES_PTEROCAST}},
...
#endif
    [SPECIES_COILARVA_ALOLAN]        = {{EVO_LEVEL_NIGHT, 20, SPECIES_MORPHYDRA_ALOLAN}},
    [SPECIES_RUMOSS_ALOLAN]      = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_LIAYARD_ALOLAN}},
    [SPECIES_SALANANA_ALOLAN]         = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_CYBIRD_ALOLAN}},
