const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_DISCUTTLE]              = {{EVO_LEVEL, 15, SPECIES_TENNADISH}},
    [SPECIES_TENNADISH]               = {{EVO_LEVEL, 26, SPECIES_WEBILLITE}},
    [SPECIES_GALACTIVY]                = {{EVO_LEVEL, 24, SPECIES_XENOWEED}},
    [SPECIES_COATTAIL]              = {{EVO_LEVEL, 22, SPECIES_COATOAC}},
    [SPECIES_CYCLIL]             = {{EVO_LEVEL, 22, SPECIES_ROADILLO}},
    [SPECIES_COILARVA]               = {{EVO_LEVEL, 18, SPECIES_MORPHYDRA}},
    [SPECIES_MORPHYDRA]              = {{EVO_LEVEL, 35, SPECIES_DRAMAGO}},
    [SPECIES_FELIGHT]                = {{EVO_LEVEL, 23, SPECIES_SILWING}},
    [SPECIES_FOMPOUS]                 = {{EVO_LEVEL, 14, SPECIES_ASTROHAUT}},
    [SPECIES_ASTROHAUT]               = {{EVO_LEVEL, 28, SPECIES_WIRLIXPLOR}},
    [SPECIES_RUMOSS]                = {{EVO_LEVEL, 24, SPECIES_LIAYARD}},
    [SPECIES_TADEA]              = {{EVO_LEVEL, 22, SPECIES_BATRACHITE}},
    [SPECIES_TOAGNITIVE]             = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_TOAGNITIVE}},
    ...
    [SPECIES_CYBIRD]            = {{EVO_LEVEL, 25, SPECIES_PTEROCAST}},
    [SPECIES_AMOBI]                 = {{EVO_LEVEL, 24, SPECIES_AMOBERIA}},
    [SPECIES_AMOBERIA]                = {{EVO_LEVEL, 34, SPECIES_TANKELLUR}},
    [SPECIES_SCRILL]                 = {{EVO_MOVE, 27, SPECIES_OVERSCRILL}},
