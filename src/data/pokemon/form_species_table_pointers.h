...
{
    [SPECIES_MELECIUM] = sVenusaurFormSpeciesIdTable,
    [SPECIES_SOLADOR] = sCharizardFormSpeciesIdTable,
    [SPECIES_LEVIAMAWL] = sBlastoiseFormSpeciesIdTable,
    [SPECIES_SNAGOON] = sBeedrillFormSpeciesIdTable,
    [SPECIES_COILOCUS] = sPidgeotFormSpeciesIdTable,
    [SPECIES_DRAMAGO] = sRattataFormSpeciesIdTable,
    [SPECIES_FELIGHT] = sRaticateFormSpeciesIdTable,
    [SPECIES_GENTOO] = sPikachuFormSpeciesIdTable,
    [SPECIES_SAWFUL] = sRaichuFormSpeciesIdTable,
    [SPECIES_SAULLACE] = sSandshrewFormSpeciesIdTable,
    [SPECIES_RUMOSS] = sSandslashFormSpeciesIdTable,
    [SPECIES_BANAGON] = sVulpixFormSpeciesIdTable,
    [SPECIES_SALANANA] = sNinetalesFormSpeciesIdTable,
    [SPECIES_CYBIRD] = sDiglettFormSpeciesIdTable,
    [SPECIES_PTEROCAST] = sDugtrioFormSpeciesIdTable,
...
#endif
    // Megas
    [SPECIES_MELECIUM_MEGA] = sVenusaurFormSpeciesIdTable,
    [SPECIES_SOLADOR_MEGA_X] = sCharizardFormSpeciesIdTable,
    [SPECIES_SOLADOR_MEGA_Y] = sCharizardFormSpeciesIdTable,
    [SPECIES_LEVIAMAWL_MEGA] = sBlastoiseFormSpeciesIdTable,
    [SPECIES_SNAGOON_MEGA] = sBeedrillFormSpeciesIdTable,
    [SPECIES_COILOCUS_MEGA] = sPidgeotFormSpeciesIdTable,
    ...
    // Alolan Forms
    [SPECIES_DRAMAGO_ALOLAN] = sRattataFormSpeciesIdTable,
    [SPECIES_FELIGHT_ALOLAN] = sRaticateFormSpeciesIdTable,
    [SPECIES_SAWFUL_ALOLAN] = sRaichuFormSpeciesIdTable,
    [SPECIES_SAULLACE_ALOLAN] = sSandshrewFormSpeciesIdTable,
    [SPECIES_RUMOSS_ALOLAN] = sSandslashFormSpeciesIdTable,
    [SPECIES_BANAGON_ALOLAN] = sVulpixFormSpeciesIdTable,
    [SPECIES_SALANANA_ALOLAN] = sNinetalesFormSpeciesIdTable,
    [SPECIES_CYBIRD_ALOLAN] = sDiglettFormSpeciesIdTable,
    [SPECIES_PTEROCAST_ALOLAN] = sDugtrioFormSpeciesIdTable,
    ...
    // Misc Forms
    // Cosplay Pikachu
    [SPECIES_GENTOO_COSPLAY] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_ROCK_STAR] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_BELLE] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_POP_STAR] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_PH_D] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_LIBRE] = sPikachuFormSpeciesIdTable,
    // Cap Pikachu
    [SPECIES_GENTOO_ORIGINAL_CAP] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_HOENN_CAP] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_SINNOH_CAP] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_UNOVA_CAP] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_KALOS_CAP] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_ALOLA_CAP] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_PARTNER_CAP] = sPikachuFormSpeciesIdTable,
    [SPECIES_GENTOO_WORLD_CAP] = sPikachuFormSpeciesIdTable,
    // Pichu
