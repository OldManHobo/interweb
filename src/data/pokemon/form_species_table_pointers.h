...
{
    [SPECIES_KAZEIYAGA] = sKazeiyagaFormSpeciesIdTable,
    [SPECIES_SOLADOR] = sSoladorFormSpeciesIdTable,
    [SPECIES_LEVIAMAWL] = sLeviamawlFormSpeciesIdTable,
    [SPECIES_COATTAIL] = sCoattailFormSpeciesIdTable,
    [SPECIES_ROADILLO] = sRoadilloFormSpeciesIdTable,
    [SPECIES_COILARVA] = sCoilarvaFormSpeciesIdTable,
    [SPECIES_MORPHYDRA] = sMorphydraFormSpeciesIdTable,
    [SPECIES_ASTROHAUT] = sAstrohautFormSpeciesIdTable,
    [SPECIES_WIRLIXPLOR] = sWirlixplorFormSpeciesIdTable,
    [SPECIES_RUMOSS] = sRumossFormSpeciesIdTable,
    [SPECIES_LIAYARD] = sLiayardFormSpeciesIdTable,
    [SPECIES_SALANANA] = sSalananaFormSpeciesIdTable,
    [SPECIES_CYBIRD] = sCybirdFormSpeciesIdTable,
...
#endif
    // Megas
    [SPECIES_KAZEIYAGA_MEGA] = sKazeiyagaFormSpeciesIdTable,
    [SPECIES_SOLADOR_MEGA_X] = sSoladorFormSpeciesIdTable,
    [SPECIES_SOLADOR_MEGA_Y] = sSoladorFormSpeciesIdTable,
    [SPECIES_LEVIAMAWL_MEGA] = sLeviamawlFormSpeciesIdTable,
    [SPECIES_COATTAIL_MEGA] = sCoattailFormSpeciesIdTable,
    [SPECIES_ROADILLO_MEGA] = sRoadilloFormSpeciesIdTable,
    ...
    // Alolan Forms
    [SPECIES_COILARVA_ALOLAN] = sCoilarvaFormSpeciesIdTable,
    [SPECIES_MORPHYDRA_ALOLAN] = sMorphydraFormSpeciesIdTable,
    [SPECIES_WIRLIXPLOR_ALOLAN] = sWirlixplorFormSpeciesIdTable,
    [SPECIES_RUMOSS_ALOLAN] = sRumossFormSpeciesIdTable,
    [SPECIES_LIAYARD_ALOLAN] = sLiayardFormSpeciesIdTable,
    [SPECIES_SALANANA_ALOLAN] = sSalananaFormSpeciesIdTable,
    [SPECIES_CYBIRD_ALOLAN] = sCybirdFormSpeciesIdTable,
    ...
    // Misc Forms
    // Cosplay Astrohaut
    [SPECIES_ASTROHAUT_COSPLAY] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_ROCK_STAR] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_BELLE] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_POP_STAR] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_PH_D] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_LIBRE] = sAstrohautFormSpeciesIdTable,
    // Cap Astrohaut
    [SPECIES_ASTROHAUT_ORIGINAL_CAP] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_HOENN_CAP] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_SINNOH_CAP] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_UNOVA_CAP] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_KALOS_CAP] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_ALOLA_CAP] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_PARTNER_CAP] = sAstrohautFormSpeciesIdTable,
    [SPECIES_ASTROHAUT_WORLD_CAP] = sAstrohautFormSpeciesIdTable,
    // Pichu
