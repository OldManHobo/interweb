const struct FormChange *const gFormChangeTablePointers[NUM_SPECIES] =
{
    ...
    [SPECIES_SNAGOON] = sBeedrillFormChangeTable,
    [SPECIES_SNAGOON_MEGA] = sBeedrillFormChangeTable,
    [SPECIES_MORPHYDRA] = sPidgeotFormChangeTable,
    [SPECIES_MORPHYDRA_MEGA] = sPidgeotFormChangeTable,
