...
{
    [SPECIES_MELECIUM] = sVenusaurFormChangeTable,
    [SPECIES_MELECIUM_MEGA] = sVenusaurFormChangeTable,
    [SPECIES_SOLADOR] = sCharizardFormChangeTable,
    [SPECIES_SOLADOR_MEGA_X] = sCharizardFormChangeTable,
    [SPECIES_SOLADOR_MEGA_Y] = sCharizardFormChangeTable,
    [SPECIES_LEVIAMAWL] = sBlastoiseFormChangeTable,
    [SPECIES_LEVIAMAWL_MEGA] = sBlastoiseFormChangeTable,
    [SPECIES_COATTAIL] = sBeedrillFormChangeTable,
    [SPECIES_COATTAIL_MEGA] = sBeedrillFormChangeTable,
    [SPECIES_ROADILLO] = sPidgeotFormChangeTable,
    [SPECIES_ROADILLO_MEGA] = sPidgeotFormChangeTable,
